...
pub fn emit_runtime_helpers(out: &mut String, needed: &HashSet<String>) {
    ...
    if needed.contains("DRAW_CIRCLE_RUNTIME") {
        ...
        out.push_str("    CLR Vec_Misc_Count\n");
        out.push_str("    LDA >DRAW_CIRCLE_RADIUS  ; radius\n");
        out.push_str("    LDB >DRAW_CIRCLE_RADIUS\n");
        ...
        out.push_str("    CLR Vec_Misc_Count\n");
        out.push_str("    LDA >DRAW_CIRCLE_RADIUS  ; radius (dy)\n");
        out.push_str("    LDB >DRAW_CIRCLE_RADIUS\n");
        ...
        out.push_str("    CLR Vec_Misc_Count\n");
        out.push_str("    LDA >DRAW_CIRCLE_RADIUS\n");
        out.push_str("    LSRA                ; r/2 (dy)\n");
        out.push_str("    LDB >DRAW_CIRCLE_RADIUS  ; r (dx)\n");
        out.push_str("    JSR Draw_Line_d\n");
        out.push_str("    \n");
