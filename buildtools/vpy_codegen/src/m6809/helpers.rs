...
pub fn generate_helpers(module: &Module) -> Result<String, String> {
    ...
    if needed.contains("PRINT_NUMBER") {
        ...
        asm.push_str("    ; Uses NUM_STR buffer (5 bytes: 4 digits + terminator)\n");
        asm.push_str("    LDA #$98\n");
        asm.push_str("    STA >$D00C     ; Set VIA to DAC mode\n");
        asm.push_str(&format!("    JSR {}      ; Set DP to $D0 for BIOS\n", dp_to_d0));
        asm.push_str("    \n");
        asm.push_str("    ; Convert 16-bit number to decimal\n");
        asm.push_str("    LDD >VAR_ARG2  ; Load 16-bit number\n");
        asm.push_str("    LDX #NUM_STR   ; String buffer\n");
        asm.push_str("    \n");
        ...
        asm.push_str("    CMPD #1000\n");
        asm.push_str("    BLT .PN_D1000_DONE\n");
        asm.push_str("    SUBD #1000\n");
        asm.push_str("    INCA\n");
        asm.push_str("    BRA .PN_L1000\n");
        asm.push_str(".PN_D1000_DONE:\n");
        asm.push_str("    ADDA #'0'\n");
        asm.push_str("    STA ,X+\n");
        asm.push_str("    \n");
        asm.push_str("    CLRA\n");
        asm.push_str(".PN_L100:\n");
        asm.push_str("    CMPD #100\n");
        asm.push_str("    BLT .PN_D100_DONE\n");
        asm.push_str("    SUBD #100\n");
        asm.push_str("    INCA\n");
        asm.push_str("    BRA .PN_L100\n");
        asm.push_str(".PN_D100_DONE:\n");
        asm.push_str("    ADDA #'0'\n");
        asm.push_str("    STA ,X+\n");
        asm.push_str("    \n");
        asm.push_str("    CLRA\n");
        asm.push_str(".PN_L10:\n");
        asm.push_str("    CMPD #10\n");
        asm.push_str("    BLT .PN_D10_DONE\n");
        asm.push_str("    SUBD #10\n");
        asm.push_str("    INCA\n");
        asm.push_str("    BRA .PN_L10\n");
        asm.push_str(".PN_D10_DONE:\n");
        asm.push_str("    ADDA #'0'\n");
        asm.push_str("    STA ,X+\n");
        asm.push_str("    \n");
        asm.push_str("    ; Last digit (remainder in D)\n");
        asm.push_str("    ADDB #'0'\n");
        asm.push_str("    ORB #$80       ; Terminator\n");
        asm.push_str("    STB ,X\n");
        asm.push_str("    \n");
