...
LOOP_BODY:
    ...
    LDD #-100
    STB >ROT3D_OY       ; screen Y offset
    LDX #_3DVECTOR_3D_DATA  ; pointer to 3D data table
    JSR DRAW_VECTOR_3D_RUNTIME
    LDD #0
    STD RESULT
...
; Generated from 3dvector.vec (Malban Draw_Sync_List format)
; Total paths: 9, points: 30
; X bounds: min=-10, max=10, width=20
; Center: (0, 0)

_3DVECTOR_WIDTH EQU 20
_3DVECTOR_HALF_WIDTH EQU 10
_3DVECTOR_HEIGHT EQU 20
_3DVECTOR_HALF_HEIGHT EQU 10
_3DVECTOR_CENTER_X EQU 0
...
_3DVECTOR_VECTORS:  ; Main entry (header + 9 path(s))
    ...
    FDB _3DVECTOR_PATH3        ; pointer to path 3
    FDB _3DVECTOR_PATH4        ; pointer to path 4
    FDB _3DVECTOR_PATH5        ; pointer to path 5
    FDB _3DVECTOR_PATH6        ; pointer to path 6
    FDB _3DVECTOR_PATH7        ; pointer to path 7
    FDB _3DVECTOR_PATH8        ; pointer to path 8
...
; X bounds: min=-29, max=29, width=58
; Center: (0, 0)

_LOGO_WIDTH EQU 58
_LOGO_HALF_WIDTH EQU 29
_LOGO_HEIGHT EQU 76
...
; 3D vertex-indexed data for DRAW_VECTOR_3D (14 unique verts, 9 paths, 30 total point refs)
_3DVECTOR_3D_DATA:
    FDB 14               ; vertex count (unique)
    FCB $06,$F6,$0A          ; vert 0: x=6,y=-10,z=10
    FCB $06,$F6,$F6          ; vert 1: x=6,y=-10,z=-10
    FCB $0A,$FA,$0A          ; vert 2: x=10,y=-6,z=10
    FCB $0A,$06,$0A          ; vert 3: x=10,y=6,z=10
    FCB $F6,$06,$0A          ; vert 4: x=-10,y=6,z=10
    FCB $F6,$F6,$0A          ; vert 5: x=-10,y=-10,z=10
    FCB $0A,$FA,$F6          ; vert 6: x=10,y=-6,z=-10
    FCB $0A,$00,$F6          ; vert 7: x=10,y=0,z=-10
    FCB $F6,$00,$F6          ; vert 8: x=-10,y=0,z=-10
    FCB $F6,$F6,$F6          ; vert 9: x=-10,y=-10,z=-10
    FCB $0A,$0A,$06          ; vert 10: x=10,y=10,z=6
    FCB $0A,$0A,$00          ; vert 11: x=10,y=10,z=0
    FCB $F6,$0A,$06          ; vert 12: x=-10,y=10,z=6
    FCB $F6,$0A,$00          ; vert 13: x=-10,y=10,z=0
    FDB 9               ; path count
    FCB 2               ; path 0: point count
    FCB 0               ; path 0: closed flag
    FCB 0               ; vertex index
    FCB 1               ; vertex index
    FCB 6               ; path 1: point count
    FCB 1               ; path 1: closed flag
    FCB 0               ; vertex index
    FCB 2               ; vertex index
    FCB 3               ; vertex index
    FCB 4               ; vertex index
    FCB 5               ; vertex index
    FCB 0               ; vertex index
    FCB 6               ; path 2: point count
    FCB 1               ; path 2: closed flag
    FCB 1               ; vertex index
    FCB 6               ; vertex index
    FCB 7               ; vertex index
    FCB 8               ; vertex index
    FCB 9               ; vertex index
    FCB 1               ; vertex index
    FCB 2               ; path 3: point count
    FCB 0               ; path 3: closed flag
    FCB 2               ; vertex index
    FCB 6               ; vertex index
    FCB 2               ; path 4: point count
    FCB 0               ; path 4: closed flag
    FCB 5               ; vertex index
    FCB 9               ; vertex index
    FCB 4               ; path 5: point count
    FCB 0               ; path 5: closed flag
    FCB 3               ; vertex index
    FCB 10               ; vertex index
    FCB 11               ; vertex index
    FCB 7               ; vertex index
    FCB 4               ; path 6: point count
    FCB 0               ; path 6: closed flag
    FCB 4               ; vertex index
    FCB 12               ; vertex index
    FCB 13               ; vertex index
    FCB 8               ; vertex index
    FCB 2               ; path 7: point count
    FCB 0               ; path 7: closed flag
    FCB 12               ; vertex index
    FCB 10               ; vertex index
    FCB 2               ; path 8: point count
    FCB 0               ; path 8: closed flag
    FCB 11               ; vertex index
    FCB 13               ; vertex index


; 3D vertex-indexed data for DRAW_VECTOR_3D (41 unique verts, 18 paths, 62 total point refs)
_LOGO_3D_DATA:
    FDB 41               ; vertex count (unique)
    FCB $EB,$26,$00          ; vert 0: x=-21,y=38,z=0
    FCB $05,$26,$00          ; vert 1: x=5,y=38,z=0
    FCB $05,$16,$00          ; vert 2: x=5,y=22,z=0
    FCB $0D,$16,$00          ; vert 3: x=13,y=22,z=0
    FCB $0D,$FB,$00          ; vert 4: x=13,y=-5,z=0
    FCB $05,$FB,$00          ; vert 5: x=5,y=-5,z=0
    FCB $05,$F3,$00          ; vert 6: x=5,y=-13,z=0
    FCB $EA,$F3,$00          ; vert 7: x=-22,y=-13,z=0
    FCB $EA,$FB,$00          ; vert 8: x=-22,y=-5,z=0
    FCB $E3,$FB,$00          ; vert 9: x=-29,y=-5,z=0
    FCB $E3,$16,$00          ; vert 10: x=-29,y=22,z=0
    FCB $EB,$16,$00          ; vert 11: x=-21,y=22,z=0
    FCB $EB,$17,$00          ; vert 12: x=-21,y=23,z=0
    FCB $0D,$FC,$00          ; vert 13: x=13,y=-4,z=0
    FCB $EA,$FA,$00          ; vert 14: x=-22,y=-6,z=0
    FCB $03,$F3,$00          ; vert 15: x=3,y=-13,z=0
    FCB $EF,$22,$00          ; vert 16: x=-17,y=34,z=0
    FCB $F6,$22,$00          ; vert 17: x=-10,y=34,z=0
    FCB $F6,$1B,$00          ; vert 18: x=-10,y=27,z=0
    FCB $EF,$1B,$00          ; vert 19: x=-17,y=27,z=0
    FCB $FB,$0D,$00          ; vert 20: x=-5,y=13,z=0
    FCB $17,$0D,$00          ; vert 21: x=23,y=13,z=0
    FCB $17,$05,$00          ; vert 22: x=23,y=5,z=0
    FCB $1D,$05,$00          ; vert 23: x=29,y=5,z=0
    FCB $1D,$EB,$00          ; vert 24: x=29,y=-21,z=0
    FCB $15,$EB,$00          ; vert 25: x=21,y=-21,z=0
    FCB $15,$EA,$00          ; vert 26: x=21,y=-22,z=0
    FCB $15,$DA,$00          ; vert 27: x=21,y=-38,z=0
    FCB $FB,$DA,$00          ; vert 28: x=-5,y=-38,z=0
    FCB $FB,$EB,$00          ; vert 29: x=-5,y=-21,z=0
    FCB $F3,$EB,$00          ; vert 30: x=-13,y=-21,z=0
    FCB $F3,$05,$00          ; vert 31: x=-13,y=5,z=0
    FCB $FB,$05,$00          ; vert 32: x=-5,y=5,z=0
    FCB $F3,$04,$00          ; vert 33: x=-13,y=4,z=0
    FCB $FD,$DA,$00          ; vert 34: x=-3,y=-38,z=0
    FCB $11,$E5,$00          ; vert 35: x=17,y=-27,z=0
    FCB $11,$DE,$00          ; vert 36: x=17,y=-34,z=0
    FCB $0A,$DE,$00          ; vert 37: x=10,y=-34,z=0
    FCB $0A,$E5,$00          ; vert 38: x=10,y=-27,z=0
    FCB $FD,$0D,$00          ; vert 39: x=-3,y=13,z=0
    FCB $17,$06,$00          ; vert 40: x=23,y=6,z=0
    FDB 18               ; path count
    ...
    FCB 11               ; vertex index
    FCB 12               ; vertex index
    FCB 2               ; path 1: point count
    FCB 0               ; path 1: closed flag
    FCB 2               ; vertex index
    FCB 3               ; vertex index
    FCB 2               ; path 2: point count
    ...
    FCB 15               ; vertex index
    FCB 7               ; vertex index
    FCB 2               ; path 5: point count
    FCB 0               ; path 5: closed flag
    FCB 0               ; vertex index
    FCB 1               ; vertex index
    FCB 2               ; path 6: point count
    FCB 0               ; path 6: closed flag
    FCB 9               ; vertex index
    FCB 10               ; vertex index
    FCB 2               ; path 7: point count
    ...
    FCB 2               ; vertex index
    FCB 3               ; vertex index
    FCB 4               ; path 8: point count
    FCB 1               ; path 8: closed flag
    FCB 16               ; vertex index
    FCB 17               ; vertex index
    FCB 18               ; vertex index
    FCB 19               ; vertex index
    FCB 13               ; path 9: point count
    FCB 1               ; path 9: closed flag
    FCB 20               ; vertex index
    FCB 21               ; vertex index
    FCB 22               ; vertex index
    FCB 23               ; vertex index
    ...
    FCB 27               ; vertex index
    FCB 34               ; vertex index
    FCB 4               ; path 12: point count
    FCB 1               ; path 12: closed flag
    FCB 35               ; vertex index
    FCB 36               ; vertex index
    FCB 37               ; vertex index
    FCB 38               ; vertex index
    FCB 2               ; path 13: point count
    FCB 0               ; path 13: closed flag
    FCB 29               ; vertex index
    FCB 30               ; vertex index
    FCB 2               ; path 14: point count
    FCB 0               ; path 14: closed flag
    FCB 23               ; vertex index
    FCB 24               ; vertex index
    FCB 2               ; path 15: point count
    FCB 0               ; path 15: closed flag
    FCB 39               ; vertex index
    FCB 21               ; vertex index
    FCB 2               ; path 16: point count
    FCB 0               ; path 16: closed flag
    FCB 21               ; vertex index
    FCB 40               ; vertex index
    FCB 2               ; path 17: point count
    FCB 0               ; path 17: closed flag
    FCB 29               ; vertex index
    FCB 30               ; vertex index
