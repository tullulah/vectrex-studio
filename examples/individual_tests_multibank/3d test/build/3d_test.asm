...
.equ VAR_ANGLE_X, 0x001005D4
.equ VAR_ANGLE_Y, 0x001005D8
.equ VAR_ANGLE_Z, 0x001005DC
...
@ pitrex_draw_vector_3d: Full 3D Euler rotation (X→Y→Z)
@ pitrex_draw_vector_3d(r0=asset, r1=rot_x, r2=rot_y, r3=rot_z) + [sp]=ox, [sp+4]=oy pushed by caller
.global pitrex_draw_vector_3d
.type pitrex_draw_vector_3d, %function
pitrex_draw_vector_3d:
    push    {r4-r11, lr}
    sub     sp, sp, #8          @ locals
    mov     r4, r0              @ r4 = asset_ptr
    mov     r5, r1              @ r5 = rot_x
    mov     r6, r2              @ r6 = rot_y
    mov     r7, r3              @ r7 = rot_z
    ldrsb   r8, [sp, #52]       @ r8 = ox (pushed by expressions, now at [sp+52])
    ldrsb   r9, [sp, #48]       @ r9 = oy (pushed by expressions, now at [sp+48])
    @ TODO: Implement Y rotation: x'=x*cos(ry)-z*sin(ry), z'=x*sin(ry)+z*cos(ry)
    @ TODO: For full 3D: also apply X and Z rotations
    mov     r0, r4              @ r0 = asset_ptr
    mov     r1, r8              @ r1 = ox
    mov     r2, r9              @ r2 = oy
    mov     r3, #0              @ r3 = mirror
    mov     r10, #127           @ r10 = intensity
    push    {r10}
    bl      pitrex_draw_vector_ex
    add     sp, sp, #4
.Ldv3d_done:
...
.Lgp_1:
    @ main() body
    mov     r0, #0
    ldr     r1, =0x001005D4    @ ANGLE_X
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005D8    @ ANGLE_Y
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005DC    @ ANGLE_Z
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
...
pitrex_game_loop:
    ...
    mov     r0, #20
    push    {r0}
    bl      pitrex_draw_vector_3d
    add     sp, sp, #8          @ pop ox, oy
