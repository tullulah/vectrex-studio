...
@ --- User variables (RAM) ---
.equ VAR_ANGLE_X, 0x2007F300
.equ VAR_ANGLE_Y, 0x2007F304
.equ VAR_ANGLE_Z, 0x2007F308
...
game_main:
    ...
    @ main() body
    mov     r0, #0
    ldr     r1, =0x2007F300    @ ANGLE_X
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F304    @ ANGLE_Y
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F308    @ ANGLE_Z
    str     r0, [r1]
game_main_loop:
    bl      vpy_wait_recal
    ...
    ldr     r1, =0x2007F304    @ ANGLE_Y
    str     r0, [r1]
    ldr     r0, =_LOGO_VECTORS    @ asset 'logo' (3D stub: using 2D)
    push    {r0}
    mov     r0, #0
    push    {r0}
    mov     r0, #20
    ...
    bl      vpy_draw_vector_ex
    add     sp, sp, #4
    ldr     r0, =_3DVECTOR_VECTORS    @ asset '3dvector' (3D stub: using 2D)
    push    {r0}
    mov     r0, #0
    push    {r0}
    ldr     r0, =-100
...
_MUSIC1_MUSIC:
    ...
    .byte   10, 8  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=15 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   14, 4  @ frame=30 delay=14 writes=4
    .byte   0, 142  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    .byte   7, 56  @ PSG r7
    .byte   29, 8  @ frame=60 delay=29 writes=8
    .byte   6, 15  @ PSG r6
    .byte   0, 120  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    ...
    .byte   9, 10  @ PSG r9
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=75 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   14, 4  @ frame=90 delay=14 writes=4
    .byte   0, 90  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    .byte   7, 56  @ PSG r7
    .byte   29, 11  @ frame=120 delay=29 writes=11
    .byte   6, 15  @ PSG r6
    .byte   0, 120  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    ...
    .byte   10, 8  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=135 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   14, 4  @ frame=150 delay=14 writes=4
    .byte   0, 142  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    .byte   7, 56  @ PSG r7
    .byte   29, 8  @ frame=180 delay=29 writes=8
    .byte   6, 15  @ PSG r6
    .byte   0, 179  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    ...
    .byte   9, 10  @ PSG r9
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=195 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   44, 11  @ frame=240 delay=44 writes=11
    .byte   6, 15  @ PSG r6
    .byte   0, 160  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    ...
    .byte   10, 8  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=255 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   14, 4  @ frame=270 delay=14 writes=4
    .byte   0, 134  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    .byte   7, 56  @ PSG r7
    .byte   29, 8  @ frame=300 delay=29 writes=8
    .byte   6, 15  @ PSG r6
    .byte   0, 107  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    ...
    .byte   9, 10  @ PSG r9
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=315 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   14, 4  @ frame=330 delay=14 writes=4
    .byte   0, 80  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    .byte   7, 56  @ PSG r7
    .byte   29, 11  @ frame=360 delay=29 writes=11
    .byte   6, 15  @ PSG r6
    .byte   0, 107  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    ...
    .byte   10, 8  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=375 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   14, 4  @ frame=390 delay=14 writes=4
    .byte   0, 134  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    .byte   7, 56  @ PSG r7
    .byte   29, 8  @ frame=420 delay=29 writes=8
    .byte   6, 15  @ PSG r6
    .byte   0, 160  @ PSG r0
    .byte   1, 0  @ PSG r1
    .byte   8, 12  @ PSG r8
    ...
    .byte   9, 10  @ PSG r9
    .byte   7, 48  @ PSG r7
    .byte   14, 1  @ frame=435 delay=14 writes=1
    .byte   7, 56  @ PSG r7
    .byte   44, 4  @ frame=480 delay=44 writes=4
    .byte   8, 0  @ PSG r8
    .byte   9, 0  @ PSG r9
    .byte   10, 0  @ PSG r10
    .byte   7, 63  @ PSG r7
    .byte   0, 0xFF   @ loop back (fires frame ~480)
