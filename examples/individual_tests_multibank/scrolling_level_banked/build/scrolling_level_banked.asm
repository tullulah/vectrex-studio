...
; Total: 3 vectors, 0 music, 0 sfx, 1 levels
;***************************************************************************
...
VECTOR_ADDR_TABLE:
    FDB _GROUND_VECTORS    ; ground
    FDB _MARKER_VECTORS    ; marker
    FDB _TILE_VECTORS    ; tile
