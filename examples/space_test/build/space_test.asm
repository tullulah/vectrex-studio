...
@ --- User variables (RAM) ---
.equ VAR_SCREEN_WIDTH, 0x2007F3DC
.equ VAR_SCREEN_HEIGHT, 0x2007F3E0
.equ VAR_PLAYER_SIZE, 0x2007F3E4
.equ VAR_ENEMY_SIZE, 0x2007F3E8
.equ VAR_BULLET_SPEED, 0x2007F3EC
.equ VAR_GAME_STATE, 0x2007F3F0
.equ VAR_SCORE, 0x2007F3F4
.equ VAR_PLAYER_X, 0x2007F3F8
.equ VAR_PLAYER_Y, 0x2007F3FC
.equ VAR_BULLET_ACTIVE, 0x2007F400
.equ VAR_BULLET_X, 0x2007F404
.equ VAR_BULLET_Y, 0x2007F408
.equ VAR_ENEMY_ACTIVE, 0x2007F40C
.equ VAR_ENEMY_X, 0x2007F410
.equ VAR_ENEMY_Y, 0x2007F414
.equ VAR_ENEMY_VX, 0x2007F418
...
.align 2
.global RESET_ENEMY
.type RESET_ENEMY, %function
.thumb_func
RESET_ENEMY:
    push    {r4, r5, r6, r7, lr}
    mov     r0, #0
    ldr     r1, =0x2007F410    @ ENEMY_X
    str     r0, [r1]
    mov     r0, #100
    ldr     r1, =0x2007F414    @ ENEMY_Y
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x2007F40C    @ ENEMY_ACTIVE
    str     r0, [r1]
    pop     {r4, r5, r6, r7, pc}
    .ltorg
...
DRAW_PLAYER:
    ...
    mov     r0, #80
    push    {r0}
    ldr     r1, =0x2007F3F8    @ PLAYER_X
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F3FC    @ PLAYER_Y
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F3F8    @ PLAYER_X
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F3E4    @ PLAYER_SIZE
    ldr     r0, [r1]
    mov     r1, r0
    pop     {r0}
    sub     r0, r0, r1
...
.align 2
.global DRAW_BULLET
.type DRAW_BULLET, %function
.thumb_func
DRAW_BULLET:
    push    {r4, r5, r6, r7, lr}
    ldr     r1, =0x2007F400    @ BULLET_ACTIVE
    ldr     r0, [r1]
    push    {r0}
    mov     r0, #1
    mov     r1, r0
...
.Lcf1e:
    ...
    mov     r0, #80
    push    {r0}
    ldr     r1, =0x2007F404    @ BULLET_X
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F408    @ BULLET_Y
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F404    @ BULLET_X
    ldr     r0, [r1]
...
.Lcf8e:
    ...
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F3EC    @ BULLET_SPEED
    ldr     r0, [r1]
    mov     r1, r0
    pop     {r0}
    add     r0, r0, r1
    ...
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F3E0    @ SCREEN_HEIGHT
    ldr     r0, [r1]
    mov     r1, r0
    pop     {r0}
    cmp     r0, r1
