...
VAR_STATE_MAP        EQU $C880+$248   ; User variable: STATE_MAP (2 bytes)
VAR_STATE_GAME       EQU $C880+$24A   ; User variable: STATE_GAME (2 bytes)
VAR_SCREEN           EQU $C880+$24C   ; User variable: SCREEN (2 bytes)
VAR_TITLE_INTENSITY  EQU $C880+$24E   ; User variable: TITLE_INTENSITY (2 bytes)
VAR_TITLE_STATE      EQU $C880+$250   ; User variable: TITLE_STATE (2 bytes)
VAR_CURRENT_MUSIC    EQU $C880+$252   ; User variable: CURRENT_MUSIC (2 bytes)
VAR_LOCATION_X_COORDS EQU $C880+$254   ; User variable: LOCATION_X_COORDS (2 bytes)
VAR_LOCATION_Y_COORDS EQU $C880+$256   ; User variable: LOCATION_Y_COORDS (2 bytes)
VAR_LOCATION_NAMES   EQU $C880+$258   ; User variable: LOCATION_NAMES (2 bytes)
VAR_LEVEL_BACKGROUNDS EQU $C880+$25A   ; User variable: LEVEL_BACKGROUNDS (2 bytes)
VAR_LEVEL_ENEMY_COUNT EQU $C880+$25C   ; User variable: LEVEL_ENEMY_COUNT (2 bytes)
VAR_LEVEL_ENEMY_SPEED EQU $C880+$25E   ; User variable: LEVEL_ENEMY_SPEED (2 bytes)
VAR_NUM_LOCATIONS    EQU $C880+$260   ; User variable: NUM_LOCATIONS (2 bytes)
VAR_CURRENT_LOCATION EQU $C880+$262   ; User variable: CURRENT_LOCATION (2 bytes)
VAR_LOCATION_GLOW_INTENSITY EQU $C880+$264   ; User variable: LOCATION_GLOW_INTENSITY (2 bytes)
VAR_LOCATION_GLOW_DIRECTION EQU $C880+$266   ; User variable: LOCATION_GLOW_DIRECTION (2 bytes)
VAR_JOY_X            EQU $C880+$268   ; User variable: JOY_X (2 bytes)
VAR_JOY_Y            EQU $C880+$26A   ; User variable: JOY_Y (2 bytes)
VAR_PREV_JOY_X       EQU $C880+$26C   ; User variable: PREV_JOY_X (2 bytes)
VAR_PREV_JOY_Y       EQU $C880+$26E   ; User variable: PREV_JOY_Y (2 bytes)
VAR_COUNTDOWN_TIMER  EQU $C880+$270   ; User variable: COUNTDOWN_TIMER (2 bytes)
VAR_COUNTDOWN_ACTIVE EQU $C880+$272   ; User variable: COUNTDOWN_ACTIVE (2 bytes)
VAR_JOYSTICK_POLL_COUNTER EQU $C880+$274   ; User variable: JOYSTICK_POLL_COUNTER (2 bytes)
VAR_HOOK_ACTIVE      EQU $C880+$276   ; User variable: HOOK_ACTIVE (2 bytes)
VAR_HOOK_X           EQU $C880+$278   ; User variable: HOOK_X (2 bytes)
VAR_HOOK_Y           EQU $C880+$27A   ; User variable: HOOK_Y (2 bytes)
VAR_HOOK_MAX_Y       EQU $C880+$27C   ; User variable: HOOK_MAX_Y (2 bytes)
VAR_HOOK_GUN_X       EQU $C880+$27E   ; User variable: HOOK_GUN_X (2 bytes)
VAR_HOOK_GUN_Y       EQU $C880+$280   ; User variable: HOOK_GUN_Y (2 bytes)
VAR_HOOK_INIT_Y      EQU $C880+$282   ; User variable: HOOK_INIT_Y (2 bytes)
VAR_PLAYER_X         EQU $C880+$284   ; User variable: PLAYER_X (2 bytes)
VAR_PLAYER_Y         EQU $C880+$286   ; User variable: PLAYER_Y (2 bytes)
VAR_MOVE_SPEED       EQU $C880+$288   ; User variable: MOVE_SPEED (2 bytes)
VAR_ABS_JOY          EQU $C880+$28A   ; User variable: ABS_JOY (2 bytes)
VAR_PLAYER_ANIM_FRAME EQU $C880+$28C   ; User variable: PLAYER_ANIM_FRAME (2 bytes)
VAR_PLAYER_ANIM_COUNTER EQU $C880+$28E   ; User variable: PLAYER_ANIM_COUNTER (2 bytes)
VAR_PLAYER_ANIM_SPEED EQU $C880+$290   ; User variable: PLAYER_ANIM_SPEED (2 bytes)
VAR_PLAYER_FACING    EQU $C880+$292   ; User variable: PLAYER_FACING (2 bytes)
VAR_MAX_ENEMIES      EQU $C880+$294   ; User variable: MAX_ENEMIES (2 bytes)
VAR_GRAVITY          EQU $C880+$296   ; User variable: GRAVITY (2 bytes)
VAR_BOUNCE_DAMPING   EQU $C880+$298   ; User variable: BOUNCE_DAMPING (2 bytes)
VAR_MIN_BOUNCE_VY    EQU $C880+$29A   ; User variable: MIN_BOUNCE_VY (2 bytes)
VAR_GROUND_Y         EQU $C880+$29C   ; User variable: GROUND_Y (2 bytes)
VAR_JOYSTICK1_STATE  EQU $C880+$29E   ; User variable: JOYSTICK1_STATE (2 bytes)
VAR_LOC_X            EQU $C880+$2A0   ; User variable: LOC_X (2 bytes)
VAR_LOC_Y            EQU $C880+$2A2   ; User variable: LOC_Y (2 bytes)
VAR_ANIM_THRESHOLD   EQU $C880+$2A4   ; User variable: ANIM_THRESHOLD (2 bytes)
VAR_MIRROR_MODE      EQU $C880+$2A6   ; User variable: MIRROR_MODE (2 bytes)
VAR_ACTIVE_COUNT     EQU $C880+$2A8   ; User variable: ACTIVE_COUNT (2 bytes)
VAR_I                EQU $C880+$2AA   ; User variable: I (2 bytes)
VAR_ENEMY_ACTIVE     EQU $C880+$2AC   ; User variable: ENEMY_ACTIVE (2 bytes)
VAR_COUNT            EQU $C880+$2AE   ; User variable: COUNT (2 bytes)
VAR_SPEED            EQU $C880+$2B0   ; User variable: SPEED (2 bytes)
VAR_ENEMY_SIZE       EQU $C880+$2B2   ; User variable: ENEMY_SIZE (2 bytes)
VAR_ENEMY_X          EQU $C880+$2B4   ; User variable: ENEMY_X (2 bytes)
VAR_ENEMY_Y          EQU $C880+$2B6   ; User variable: ENEMY_Y (2 bytes)
VAR_ENEMY_VX         EQU $C880+$2B8   ; User variable: ENEMY_VX (2 bytes)
VAR_ENEMY_VY         EQU $C880+$2BA   ; User variable: ENEMY_VY (2 bytes)
VAR_START_X          EQU $C880+$2C4   ; User variable: start_x (2 bytes)
VAR_START_Y          EQU $C880+$2C6   ; User variable: start_y (2 bytes)
VAR_END_X            EQU $C880+$2C8   ; User variable: end_x (2 bytes)
VAR_END_Y            EQU $C880+$2CA   ; User variable: end_y (2 bytes)
VAR_START_X          EQU $C880+$2C4   ; User variable: START_X (2 bytes)
VAR_START_Y          EQU $C880+$2C6   ; User variable: START_Y (2 bytes)
VAR_END_X            EQU $C880+$2C8   ; User variable: END_X (2 bytes)
VAR_END_Y            EQU $C880+$2CA   ; User variable: END_Y (2 bytes)
VAR_JOYSTICK1_STATE_DATA EQU $C880+$2CC   ; Mutable array 'JOYSTICK1_STATE' data (6 elements x 2 bytes) (12 bytes)
VAR_ENEMY_ACTIVE_DATA EQU $C880+$2D8   ; Mutable array 'ENEMY_ACTIVE' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_X_DATA     EQU $C880+$2E8   ; Mutable array 'ENEMY_X' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_Y_DATA     EQU $C880+$2F8   ; Mutable array 'ENEMY_Y' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VX_DATA    EQU $C880+$308   ; Mutable array 'ENEMY_VX' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VY_DATA    EQU $C880+$318   ; Mutable array 'ENEMY_VY' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_SIZE_DATA  EQU $C880+$328   ; Mutable array 'ENEMY_SIZE' data (8 elements x 2 bytes) (16 bytes)
...
; Object: obj_1767470884207 (enemy)
    ...
    FCB _FUJI_BG_HALF_HEIGHT  ; half_height (collision AABB, ROM+19)
...
; Object: enemy_1 (enemy)
    ...
    FCB _BUBBLE_LARGE_HALF_HEIGHT  ; half_height (collision AABB, ROM+19)
