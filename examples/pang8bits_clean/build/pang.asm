...
VAR_NUM_LOCATIONS    EQU $C880+$DD   ; User variable: num_locations (2 bytes)
VAR_CURRENT_LOCATION EQU $C880+$DF   ; User variable: current_location (2 bytes)
VAR_LOCATION_GLOW_INTENSITY EQU $C880+$E1   ; User variable: location_glow_intensity (2 bytes)
VAR_LOCATION_GLOW_DIRECTION EQU $C880+$E3   ; User variable: location_glow_direction (2 bytes)
VAR_JOY_X            EQU $C880+$E5   ; User variable: joy_x (2 bytes)
VAR_JOY_Y            EQU $C880+$E7   ; User variable: joy_y (2 bytes)
VAR_PREV_JOY_X       EQU $C880+$E9   ; User variable: prev_joy_x (2 bytes)
VAR_PREV_JOY_Y       EQU $C880+$EB   ; User variable: prev_joy_y (2 bytes)
VAR_COUNTDOWN_TIMER  EQU $C880+$ED   ; User variable: countdown_timer (2 bytes)
VAR_COUNTDOWN_ACTIVE EQU $C880+$EF   ; User variable: countdown_active (2 bytes)
VAR_JOYSTICK_POLL_COUNTER EQU $C880+$F1   ; User variable: joystick_poll_counter (2 bytes)
VAR_HOOK_ACTIVE      EQU $C880+$F3   ; User variable: hook_active (2 bytes)
VAR_HOOK_X           EQU $C880+$F5   ; User variable: hook_x (2 bytes)
VAR_HOOK_Y           EQU $C880+$F7   ; User variable: hook_y (2 bytes)
VAR_HOOK_MAX_Y       EQU $C880+$F9   ; User variable: hook_max_y (2 bytes)
VAR_HOOK_GUN_X       EQU $C880+$FB   ; User variable: hook_gun_x (2 bytes)
VAR_HOOK_GUN_Y       EQU $C880+$FD   ; User variable: hook_gun_y (2 bytes)
VAR_HOOK_INIT_Y      EQU $C880+$FF   ; User variable: hook_init_y (2 bytes)
VAR_PLAYER_X         EQU $C880+$101   ; User variable: player_x (2 bytes)
VAR_PLAYER_Y         EQU $C880+$103   ; User variable: player_y (2 bytes)
VAR_MOVE_SPEED       EQU $C880+$105   ; User variable: move_speed (2 bytes)
VAR_ABS_JOY          EQU $C880+$107   ; User variable: abs_joy (2 bytes)
VAR_PLAYER_ANIM_FRAME EQU $C880+$109   ; User variable: player_anim_frame (2 bytes)
VAR_PLAYER_ANIM_COUNTER EQU $C880+$10B   ; User variable: player_anim_counter (2 bytes)
VAR_PLAYER_ANIM_SPEED EQU $C880+$10D   ; User variable: player_anim_speed (2 bytes)
VAR_PLAYER_FACING    EQU $C880+$10F   ; User variable: player_facing (2 bytes)
VAR_MAX_ENEMIES      EQU $C880+$111   ; User variable: MAX_ENEMIES (2 bytes)
VAR_GRAVITY          EQU $C880+$113   ; User variable: GRAVITY (2 bytes)
VAR_BOUNCE_DAMPING   EQU $C880+$115   ; User variable: BOUNCE_DAMPING (2 bytes)
VAR_MIN_BOUNCE_VY    EQU $C880+$117   ; User variable: MIN_BOUNCE_VY (2 bytes)
VAR_GROUND_Y         EQU $C880+$119   ; User variable: GROUND_Y (2 bytes)
VAR_JOYSTICK1_STATE  EQU $C880+$11B   ; User variable: joystick1_state (2 bytes)
VAR_LOC_X            EQU $C880+$11D   ; User variable: loc_x (2 bytes)
VAR_LOC_Y            EQU $C880+$11F   ; User variable: loc_y (2 bytes)
VAR_ANIM_THRESHOLD   EQU $C880+$121   ; User variable: anim_threshold (2 bytes)
VAR_MIRROR_MODE      EQU $C880+$123   ; User variable: mirror_mode (2 bytes)
VAR_ACTIVE_COUNT     EQU $C880+$125   ; User variable: active_count (2 bytes)
VAR_I                EQU $C880+$127   ; User variable: i (2 bytes)
VAR_ENEMY_ACTIVE     EQU $C880+$129   ; User variable: enemy_active (2 bytes)
VAR_COUNT            EQU $C880+$12B   ; User variable: count (2 bytes)
VAR_SPEED            EQU $C880+$12D   ; User variable: speed (2 bytes)
VAR_ENEMY_SIZE       EQU $C880+$12F   ; User variable: enemy_size (2 bytes)
VAR_ENEMY_X          EQU $C880+$131   ; User variable: enemy_x (2 bytes)
VAR_ENEMY_Y          EQU $C880+$133   ; User variable: enemy_y (2 bytes)
VAR_ENEMY_VX         EQU $C880+$135   ; User variable: enemy_vx (2 bytes)
VAR_ENEMY_VY         EQU $C880+$137   ; User variable: enemy_vy (2 bytes)
VAR_START_X          EQU $C880+$139   ; User variable: start_x (2 bytes)
VAR_START_Y          EQU $C880+$13B   ; User variable: start_y (2 bytes)
VAR_END_X            EQU $C880+$13D   ; User variable: end_x (2 bytes)
VAR_END_Y            EQU $C880+$13F   ; User variable: end_y (2 bytes)
VAR_JOYSTICK1_STATE_DATA EQU $C880+$141   ; Mutable array 'joystick1_state' data (6 elements x 2 bytes) (12 bytes)
VAR_ENEMY_ACTIVE_DATA EQU $C880+$14D   ; Mutable array 'enemy_active' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_X_DATA     EQU $C880+$15D   ; Mutable array 'enemy_x' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_Y_DATA     EQU $C880+$16D   ; Mutable array 'enemy_y' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VX_DATA    EQU $C880+$17D   ; Mutable array 'enemy_vx' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VY_DATA    EQU $C880+$18D   ; Mutable array 'enemy_vy' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_SIZE_DATA  EQU $C880+$19D   ; Mutable array 'enemy_size' data (8 elements x 2 bytes) (16 bytes)
