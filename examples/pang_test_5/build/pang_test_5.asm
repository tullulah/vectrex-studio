...
VAR_CURRENT_MUSIC    EQU $C880+$2B   ; User variable: CURRENT_MUSIC (2 bytes)
VAR_PULSE_INTENSITY  EQU $C880+$2D   ; User variable: PULSE_INTENSITY (2 bytes)
VAR_PULSE_DIRECTION  EQU $C880+$2F   ; User variable: PULSE_DIRECTION (2 bytes)
...
MAIN:
    ...
    LDD #50
    STD VAR_PULSE_INTENSITY
    LDD #1
    STD VAR_PULSE_DIRECTION
...
.CMP_0_END:
    ...
    LDD RESULT
    LBEQ IF_NEXT_1
    ; ERROR: Music asset 'pang_theme' not found
...
IF_NEXT_1:
IF_END_0:
    LDD VAR_PULSE_INTENSITY
    STD RESULT
    LDD RESULT
    STD TMPVAL          ; Save left operand to TMPVAL (stack-safe temp)
    LDD VAR_PULSE_DIRECTION
    STD RESULT
    LDD RESULT
