...
#endif  /* UVM2_PICO_RUNTIME */
.global uvm2_game_main
.thumb_set uvm2_game_main, game_main

#ifdef UVM2_PICO_RUNTIME
.section .vpyram, "awR", %nobits
.space 0x4000            @ 16 KB: VPY_RAM completa
.text
#endif
