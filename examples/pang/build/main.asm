...
VAR_START_X          EQU $C880+$2D1   ; User variable: start_x (2 bytes)
VAR_START_Y          EQU $C880+$2D3   ; User variable: start_y (2 bytes)
VAR_END_X            EQU $C880+$2D5   ; User variable: end_x (2 bytes)
VAR_END_Y            EQU $C880+$2D7   ; User variable: end_y (2 bytes)
VAR_JOYSTICK1_STATE_DATA EQU $C880+$2D9   ; Mutable array 'joystick1_state' data (6 elements x 2 bytes) (12 bytes)
VAR_ENEMY_ACTIVE_DATA EQU $C880+$2E5   ; Mutable array 'enemy_active' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_X_DATA     EQU $C880+$2F5   ; Mutable array 'enemy_x' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_Y_DATA     EQU $C880+$305   ; Mutable array 'enemy_y' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VX_DATA    EQU $C880+$315   ; Mutable array 'enemy_vx' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VY_DATA    EQU $C880+$325   ; Mutable array 'enemy_vy' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_SIZE_DATA  EQU $C880+$335   ; Mutable array 'enemy_size' data (8 elements x 2 bytes) (16 bytes)
PSG_MUSIC_PTR        EQU $C880+$345   ; PSG music data pointer (2 bytes)
PSG_MUSIC_START      EQU $C880+$347   ; PSG music start pointer (for loops) (2 bytes)
PSG_MUSIC_ACTIVE     EQU $C880+$349   ; PSG music active flag (1 bytes)
PSG_IS_PLAYING       EQU $C880+$34A   ; PSG playing flag (1 bytes)
PSG_DELAY_FRAMES     EQU $C880+$34B   ; PSG frame delay counter (1 bytes)
PSG_MUSIC_BANK       EQU $C880+$34C   ; PSG music bank ID (for multibank) (1 bytes)
SFX_PTR              EQU $C880+$34D   ; SFX data pointer (2 bytes)
SFX_ACTIVE           EQU $C880+$34F   ; SFX active flag (1 bytes)
SFX_BANK             EQU $C880+$350   ; SFX bank ID (for multibank) (1 bytes)
VAR_ARG0             EQU $C880+$351   ; Function argument 0 (16-bit) (2 bytes)
VAR_ARG1             EQU $C880+$353   ; Function argument 1 (16-bit) (2 bytes)
VAR_ARG2             EQU $C880+$355   ; Function argument 2 (16-bit) (2 bytes)
VAR_ARG3             EQU $C880+$357   ; Function argument 3 (16-bit) (2 bytes)
VAR_ARG4             EQU $C880+$359   ; Function argument 4 (16-bit) (2 bytes)
CURRENT_ROM_BANK     EQU $C880+$35B   ; Current ROM bank ID (multibank tracking) (1 bytes)
