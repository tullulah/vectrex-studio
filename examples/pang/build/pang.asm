...
VAR_SCREEN           EQU $C880+$2E4   ; User variable: screen (2 bytes)
VAR_TITLE_INTENSITY  EQU $C880+$2E6   ; User variable: title_intensity (2 bytes)
VAR_TITLE_STATE      EQU $C880+$2E8   ; User variable: title_state (2 bytes)
VAR_CURRENT_MUSIC    EQU $C880+$2EA   ; User variable: current_music (2 bytes)
VAR_LOCATION_X_COORDS EQU $C880+$2EC   ; User variable: location_x_coords (2 bytes)
VAR_LOCATION_Y_COORDS EQU $C880+$2EE   ; User variable: location_y_coords (2 bytes)
VAR_LOCATION_NAMES   EQU $C880+$2F0   ; User variable: location_names (2 bytes)
VAR_LEVEL_BACKGROUNDS EQU $C880+$2F2   ; User variable: level_backgrounds (2 bytes)
VAR_LEVEL_ENEMY_COUNT EQU $C880+$2F4   ; User variable: level_enemy_count (2 bytes)
VAR_LEVEL_ENEMY_SPEED EQU $C880+$2F6   ; User variable: level_enemy_speed (2 bytes)
VAR_PREV_BTN1        EQU $C880+$2F8   ; User variable: prev_btn1 (2 bytes)
VAR_PREV_BTN2        EQU $C880+$2FA   ; User variable: prev_btn2 (2 bytes)
VAR_PREV_BTN3        EQU $C880+$2FC   ; User variable: prev_btn3 (2 bytes)
VAR_PREV_BTN4        EQU $C880+$2FE   ; User variable: prev_btn4 (2 bytes)
VAR_NUM_LOCATIONS    EQU $C880+$300   ; User variable: num_locations (2 bytes)
VAR_CURRENT_LOCATION EQU $C880+$302   ; User variable: current_location (2 bytes)
VAR_LOCATION_GLOW_INTENSITY EQU $C880+$304   ; User variable: location_glow_intensity (2 bytes)
VAR_LOCATION_GLOW_DIRECTION EQU $C880+$306   ; User variable: location_glow_direction (2 bytes)
VAR_JOY_X            EQU $C880+$308   ; User variable: joy_x (2 bytes)
VAR_JOY_Y            EQU $C880+$30A   ; User variable: joy_y (2 bytes)
VAR_PREV_JOY_X       EQU $C880+$30C   ; User variable: prev_joy_x (2 bytes)
VAR_PREV_JOY_Y       EQU $C880+$30E   ; User variable: prev_joy_y (2 bytes)
VAR_COUNTDOWN_TIMER  EQU $C880+$310   ; User variable: countdown_timer (2 bytes)
VAR_COUNTDOWN_ACTIVE EQU $C880+$312   ; User variable: countdown_active (2 bytes)
VAR_JOYSTICK_POLL_COUNTER EQU $C880+$314   ; User variable: joystick_poll_counter (2 bytes)
VAR_HOOK_ACTIVE      EQU $C880+$316   ; User variable: hook_active (2 bytes)
VAR_HOOK_X           EQU $C880+$318   ; User variable: hook_x (2 bytes)
VAR_HOOK_Y           EQU $C880+$31A   ; User variable: hook_y (2 bytes)
VAR_HOOK_MAX_Y       EQU $C880+$31C   ; User variable: hook_max_y (2 bytes)
VAR_HOOK_GUN_X       EQU $C880+$31E   ; User variable: hook_gun_x (2 bytes)
VAR_HOOK_GUN_Y       EQU $C880+$320   ; User variable: hook_gun_y (2 bytes)
VAR_HOOK_INIT_Y      EQU $C880+$322   ; User variable: hook_init_y (2 bytes)
VAR_PLAYER_X         EQU $C880+$324   ; User variable: player_x (2 bytes)
VAR_PLAYER_Y         EQU $C880+$326   ; User variable: player_y (2 bytes)
VAR_MOVE_SPEED       EQU $C880+$328   ; User variable: move_speed (2 bytes)
VAR_ABS_JOY          EQU $C880+$32A   ; User variable: abs_joy (2 bytes)
VAR_PLAYER_ANIM_FRAME EQU $C880+$32C   ; User variable: player_anim_frame (2 bytes)
VAR_PLAYER_ANIM_COUNTER EQU $C880+$32E   ; User variable: player_anim_counter (2 bytes)
VAR_PLAYER_ANIM_SPEED EQU $C880+$330   ; User variable: player_anim_speed (2 bytes)
VAR_PLAYER_FACING    EQU $C880+$332   ; User variable: player_facing (2 bytes)
VAR_MAX_ENEMIES      EQU $C880+$334   ; User variable: MAX_ENEMIES (2 bytes)
VAR_GRAVITY          EQU $C880+$336   ; User variable: GRAVITY (2 bytes)
VAR_BOUNCE_DAMPING   EQU $C880+$338   ; User variable: BOUNCE_DAMPING (2 bytes)
VAR_MIN_BOUNCE_VY    EQU $C880+$33A   ; User variable: MIN_BOUNCE_VY (2 bytes)
VAR_GROUND_Y         EQU $C880+$33C   ; User variable: GROUND_Y (2 bytes)
VAR_JOYSTICK1_STATE  EQU $C880+$33E   ; User variable: joystick1_state (2 bytes)
VAR_LOC_X            EQU $C880+$340   ; User variable: loc_x (2 bytes)
VAR_LOC_Y            EQU $C880+$342   ; User variable: loc_y (2 bytes)
VAR_ANIM_THRESHOLD   EQU $C880+$344   ; User variable: anim_threshold (2 bytes)
VAR_MIRROR_MODE      EQU $C880+$346   ; User variable: mirror_mode (2 bytes)
VAR_COUNT            EQU $C880+$348   ; User variable: count (2 bytes)
VAR_SPEED            EQU $C880+$34A   ; User variable: speed (2 bytes)
VAR_I                EQU $C880+$34C   ; User variable: i (2 bytes)
VAR_ENEMY_ACTIVE     EQU $C880+$34E   ; User variable: enemy_active (2 bytes)
VAR_ENEMY_SIZE       EQU $C880+$350   ; User variable: enemy_size (2 bytes)
VAR_ENEMY_X          EQU $C880+$352   ; User variable: enemy_x (2 bytes)
VAR_ENEMY_Y          EQU $C880+$354   ; User variable: enemy_y (2 bytes)
VAR_ENEMY_VX         EQU $C880+$356   ; User variable: enemy_vx (2 bytes)
VAR_ENEMY_VY         EQU $C880+$358   ; User variable: enemy_vy (2 bytes)
VAR_START_X          EQU $C880+$35A   ; User variable: start_x (2 bytes)
VAR_START_Y          EQU $C880+$35C   ; User variable: start_y (2 bytes)
VAR_END_X            EQU $C880+$35E   ; User variable: end_x (2 bytes)
VAR_END_Y            EQU $C880+$360   ; User variable: end_y (2 bytes)
VAR_JOYSTICK1_STATE_DATA EQU $C880+$362   ; Mutable array 'joystick1_state' data (6 elements x 2 bytes) (12 bytes)
VAR_ENEMY_ACTIVE_DATA EQU $C880+$36E   ; Mutable array 'enemy_active' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_X_DATA     EQU $C880+$37E   ; Mutable array 'enemy_x' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_Y_DATA     EQU $C880+$38E   ; Mutable array 'enemy_y' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VX_DATA    EQU $C880+$39E   ; Mutable array 'enemy_vx' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_VY_DATA    EQU $C880+$3AE   ; Mutable array 'enemy_vy' data (8 elements x 2 bytes) (16 bytes)
VAR_ENEMY_SIZE_DATA  EQU $C880+$3BE   ; Mutable array 'enemy_size' data (8 elements x 2 bytes) (16 bytes)
