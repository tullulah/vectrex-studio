    Finished `dev` profile [unoptimized + debuginfo] target(s) in 0.04s
     Running `buildtools/target/debug/vpy_cli asm examples/pang/src/main.vpy`
=== GENERATE UNIFIED ASM ===

Bank Configuration:
  ROM Total: 32768 bytes
  Bank Size: 32768 bytes
  Bank Count: 1
  Helpers Bank: 0 (DYNAMIC - not hardcoded 31)
  Title: PANG
  Single-bank mode

Generating unified ASM...
  ASM size: 508615 bytes
  Symbols: 0
  External refs: 0
