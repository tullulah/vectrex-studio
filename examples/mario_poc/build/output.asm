...
@ --- User variables (RAM) ---
.equ VAR_MARIO_HH, 0x2007F300  @ const scalar
.equ VAR_MARIO_HW, 0x2007F304  @ const scalar
.equ VAR_PLAYER_X, 0x2007F308
.equ VAR_PLAYER_Y, 0x2007F30C
.equ VAR_VEL_Y, 0x2007F310
.equ VAR_ON_GROUND, 0x2007F314
.equ VAR_PREV_Y, 0x2007F318
.equ VAR_CAMERA_X, 0x2007F31C
.equ VAR_SCROLL_LEFT, 0x2007F320
.equ VAR_SCROLL_RIGHT, 0x2007F324
.equ VAR_SCROLL_RIGHT_EDGE, 0x2007F328
.equ VAR_SCREEN_X, 0x2007F32C
.equ VAR_IS_WALKING, 0x2007F330
.equ VAR_FLOOR_Y, 0x2007F334
.equ VAR_JOY_X, 0x2007F338  @ implicit
.equ VAR_BTN_JUMP, 0x2007F33C  @ implicit
.equ VAR_DX_PUSH, 0x2007F340  @ implicit
...
game_main:
    ...
    pop     {r0}
    bl      vpy_load_level
    bl      vpy_get_scroll_limit_left
    ldr     r1, =0x2007F320    @ SCROLL_LEFT
    str     r0, [r1]
    bl      vpy_get_scroll_limit_right
    ldr     r1, =0x2007F324    @ SCROLL_RIGHT
    str     r0, [r1]
    ldr     r1, =0x2007F324    @ SCROLL_RIGHT
    ldr     r0, [r1]
    push    {r0}
    ...
    pop     {r0}
    sub     r0, r0, r1
    ldr     r1, =0x2007F328    @ SCROLL_RIGHT_EDGE
    str     r0, [r1]
game_main_loop:
    bl      vpy_wait_recal
    ...
    bl      vpy_audio_update
    bl      vpy_j1_x
    ldr     r1, =0x2007F338    @ JOY_X
    str     r0, [r1]
    bl      vpy_j1_btn1
    ldr     r1, =0x2007F33C    @ BTN_JUMP
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F330    @ IS_WALKING
    str     r0, [r1]
    ldr     r1, =0x2007F338    @ JOY_X
    ldr     r0, [r1]
    push    {r0}
...
.Lcf2e:
    ...
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F30C    @ PLAYER_Y
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F304    @ MARIO_HW
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F300    @ MARIO_HH
    ldr     r0, [r1]
    push    {r0}
    pop     {r3}
    pop     {r2}
