...
.equ PIN_A1,         8          @ A1  (GPIO8)
.equ PIN_A14,        21         @ A14 (GPIO21)
.equ ADDR_MASK,      0x003FFF00  @ GPIO 8-21 = A1-A14
.equ PIN_PB6,        22         @ VIA Port B bit 6 (beam control)
.equ PIN_NIRQ,       23         @ /IRQ
.equ PIN_A14B,       24         @ A14 copy (/CART detect)
.equ PIN_A15,        25         @ A15
...
.equ VAR_PLAYER_X, 0x2007F290
.equ VAR_PLAYER_Y, 0x2007F294
.equ VAR_VEL_Y, 0x2007F298
.equ VAR_ON_GROUND, 0x2007F29C
.equ VAR_PREV_Y, 0x2007F2A0
.equ VAR_CAMERA_X, 0x2007F2A4
.equ VAR_FLOOR_Y, 0x2007F2A8
.equ VAR_JOY_X, 0x2007F2AC  @ implicit
.equ VAR_BTN_JUMP, 0x2007F2B0  @ implicit
...
game_main_loop:
    ...
    bl      vpy_audio_update
    bl      vpy_j1_x
    ldr     r1, =0x2007F2AC    @ JOY_X
    str     r0, [r1]
    bl      vpy_j1_btn1
    ldr     r1, =0x2007F2B0    @ BTN_JUMP
    str     r0, [r1]
    ldr     r1, =0x2007F2AC    @ JOY_X
    ldr     r0, [r1]
    push    {r0}
...
.Lcf4e:
    cmp     r0, #0
    beq     if_else_4
    ldr     r1, =0x2007F294    @ PLAYER_Y
    ldr     r0, [r1]
    ldr     r1, =0x2007F2A0    @ PREV_Y
    str     r0, [r1]
    ldr     r1, =0x2007F294    @ PLAYER_Y
    ldr     r0, [r1]
    push    {r0}
...
_THEME_MUSIC:
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=907 delay=6 writes=3
    .byte   8, 0  @ PSG r8
    .byte   10, 0  @ PSG r10
    .byte   7, 60  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 5  @ frame=928 delay=6 writes=5
    .byte   8, 0  @ PSG r8
    .byte   4, 135  @ PSG r4
    .byte   5, 3  @ PSG r5
    .byte   10, 13  @ PSG r10
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   12, 3  @ frame=955 delay=12 writes=3
    .byte   6, 22  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=962 delay=6 writes=3
    .byte   6, 22  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=969 delay=6 writes=3
    .byte   6, 19  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=1350 delay=6 writes=3
    .byte   8, 0  @ PSG r8
    .byte   10, 0  @ PSG r10
    .byte   7, 60  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 5  @ frame=1371 delay=6 writes=5
    .byte   8, 0  @ PSG r8
    .byte   4, 135  @ PSG r4
    .byte   5, 3  @ PSG r5
    .byte   10, 13  @ PSG r10
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   12, 3  @ frame=1398 delay=12 writes=3
    .byte   6, 22  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=1405 delay=6 writes=3
    .byte   6, 22  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=1412 delay=6 writes=3
    .byte   6, 19  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 6  @ frame=1454 delay=6 writes=6
    .byte   8, 0  @ PSG r8
    .byte   10, 0  @ PSG r10
    .byte   2, 246  @ PSG r2
    .byte   3, 3  @ PSG r3
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 56  @ PSG r7
    .byte   6, 3  @ frame=1468 delay=6 writes=3
    .byte   6, 22  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 8  @ frame=1482 delay=6 writes=8
    .byte   8, 0  @ PSG r8
    .byte   2, 63  @ PSG r2
    .byte   3, 1  @ PSG r3
    .byte   9, 14  @ PSG r9
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 6  @ frame=1509 delay=6 writes=6
    .byte   8, 0  @ PSG r8
    .byte   10, 0  @ PSG r10
    .byte   2, 246  @ PSG r2
    .byte   3, 3  @ PSG r3
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 56  @ PSG r7
    .byte   6, 9  @ frame=1523 delay=6 writes=9
    .byte   6, 21  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   2, 213  @ PSG r2
    .byte   3, 0  @ PSG r3
    ...
    .byte   9, 0  @ PSG r9
    .byte   7, 50  @ PSG r7
    .byte   8, 6  @ frame=1537 delay=8 writes=6
    .byte   6, 23  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   2, 164  @ PSG r2
    .byte   3, 2  @ PSG r3
    .byte   9, 13  @ PSG r9
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=1544 delay=6 writes=3
    .byte   6, 24  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 6  @ frame=1565 delay=6 writes=6
    .byte   8, 0  @ PSG r8
    .byte   10, 0  @ PSG r10
    .byte   2, 246  @ PSG r2
    .byte   3, 3  @ PSG r3
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 56  @ PSG r7
    .byte   5, 3  @ frame=1578 delay=5 writes=3
    .byte   6, 22  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 8  @ frame=1592 delay=6 writes=8
    .byte   8, 0  @ PSG r8
    .byte   2, 63  @ PSG r2
    .byte   3, 1  @ PSG r3
    .byte   9, 14  @ PSG r9
    ...
    .byte   8, 13  @ PSG r8
    .byte   7, 48  @ PSG r7
    .byte   13, 2  @ frame=1620 delay=13 writes=2
    .byte   8, 0  @ PSG r8
    .byte   7, 56  @ PSG r7
    ...
    .byte   10, 0  @ PSG r10
    .byte   7, 62  @ PSG r7
    .byte   4, 9  @ frame=1627 delay=4 writes=9
    .byte   6, 25  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   2, 71  @ PSG r2
    .byte   3, 0  @ PSG r3
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   13, 9  @ frame=1641 delay=13 writes=9
    .byte   6, 25  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   2, 80  @ PSG r2
    .byte   3, 0  @ PSG r3
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=1648 delay=6 writes=3
    .byte   6, 24  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    .byte   6, 3  @ frame=1655 delay=6 writes=3
    .byte   6, 23  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 6  @ frame=1675 delay=6 writes=6
    .byte   8, 0  @ PSG r8
    .byte   10, 0  @ PSG r10
    .byte   2, 246  @ PSG r2
    .byte   3, 3  @ PSG r3
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 56  @ PSG r7
    .byte   6, 3  @ frame=1689 delay=6 writes=3
    .byte   6, 22  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 48  @ PSG r7
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 48  @ PSG r7
    .byte   6, 8  @ frame=1703 delay=6 writes=8
    .byte   8, 0  @ PSG r8
    .byte   2, 63  @ PSG r2
    .byte   3, 1  @ PSG r3
    .byte   9, 14  @ PSG r9
    ...
    .byte   10, 14  @ PSG r10
    .byte   7, 56  @ PSG r7
    .byte   6, 6  @ frame=1745 delay=6 writes=6
    .byte   6, 21  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   4, 213  @ PSG r4
    .byte   5, 0  @ PSG r5
    ...
    .byte   10, 0  @ PSG r10
    .byte   7, 52  @ PSG r7
    .byte   2, 3  @ frame=1752 delay=2 writes=3
    .byte   6, 27  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 52  @ PSG r7
    .byte   5, 6  @ frame=1758 delay=5 writes=6
    .byte   6, 26  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   4, 135  @ PSG r4
    .byte   5, 3  @ PSG r5
    ...
    .byte   10, 0  @ PSG r10
    .byte   7, 52  @ PSG r7
    .byte   1, 3  @ frame=1765 delay=1 writes=3
    .byte   6, 25  @ PSG r6
    .byte   8, 7  @ PSG r8
    .byte   7, 52  @ PSG r7
