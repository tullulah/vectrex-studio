...
.equ USER_RAM_START,      0x2007F29C  @ user variables begin here
...
.equ VAR_SCROLL_LEFT, 0x2007F2AC
.equ VAR_SCROLL_RIGHT, 0x2007F2B0
.equ VAR_SCROLL_RIGHT_EDGE, 0x2007F2B4
.equ VAR_SCREEN_X, 0x2007F2B8
.equ VAR_IS_WALKING, 0x2007F2BC
.equ VAR_FLOOR_Y, 0x2007F2C0
.equ VAR_JOY_X, 0x2007F2C4  @ implicit
.equ VAR_BTN_JUMP, 0x2007F2C8  @ implicit
.equ VAR_DX_PUSH, 0x2007F2CC  @ implicit
...
game_main:
    ...
    ldr     r1, =0x2007F2AC    @ SCROLL_LEFT
    str     r0, [r1]
    bl      vpy_get_scroll_limit_right
    ldr     r1, =0x2007F2B0    @ SCROLL_RIGHT
    str     r0, [r1]
    ldr     r1, =0x2007F2B0    @ SCROLL_RIGHT
    ldr     r0, [r1]
    push    {r0}
    ...
    pop     {r0}
    sub     r0, r0, r1
    ldr     r1, =0x2007F2B4    @ SCROLL_RIGHT_EDGE
    str     r0, [r1]
game_main_loop:
    bl      vpy_wait_recal
    ...
    bl      vpy_audio_update
    bl      vpy_j1_x
    ldr     r1, =0x2007F2C4    @ JOY_X
    str     r0, [r1]
    bl      vpy_j1_btn1
    ldr     r1, =0x2007F2C8    @ BTN_JUMP
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F2BC    @ IS_WALKING
    str     r0, [r1]
    ldr     r1, =0x2007F2C4    @ JOY_X
    ldr     r0, [r1]
    push    {r0}
