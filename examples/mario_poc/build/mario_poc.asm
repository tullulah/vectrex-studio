...
.equ VAR_MARIO_HH, 0x0010016C  @ const scalar
.equ VAR_MARIO_HW, 0x00100170  @ const scalar
.equ VAR_PLAYER_X, 0x00100174
.equ VAR_PLAYER_Y, 0x00100178
.equ VAR_VEL_Y, 0x0010017C
.equ VAR_ON_GROUND, 0x00100180
.equ VAR_PREV_Y, 0x00100184
.equ VAR_CAMERA_X, 0x00100188
.equ VAR_SCROLL_LEFT, 0x0010018C
.equ VAR_SCROLL_RIGHT, 0x00100190
.equ VAR_SCROLL_RIGHT_EDGE, 0x00100194
.equ VAR_SCREEN_X, 0x00100198
.equ VAR_IS_WALKING, 0x0010019C
.equ VAR_FLOOR_Y, 0x001001A0
.equ VAR_JOY_X, 0x001001A4  @ local assign
.equ VAR_BTN_JUMP, 0x001001A8  @ local assign
.equ VAR_DX_PUSH, 0x001001AC  @ local assign
...
.Lgp_1:
    ...
    bl      pitrex_get_scroll_limit_left
    ldr     r1, =0x0010018C    @ SCROLL_LEFT
    str     r0, [r1]
    bl      pitrex_get_scroll_limit_right
    ldr     r1, =0x00100190    @ SCROLL_RIGHT
    str     r0, [r1]
    ldr     r1, =0x00100190    @ SCROLL_RIGHT
    ldr     r0, [r1]
    push    {r0}
    ...
    pop     {r0}
    sub     r0, r0, r1
    ldr     r1, =0x00100194    @ SCROLL_RIGHT_EDGE
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
...
pitrex_game_loop:
    ...
    bl      pitrex_j1_x
    ldr     r1, =0x001001A4    @ JOY_X
    str     r0, [r1]
    bl      pitrex_j1_btn1
    ldr     r1, =0x001001A8    @ BTN_JUMP
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x0010019C    @ IS_WALKING
    str     r0, [r1]
    ldr     r1, =0x001001A4    @ JOY_X
    ldr     r0, [r1]
    push    {r0}
...
.Lcf2e:
    ...
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100178    @ PLAYER_Y
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100170    @ MARIO_HW
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x0010016C    @ MARIO_HH
    ldr     r0, [r1]
    push    {r0}
    pop     {r3}
    pop     {r2}
