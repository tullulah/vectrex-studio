...
UGPC_OUTER_IDX       EQU $C880+$238   ; GP-GP outer loop index (1 bytes)
UGPC_OUTER_MAX       EQU $C880+$239   ; GP-GP outer loop max (count-1) (1 bytes)
UGPC_INNER_IDX       EQU $C880+$23A   ; GP-GP inner loop index (1 bytes)
UGPC_DX              EQU $C880+$23B   ; GP-GP |dx| (16-bit) (2 bytes)
UGPC_DIST            EQU $C880+$23D   ; GP-GP Manhattan distance (16-bit) (2 bytes)
UGFC_GP_IDX          EQU $C880+$23F   ; GP-FG outer loop GP index (1 bytes)
UGFC_FG_COUNT        EQU $C880+$240   ; GP-FG inner loop FG count (1 bytes)
UGFC_DX              EQU $C880+$241   ; GP-FG |dx| (1 bytes)
UGFC_DY              EQU $C880+$242   ; GP-FG |dy| (1 bytes)
VAR_MARIO_HH         EQU $C880+$243   ; User variable: MARIO_HH (2 bytes)
VAR_MARIO_HW         EQU $C880+$245   ; User variable: MARIO_HW (2 bytes)
VAR_PLAYER_X         EQU $C880+$247   ; User variable: PLAYER_X (2 bytes)
VAR_PLAYER_Y         EQU $C880+$249   ; User variable: PLAYER_Y (2 bytes)
VAR_VEL_Y            EQU $C880+$24B   ; User variable: VEL_Y (2 bytes)
VAR_ON_GROUND        EQU $C880+$24D   ; User variable: ON_GROUND (1 bytes)
VAR_PREV_Y           EQU $C880+$24E   ; User variable: PREV_Y (2 bytes)
VAR_CAMERA_X         EQU $C880+$250   ; User variable: CAMERA_X (2 bytes)
VAR_FLOOR_Y          EQU $C880+$252   ; User variable: FLOOR_Y (2 bytes)
VAR_JOY_X            EQU $C880+$254   ; User variable: JOY_X (2 bytes)
VAR_BTN_JUMP         EQU $C880+$256   ; User variable: BTN_JUMP (2 bytes)
VAR_DX_PUSH          EQU $C880+$258   ; User variable: DX_PUSH (2 bytes)
...
; Scratch: borrows LCOL_PHH (total_hw) during run.
