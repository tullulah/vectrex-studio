...
.equ VAR_FLOOR_Y, 0x0010017C
.equ VAR_JOY_X, 0x00100180  @ local assign
.equ VAR_BTN_JUMP, 0x00100184  @ local assign
.equ VAR_DX_PUSH, 0x00100188  @ local assign
...
pitrex_game_loop:
    ...
    bl      pitrex_j1_x
    ldr     r1, =0x00100180    @ JOY_X
    str     r0, [r1]
    bl      pitrex_j1_btn1
    ldr     r1, =0x00100184    @ BTN_JUMP
    str     r0, [r1]
    ldr     r1, =0x00100180    @ JOY_X
    ldr     r0, [r1]
    push    {r0}
