...
VAR_JOYSTICK1_STATE  EQU $C880+$2B   ; User variable: JOYSTICK1_STATE (2 bytes)
VAR_JOYSTICK1_STATE_DATA EQU $C880+$2D   ; Mutable array 'JOYSTICK1_STATE' data (6 elements x 2 bytes) (12 bytes)
