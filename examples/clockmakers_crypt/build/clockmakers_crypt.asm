...
VAR_BTN              EQU $C880+$11D   ; User variable: BTN (2 bytes)
VAR_ROOM_ID          EQU $C880+$121   ; User variable: room_id (2 bytes)
VAR_ROOM_ID          EQU $C880+$121   ; User variable: ROOM_ID (2 bytes)
VAR_JOY_X            EQU $C880+$123   ; User variable: JOY_X (2 bytes)
VAR_BTN3             EQU $C880+$125   ; User variable: BTN3 (2 bytes)
VAR_BTN1             EQU $C880+$127   ; User variable: BTN1 (2 bytes)
VAR_DX               EQU $C880+$129   ; User variable: DX (2 bytes)
VAR_DY               EQU $C880+$12B   ; User variable: DY (2 bytes)
VAR_HS               EQU $C880+$12F   ; User variable: hs (2 bytes)
VAR_HS               EQU $C880+$12F   ; User variable: HS (2 bytes)
VAR_SCREEN_X         EQU $C880+$131   ; User variable: SCREEN_X (2 bytes)
