...
VAR_CLOCK_HS_COUNT   EQU $C880+$F7   ; User variable: CLOCK_HS_COUNT (2 bytes)
VAR_CLOCK_HS_SARC    EQU $C880+$F9   ; User variable: CLOCK_HS_SARC (2 bytes)
VAR_CLOCK_HS_CLOCK   EQU $C880+$FB   ; User variable: CLOCK_HS_CLOCK (2 bytes)
VAR_CLOCK_HS_X       EQU $C880+$FD   ; User variable: CLOCK_HS_X (2 bytes)
VAR_CLOCK_HS_Y       EQU $C880+$FF   ; User variable: CLOCK_HS_Y (2 bytes)
VAR_CLOCK_HS_W       EQU $C880+$101   ; User variable: CLOCK_HS_W (2 bytes)
VAR_CLOCK_HS_H       EQU $C880+$103   ; User variable: CLOCK_HS_H (2 bytes)
VAR_SCREEN           EQU $C880+$105   ; User variable: screen (2 bytes)
VAR_BLINK_TIMER      EQU $C880+$107   ; User variable: blink_timer (2 bytes)
VAR_BLINK_ON         EQU $C880+$109   ; User variable: blink_on (2 bytes)
VAR_INTRO_PAGE       EQU $C880+$10B   ; User variable: intro_page (2 bytes)
VAR_CURRENT_ROOM     EQU $C880+$10D   ; User variable: current_room (2 bytes)
VAR_PLAYER_X         EQU $C880+$10F   ; User variable: player_x (2 bytes)
VAR_PLAYER_Y         EQU $C880+$111   ; User variable: player_y (2 bytes)
VAR_SCROLL_X         EQU $C880+$113   ; User variable: scroll_x (2 bytes)
VAR_PLAYER_SPEED     EQU $C880+$115   ; User variable: player_speed (2 bytes)
VAR_CURRENT_VERB     EQU $C880+$117   ; User variable: current_verb (2 bytes)
VAR_NEAR_HS          EQU $C880+$119   ; User variable: near_hs (2 bytes)
VAR_MSG_ID           EQU $C880+$11B   ; User variable: msg_id (2 bytes)
VAR_MSG_TIMER        EQU $C880+$11D   ; User variable: msg_timer (2 bytes)
VAR_ROOM_EXIT        EQU $C880+$11F   ; User variable: room_exit (2 bytes)
VAR_FLAG_DATE_KNOWN  EQU $C880+$121   ; User variable: flag_date_known (2 bytes)
VAR_FLAG_TALLER_OPEN EQU $C880+$123   ; User variable: flag_taller_open (2 bytes)
VAR_FLAG_SARC_OPEN   EQU $C880+$125   ; User variable: flag_sarc_open (2 bytes)
VAR_EXIT_TO_ENDING   EQU $C880+$127   ; User variable: exit_to_ending (2 bytes)
VAR_CURRENT_MUSIC    EQU $C880+$129   ; User variable: current_music (2 bytes)
VAR_PREV_BTN1        EQU $C880+$12B   ; User variable: prev_btn1 (2 bytes)
VAR_PREV_BTN3        EQU $C880+$12D   ; User variable: prev_btn3 (2 bytes)
VAR_BTN1_FIRED       EQU $C880+$12F   ; User variable: btn1_fired (2 bytes)
VAR_BTN3_FIRED       EQU $C880+$131   ; User variable: btn3_fired (2 bytes)
VAR_B1               EQU $C880+$133   ; User variable: b1 (2 bytes)
VAR_B3               EQU $C880+$135   ; User variable: b3 (2 bytes)
VAR_ROOM_ID          EQU $C880+$137   ; User variable: room_id (2 bytes)
VAR_JOY_X            EQU $C880+$139   ; User variable: joy_x (2 bytes)
VAR_DX               EQU $C880+$13B   ; User variable: dx (2 bytes)
VAR_DY               EQU $C880+$13D   ; User variable: dy (2 bytes)
VAR_HS               EQU $C880+$13F   ; User variable: hs (2 bytes)
VAR_SCREEN_X         EQU $C880+$141   ; User variable: screen_x (2 bytes)
...
; Array literal for variable 'CLOCK_HS_X' (2 elements, 2 bytes each)
ARRAY_CLOCK_HS_X_DATA:
    FDB 190   ; Element 0
    FDB 400   ; Element 1

; Array literal for variable 'CLOCK_HS_Y' (2 elements, 2 bytes each)
ARRAY_CLOCK_HS_Y_DATA:
    FDB -80   ; Element 0
    FDB -70   ; Element 1

; Array literal for variable 'CLOCK_HS_W' (2 elements, 2 bytes each)
ARRAY_CLOCK_HS_W_DATA:
    FDB 40   ; Element 0
    FDB 35   ; Element 1

; Array literal for variable 'CLOCK_HS_H' (2 elements, 2 bytes each)
...
MAIN:
    ...
    LDD #0
    STD RESULT
    STD VAR_FLAG_SARC_OPEN
    LDD #0
    STD RESULT
    STD VAR_EXIT_TO_ENDING
...
draw_title:
    ...
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH7  ; Load path 7
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH8  ; Load path 8
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH9  ; Load path 9
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH10  ; Load path 10
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH11  ; Load path 11
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH12  ; Load path 12
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH13  ; Load path 13
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH14  ; Load path 14
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH15  ; Load path 15
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH16  ; Load path 16
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH17  ; Load path 17
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH18  ; Load path 18
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH19  ; Load path 19
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH20  ; Load path 20
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH21  ; Load path 21
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH22  ; Load path 22
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH23  ; Load path 23
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH24  ; Load path 24
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH25  ; Load path 25
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH26  ; Load path 26
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH27  ; Load path 27
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH28  ; Load path 28
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH29  ; Load path 29
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH30  ; Load path 30
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH31  ; Load path 31
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH32  ; Load path 32
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH33  ; Load path 33
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH34  ; Load path 34
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH35  ; Load path 35
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH36  ; Load path 36
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH37  ; Load path 37
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH38  ; Load path 38
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH39  ; Load path 39
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH40  ; Load path 40
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH41  ; Load path 41
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH42  ; Load path 42
    JSR Draw_Sync_List_At_With_Mirrors
    LDX #_LOGO_PATH43  ; Load path 43
    JSR Draw_Sync_List_At_With_Mirrors
...
.CMP_23_END:
    ...
    LDX #_CLOCKROOM_LEVEL          ; Pointer to level data in ROM
    JSR LOAD_LEVEL_RUNTIME
    LDD #70
    STD RESULT
    LDD RESULT
...
; Function: check_clockroom_hotspots
check_clockroom_hotspots:
    LDD >VAR_PLAYER_X
    STD RESULT
    LDD RESULT
    STD TMPVAL          ; Save left operand to TMPVAL (stack-safe temp)
...
IF_NEXT_80:
    ...
    LDD RESULT
    STD VAR_EXIT_TO_ENDING
    ; PLAY_SFX("puzzle_success") - play SFX asset (index=2)
    LDX #_PUZZLE_SUCCESS_SFX  ; Load SFX data pointer
    JSR PLAY_SFX_RUNTIME
    LDD #0
    STD RESULT
IF_END_79:
...
.CMP_75_END:
    ...
    LDD RESULT
    LBEQ IF_END_86
    JSR draw_clockroom_action_line
    LBRA IF_END_86
IF_END_86:
    LBRA IF_END_84
IF_NEXT_85:
...
; Function: draw_clockroom_action_line
draw_clockroom_action_line:
    LDD #0  ; const CLOCK_HS_SARC
    STD RESULT
    LDD RESULT
    STD TMPVAL          ; Save right operand to TMPVAL (stack-safe temp)
...
.CMP_86_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_12641232965239080973      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_87_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_13843794019476522291      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_88_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_931851343526459475      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_90_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_9476469358947353920      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_91_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_13777482088983958502      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_92_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_1306255401665072902      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_101_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_564764511967242620      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_4509857456104209203      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_9469988307073198007      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_102_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_6343893941434420413      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_6906140908233091688      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_4514345320188155635      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.CMP_103_END:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_15001376415733204503      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_11806333666897636487      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
draw_ending:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_2512255219486809515      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_9303927173923537616      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_8675300455265089919      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_9005050258175366001      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_2328381712862181292      ; Pointer to string in helpers bank
    STX VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
; Total paths: 44, points: 358
; X bounds: min=-104, max=104, width=208
; Center: (0, 26)

_LOGO_WIDTH EQU 208
_LOGO_HALF_WIDTH EQU 104
_LOGO_CENTER_X EQU 0
_LOGO_CENTER_Y EQU 26

_LOGO_VECTORS:  ; Main entry (header + 44 path(s))
    FCB 44               ; path_count (runtime metadata)
    ...
    FDB _LOGO_PATH7        ; pointer to path 7
    FDB _LOGO_PATH8        ; pointer to path 8
    FDB _LOGO_PATH9        ; pointer to path 9
    FDB _LOGO_PATH10        ; pointer to path 10
    FDB _LOGO_PATH11        ; pointer to path 11
    FDB _LOGO_PATH12        ; pointer to path 12
    FDB _LOGO_PATH13        ; pointer to path 13
    FDB _LOGO_PATH14        ; pointer to path 14
    FDB _LOGO_PATH15        ; pointer to path 15
    FDB _LOGO_PATH16        ; pointer to path 16
    FDB _LOGO_PATH17        ; pointer to path 17
    FDB _LOGO_PATH18        ; pointer to path 18
    FDB _LOGO_PATH19        ; pointer to path 19
    FDB _LOGO_PATH20        ; pointer to path 20
    FDB _LOGO_PATH21        ; pointer to path 21
    FDB _LOGO_PATH22        ; pointer to path 22
    FDB _LOGO_PATH23        ; pointer to path 23
    FDB _LOGO_PATH24        ; pointer to path 24
    FDB _LOGO_PATH25        ; pointer to path 25
    FDB _LOGO_PATH26        ; pointer to path 26
    FDB _LOGO_PATH27        ; pointer to path 27
    FDB _LOGO_PATH28        ; pointer to path 28
    FDB _LOGO_PATH29        ; pointer to path 29
    FDB _LOGO_PATH30        ; pointer to path 30
    FDB _LOGO_PATH31        ; pointer to path 31
    FDB _LOGO_PATH32        ; pointer to path 32
    FDB _LOGO_PATH33        ; pointer to path 33
    FDB _LOGO_PATH34        ; pointer to path 34
    FDB _LOGO_PATH35        ; pointer to path 35
    FDB _LOGO_PATH36        ; pointer to path 36
    FDB _LOGO_PATH37        ; pointer to path 37
    FDB _LOGO_PATH38        ; pointer to path 38
    FDB _LOGO_PATH39        ; pointer to path 39
    FDB _LOGO_PATH40        ; pointer to path 40
    FDB _LOGO_PATH41        ; pointer to path 41
    FDB _LOGO_PATH42        ; pointer to path 42
    FDB _LOGO_PATH43        ; pointer to path 43

_LOGO_PATH0:    ; Path 0
    FCB 31              ; path0: intensity
    FCB $2A,$23,0,0        ; path0: header (y=42, x=35, relative to center)
    FCB $FF,$0D,$FD          ; flag=-1, dy=13, dx=-3
    FCB $FF,$0B,$F9          ; flag=-1, dy=11, dx=-7
    FCB $FF,$07,$F5          ; flag=-1, dy=7, dx=-11
    FCB $FF,$03,$F3          ; flag=-1, dy=3, dx=-13
    FCB $FF,$FD,$F3          ; flag=-1, dy=-3, dx=-13
    FCB $FF,$F9,$F5          ; flag=-1, dy=-7, dx=-11
    FCB $FF,$F5,$F9          ; flag=-1, dy=-11, dx=-7
    FCB $FF,$F3,$FD          ; flag=-1, dy=-13, dx=-3
    FCB $FF,$F3,$03          ; flag=-1, dy=-13, dx=3
    FCB $FF,$F5,$07          ; flag=-1, dy=-11, dx=7
    FCB $FF,$F9,$0B          ; flag=-1, dy=-7, dx=11
    FCB $FF,$FD,$0D          ; flag=-1, dy=-3, dx=13
    FCB $FF,$03,$0D          ; flag=-1, dy=3, dx=13
    FCB $FF,$07,$0B          ; flag=-1, dy=7, dx=11
    FCB $FF,$0B,$07          ; flag=-1, dy=11, dx=7
    FCB $FF,$0D,$03          ; flag=-1, dy=13, dx=3
    FCB 2                ; End marker (path complete)

_LOGO_PATH1:    ; Path 1
    FCB 35              ; path1: intensity
    FCB $2B,$1D,0,0        ; path1: header (y=43, x=29, relative to center)
    FCB $FF,$0B,$FE          ; flag=-1, dy=11, dx=-2
    FCB $FF,$09,$FA          ; flag=-1, dy=9, dx=-6
    FCB $FF,$06,$F7          ; flag=-1, dy=6, dx=-9
    FCB $FF,$02,$F5          ; flag=-1, dy=2, dx=-11
    FCB $FF,$FE,$F5          ; flag=-1, dy=-2, dx=-11
    FCB $FF,$FA,$F7          ; flag=-1, dy=-6, dx=-9
    FCB $FF,$F7,$FA          ; flag=-1, dy=-9, dx=-6
    FCB $FF,$F5,$FE          ; flag=-1, dy=-11, dx=-2
    FCB $FF,$F5,$02          ; flag=-1, dy=-11, dx=2
    FCB $FF,$F7,$06          ; flag=-1, dy=-9, dx=6
    FCB $FF,$FA,$09          ; flag=-1, dy=-6, dx=9
...
_LOGO_PATH2:    ; Path 2
    FCB 127              ; path2: intensity
    FCB $02,$EC,0,0        ; path2: header (y=2, x=-20, relative to center)
    FCB $FF,$00,$0C          ; flag=-1, dy=0, dx=12
    FCB 2                ; End marker (path complete)

_LOGO_PATH3:    ; Path 3
    FCB 127              ; path3: intensity
    FCB $02,$F2,0,0        ; path3: header (y=2, x=-14, relative to center)
    FCB $FF,$F7,$00          ; flag=-1, dy=-9, dx=0
    FCB 2                ; End marker (path complete)

_LOGO_PATH4:    ; Path 4
    FCB 127              ; path4: intensity
    FCB $02,$FB,0,0        ; path4: header (y=2, x=-5, relative to center)
    FCB $FF,$F7,$00          ; flag=-1, dy=-9, dx=0
    FCB 2                ; End marker (path complete)

_LOGO_PATH5:    ; Path 5
    FCB 127              ; path5: intensity
    FCB $FE,$FB,0,0        ; path5: header (y=-2, x=-5, relative to center)
    FCB $FF,$00,$09          ; flag=-1, dy=0, dx=9
    FCB 2                ; End marker (path complete)

_LOGO_PATH6:    ; Path 6
    FCB 127              ; path6: intensity
    FCB $02,$04,0,0        ; path6: header (y=2, x=4, relative to center)
    FCB $FF,$F7,$00          ; flag=-1, dy=-9, dx=0
    FCB 2                ; End marker (path complete)

_LOGO_PATH7:    ; Path 7
    FCB 127              ; path7: intensity
    FCB $02,$11,0,0        ; path7: header (y=2, x=17, relative to center)
...
_LOGO_PATH8:    ; Path 8
    FCB 127              ; path8: intensity
    FCB $FE,$09,0,0        ; path8: header (y=-2, x=9, relative to center)
    FCB $FF,$00,$06          ; flag=-1, dy=0, dx=6
    FCB 2                ; End marker (path complete)

_LOGO_PATH9:    ; Path 9
    FCB 127              ; path9: intensity
    FCB $F5,$A6,0,0        ; path9: header (y=-11, x=-90, relative to center)
    FCB $FF,$02,$F8          ; flag=-1, dy=2, dx=-8
    FCB $FF,$FB,$FA          ; flag=-1, dy=-5, dx=-6
    FCB $FF,$F8,$00          ; flag=-1, dy=-8, dx=0
...
_LOGO_PATH10:    ; Path 10
    FCB 127              ; path10: intensity
    FCB $F6,$A9,0,0        ; path10: header (y=-10, x=-87, relative to center)
...
_LOGO_PATH11:    ; Path 11
    FCB 127              ; path11: intensity
    FCB $F2,$B8,0,0        ; path11: header (y=-14, x=-72, relative to center)
    FCB $FF,$F7,$01          ; flag=-1, dy=-9, dx=1
    FCB $FF,$FD,$08          ; flag=-1, dy=-3, dx=8
    FCB $FF,$04,$09          ; flag=-1, dy=4, dx=9
...
_LOGO_PATH12:    ; Path 12
    FCB 127              ; path12: intensity
    FCB $F5,$DB,0,0        ; path12: header (y=-11, x=-37, relative to center)
...
_LOGO_PATH13:    ; Path 13
    FCB 127              ; path13: intensity
    FCB $F5,$DD,0,0        ; path13: header (y=-11, x=-35, relative to center)
...
_LOGO_PATH14:    ; Path 14
    FCB 127              ; path14: intensity
    FCB $F5,$A6,0,0        ; path14: header (y=-11, x=-90, relative to center)
    FCB $FF,$FD,$FF          ; flag=-1, dy=-3, dx=-1
...
_LOGO_PATH15:    ; Path 15
    FCB 127              ; path15: intensity
    FCB $F6,$A9,0,0        ; path15: header (y=-10, x=-87, relative to center)
    FCB $FF,$FF,$04          ; flag=-1, dy=-1, dx=4
...
_LOGO_PATH16:    ; Path 16
    FCB 127              ; path16: intensity
    FCB $F2,$BD,0,0        ; path16: header (y=-14, x=-67, relative to center)
    FCB $FF,$F9,$00          ; flag=-1, dy=-7, dx=0
...
_LOGO_PATH17:    ; Path 17
    FCB 127              ; path17: intensity
    FCB $F5,$DB,0,0        ; path17: header (y=-11, x=-37, relative to center)
    FCB $FF,$FE,$FE          ; flag=-1, dy=-2, dx=-2
    FCB $FF,$01,$F7          ; flag=-1, dy=1, dx=-9
    FCB $FF,$F8,$00          ; flag=-1, dy=-8, dx=0
...
_LOGO_PATH18:    ; Path 18
    FCB 127              ; path18: intensity
    FCB $E7,$F2,0,0        ; path18: header (y=-25, x=-14, relative to center)
...
_LOGO_PATH19:    ; Path 19
    FCB 127              ; path19: intensity
    FCB $E7,$0A,0,0        ; path19: header (y=-25, x=10, relative to center)
    FCB $FF,$0D,$08          ; flag=-1, dy=13, dx=8
    FCB $FF,$02,$FE          ; flag=-1, dy=2, dx=-2
    FCB $FF,$00,$06          ; flag=-1, dy=0, dx=6
    FCB $FF,$F1,$08          ; flag=-1, dy=-15, dx=8
    FCB $FF,$00,$FB          ; flag=-1, dy=0, dx=-5
    FCB $FF,$05,$FE          ; flag=-1, dy=5, dx=-2
    FCB $FF,$00,$F8          ; flag=-1, dy=0, dx=-8
    FCB $FF,$FD,$FF          ; flag=-1, dy=-3, dx=-1
...
_LOGO_PATH20:    ; Path 20
    FCB 127              ; path20: intensity
    FCB $F6,$1F,0,0        ; path20: header (y=-10, x=31, relative to center)
    FCB $FF,$F1,$00          ; flag=-1, dy=-15, dx=0
    FCB $FF,$00,$05          ; flag=-1, dy=0, dx=5
    FCB $FF,$05,$FE          ; flag=-1, dy=5, dx=-2
    FCB $FF,$03,$05          ; flag=-1, dy=3, dx=5
...
_LOGO_PATH21:    ; Path 21
    FCB 127              ; path21: intensity
    FCB $F6,$32,0,0        ; path21: header (y=-10, x=50, relative to center)
    FCB $FF,$FE,$01          ; flag=-1, dy=-2, dx=1
    FCB $FF,$F3,$00          ; flag=-1, dy=-13, dx=0
    FCB $FF,$00,$0E          ; flag=-1, dy=0, dx=14
    FCB $FF,$03,$00          ; flag=-1, dy=3, dx=0
...
_LOGO_PATH22:    ; Path 22
    FCB 127              ; path22: intensity
    FCB $F6,$43,0,0        ; path22: header (y=-10, x=67, relative to center)
...
_LOGO_PATH23:    ; Path 23
    FCB 127              ; path23: intensity
    FCB $EE,$10,0,0        ; path23: header (y=-18, x=16, relative to center)
    FCB $FF,$00,$06          ; flag=-1, dy=0, dx=6
    FCB $FF,$05,$FD          ; flag=-1, dy=5, dx=-3
    FCB $FF,$FB,$FD          ; flag=-1, dy=-5, dx=-3
    FCB 2                ; End marker (path complete)

_LOGO_PATH24:    ; Path 24
    FCB 127              ; path24: intensity
    FCB $F4,$48,0,0        ; path24: header (y=-12, x=72, relative to center)
    FCB $FF,$FA,$00          ; flag=-1, dy=-6, dx=0
...
_LOGO_PATH25:    ; Path 25
    FCB 127              ; path25: intensity
    FCB $F3,$66,0,0        ; path25: header (y=-13, x=102, relative to center)
    FCB $FF,$03,$00          ; flag=-1, dy=3, dx=0
...
_LOGO_PATH26:    ; Path 26
    FCB 127              ; path26: intensity
    FCB $E3,$DA,0,0        ; path26: header (y=-29, x=-38, relative to center)
    FCB $FF,$FC,$01          ; flag=-1, dy=-4, dx=1
    FCB $FF,$F1,$00          ; flag=-1, dy=-15, dx=0
    FCB $FF,$01,$07          ; flag=-1, dy=1, dx=7
    FCB $FF,$06,$FF          ; flag=-1, dy=6, dx=-1
    FCB $FF,$01,$04          ; flag=-1, dy=1, dx=4
    FCB $FF,$F7,$09          ; flag=-1, dy=-9, dx=9
    FCB $FF,$02,$06          ; flag=-1, dy=2, dx=6
...
_LOGO_PATH27:    ; Path 27
    FCB 127              ; path27: intensity
    FCB $E2,$F3,0,0        ; path27: header (y=-30, x=-13, relative to center)
    FCB $FF,$F6,$0A          ; flag=-1, dy=-10, dx=10
    FCB $FF,$F8,$00          ; flag=-1, dy=-8, dx=0
    FCB $FF,$00,$07          ; flag=-1, dy=0, dx=7
    FCB $FF,$08,$FF          ; flag=-1, dy=8, dx=-1
    FCB $FF,$0B,$0B          ; flag=-1, dy=11, dx=11
    FCB $FF,$00,$FA          ; flag=-1, dy=0, dx=-6
    FCB $FF,$F8,$FA          ; flag=-1, dy=-8, dx=-6
    FCB $FF,$08,$F7          ; flag=-1, dy=8, dx=-9
    FCB $FF,$FF,$F9          ; flag=-1, dy=-1, dx=-7
    FCB 2                ; End marker (path complete)

_LOGO_PATH28:    ; Path 28
    FCB 127              ; path28: intensity
    FCB $E3,$10,0,0        ; path28: header (y=-29, x=16, relative to center)
    FCB $FF,$FE,$02          ; flag=-1, dy=-2, dx=2
...
_LOGO_PATH29:    ; Path 29
    FCB 127              ; path29: intensity
    FCB $E1,$33,0,0        ; path29: header (y=-31, x=51, relative to center)
...
_LOGO_PATH30:    ; Path 30
    FCB 127              ; path30: intensity
    FCB $E1,$18,0,0        ; path30: header (y=-31, x=24, relative to center)
    FCB $FF,$F7,$00          ; flag=-1, dy=-9, dx=0
...
_LOGO_PATH31:    ; Path 31
    FCB 127              ; path31: intensity
    FCB $E1,$E1,0,0        ; path31: header (y=-31, x=-31, relative to center)
    FCB $FF,$F8,$00          ; flag=-1, dy=-8, dx=0
    FCB $FF,$01,$07          ; flag=-1, dy=1, dx=7
...
_LOGO_PATH32:    ; Path 32
    FCB 127              ; path32: intensity
    FCB $E3,$D6,0,0        ; path32: header (y=-29, x=-42, relative to center)
    FCB $FF,$01,$F6          ; flag=-1, dy=1, dx=-10
    FCB $FF,$FB,$F3          ; flag=-1, dy=-5, dx=-13
    FCB $FF,$F4,$00          ; flag=-1, dy=-12, dx=0
    FCB $FF,$FA,$0C          ; flag=-1, dy=-6, dx=12
    FCB $FF,$04,$0D          ; flag=-1, dy=4, dx=13
    FCB $FF,$02,$FF          ; flag=-1, dy=2, dx=-1
    FCB $FF,$FE,$F6          ; flag=-1, dy=-2, dx=-10
...
_LOGO_PATH33:    ; Path 33
    FCB 127              ; path33: intensity
    FCB $F7,$56,0,0        ; path33: header (y=-9, x=86, relative to center)
    FCB $FF,$00,$03          ; flag=-1, dy=0, dx=3
    FCB $FF,$FE,$00          ; flag=-1, dy=-2, dx=0
    FCB $FF,$FE,$FD          ; flag=-1, dy=-2, dx=-3
    FCB $FF,$02,$01          ; flag=-1, dy=2, dx=1
...
_LOGO_PATH34:    ; Path 34
    FCB 127              ; path34: intensity
    FCB $2A,$00,0,0        ; path34: header (y=42, x=0, relative to center)
    FCB $FF,$10,$00          ; flag=-1, dy=16, dx=0
    FCB 2                ; End marker (path complete)

_LOGO_PATH35:    ; Path 35
    FCB 127              ; path35: intensity
    FCB $3A,$00,0,0        ; path35: header (y=58, x=0, relative to center)
    FCB $FF,$FD,$FE          ; flag=-1, dy=-3, dx=-2
    FCB 2                ; End marker (path complete)

_LOGO_PATH36:    ; Path 36
    FCB 127              ; path36: intensity
    FCB $3A,$00,0,0        ; path36: header (y=58, x=0, relative to center)
    FCB $FF,$FD,$02          ; flag=-1, dy=-3, dx=2
    FCB 2                ; End marker (path complete)

_LOGO_PATH37:    ; Path 37
    FCB 127              ; path37: intensity
    FCB $2A,$00,0,0        ; path37: header (y=42, x=0, relative to center)
    FCB $FF,$EB,$F4          ; flag=-1, dy=-21, dx=-12
    FCB 2                ; End marker (path complete)

_LOGO_PATH38:    ; Path 38
    FCB 127              ; path38: intensity
    FCB $15,$F4,0,0        ; path38: header (y=21, x=-12, relative to center)
    FCB $FF,$03,$FF          ; flag=-1, dy=3, dx=-1
    FCB 2                ; End marker (path complete)

_LOGO_PATH39:    ; Path 39
    FCB 127              ; path39: intensity
    FCB $15,$F4,0,0        ; path39: header (y=21, x=-12, relative to center)
    FCB $FF,$01,$03          ; flag=-1, dy=1, dx=3
    FCB 2                ; End marker (path complete)

_LOGO_PATH40:    ; Path 40
    FCB 127              ; path40: intensity
    FCB $C0,$E9,0,0        ; path40: header (y=-64, x=-23, relative to center)
    FCB $FF,$03,$FF          ; flag=-1, dy=3, dx=-1
    FCB $FF,$02,$FF          ; flag=-1, dy=2, dx=-1
    FCB $FF,$01,$FE          ; flag=-1, dy=1, dx=-2
    FCB $FF,$01,$FD          ; flag=-1, dy=1, dx=-3
...
_LOGO_PATH41:    ; Path 41
    FCB 127              ; path41: intensity
    FCB $C0,$EE,0,0        ; path41: header (y=-64, x=-18, relative to center)
...
_LOGO_PATH42:    ; Path 42
    FCB 127              ; path42: intensity
    FCB $C5,$D7,0,0        ; path42: header (y=-59, x=-41, relative to center)
    FCB $FF,$FD,$F8          ; flag=-1, dy=-3, dx=-8
    FCB $FF,$FC,$00          ; flag=-1, dy=-4, dx=0
    FCB $FF,$FD,$08          ; flag=-1, dy=-3, dx=8
    FCB 2                ; End marker (path complete)

_LOGO_PATH43:    ; Path 43
    FCB 127              ; path43: intensity
    FCB $C4,$EE,0,0        ; path43: header (y=-60, x=-18, relative to center)
    FCB $FF,$FE,$07          ; flag=-1, dy=-2, dx=7
    FCB $FF,$01,$41          ; flag=-1, dy=1, dx=65
    ...
    FCB $FF,$00,$FB          ; flag=-1, dy=0, dx=-5
    FCB $FF,$02,$00          ; flag=-1, dy=2, dx=0
    FCB $FF,$FF,$DA          ; flag=-1, dy=-1, dx=-38
    FCB $FF,$FE,$F6          ; flag=-1, dy=-2, dx=-10
    FCB 2                ; End marker (path complete)
...
_PLAYER_PATH6:    ; Path 6
    ...
    FCB 2                ; End marker (path complete)
; Generated from room2.vec (Malban Draw_Sync_List format)
; Total paths: 138, points: 628
; X bounds: min=-119, max=119, width=238
; Center: (0, 21)

_ROOM2_WIDTH EQU 238
_ROOM2_HALF_WIDTH EQU 119
_ROOM2_CENTER_X EQU 0
_ROOM2_CENTER_Y EQU 21

_ROOM2_VECTORS:  ; Main entry (header + 138 path(s))
    FCB 138               ; path_count (runtime metadata)
    FDB _ROOM2_PATH0        ; pointer to path 0
    FDB _ROOM2_PATH1        ; pointer to path 1
    FDB _ROOM2_PATH2        ; pointer to path 2
    FDB _ROOM2_PATH3        ; pointer to path 3
    FDB _ROOM2_PATH4        ; pointer to path 4
    FDB _ROOM2_PATH5        ; pointer to path 5
    FDB _ROOM2_PATH6        ; pointer to path 6
    FDB _ROOM2_PATH7        ; pointer to path 7
    FDB _ROOM2_PATH8        ; pointer to path 8
    FDB _ROOM2_PATH9        ; pointer to path 9
    FDB _ROOM2_PATH10        ; pointer to path 10
    FDB _ROOM2_PATH11        ; pointer to path 11
    FDB _ROOM2_PATH12        ; pointer to path 12
    FDB _ROOM2_PATH13        ; pointer to path 13
    FDB _ROOM2_PATH14        ; pointer to path 14
    FDB _ROOM2_PATH15        ; pointer to path 15
    FDB _ROOM2_PATH16        ; pointer to path 16
    FDB _ROOM2_PATH17        ; pointer to path 17
    FDB _ROOM2_PATH18        ; pointer to path 18
    FDB _ROOM2_PATH19        ; pointer to path 19
    FDB _ROOM2_PATH20        ; pointer to path 20
    FDB _ROOM2_PATH21        ; pointer to path 21
    FDB _ROOM2_PATH22        ; pointer to path 22
    FDB _ROOM2_PATH23        ; pointer to path 23
    FDB _ROOM2_PATH24        ; pointer to path 24
    FDB _ROOM2_PATH25        ; pointer to path 25
    FDB _ROOM2_PATH26        ; pointer to path 26
    FDB _ROOM2_PATH27        ; pointer to path 27
    FDB _ROOM2_PATH28        ; pointer to path 28
    FDB _ROOM2_PATH29        ; pointer to path 29
    FDB _ROOM2_PATH30        ; pointer to path 30
    FDB _ROOM2_PATH31        ; pointer to path 31
    FDB _ROOM2_PATH32        ; pointer to path 32
    FDB _ROOM2_PATH33        ; pointer to path 33
    FDB _ROOM2_PATH34        ; pointer to path 34
    FDB _ROOM2_PATH35        ; pointer to path 35
    FDB _ROOM2_PATH36        ; pointer to path 36
    FDB _ROOM2_PATH37        ; pointer to path 37
    FDB _ROOM2_PATH38        ; pointer to path 38
    FDB _ROOM2_PATH39        ; pointer to path 39
    FDB _ROOM2_PATH40        ; pointer to path 40
    FDB _ROOM2_PATH41        ; pointer to path 41
    FDB _ROOM2_PATH42        ; pointer to path 42
    FDB _ROOM2_PATH43        ; pointer to path 43
    FDB _ROOM2_PATH44        ; pointer to path 44
    FDB _ROOM2_PATH45        ; pointer to path 45
    FDB _ROOM2_PATH46        ; pointer to path 46
    FDB _ROOM2_PATH47        ; pointer to path 47
    FDB _ROOM2_PATH48        ; pointer to path 48
    FDB _ROOM2_PATH49        ; pointer to path 49
    FDB _ROOM2_PATH50        ; pointer to path 50
    FDB _ROOM2_PATH51        ; pointer to path 51
    FDB _ROOM2_PATH52        ; pointer to path 52
    FDB _ROOM2_PATH53        ; pointer to path 53
    FDB _ROOM2_PATH54        ; pointer to path 54
    FDB _ROOM2_PATH55        ; pointer to path 55
    FDB _ROOM2_PATH56        ; pointer to path 56
    FDB _ROOM2_PATH57        ; pointer to path 57
    FDB _ROOM2_PATH58        ; pointer to path 58
    FDB _ROOM2_PATH59        ; pointer to path 59
    FDB _ROOM2_PATH60        ; pointer to path 60
    FDB _ROOM2_PATH61        ; pointer to path 61
    FDB _ROOM2_PATH62        ; pointer to path 62
    FDB _ROOM2_PATH63        ; pointer to path 63
    FDB _ROOM2_PATH64        ; pointer to path 64
    FDB _ROOM2_PATH65        ; pointer to path 65
    FDB _ROOM2_PATH66        ; pointer to path 66
    FDB _ROOM2_PATH67        ; pointer to path 67
    FDB _ROOM2_PATH68        ; pointer to path 68
    FDB _ROOM2_PATH69        ; pointer to path 69
    FDB _ROOM2_PATH70        ; pointer to path 70
    FDB _ROOM2_PATH71        ; pointer to path 71
    FDB _ROOM2_PATH72        ; pointer to path 72
    FDB _ROOM2_PATH73        ; pointer to path 73
    FDB _ROOM2_PATH74        ; pointer to path 74
    FDB _ROOM2_PATH75        ; pointer to path 75
    FDB _ROOM2_PATH76        ; pointer to path 76
    FDB _ROOM2_PATH77        ; pointer to path 77
    FDB _ROOM2_PATH78        ; pointer to path 78
    FDB _ROOM2_PATH79        ; pointer to path 79
    FDB _ROOM2_PATH80        ; pointer to path 80
    FDB _ROOM2_PATH81        ; pointer to path 81
    FDB _ROOM2_PATH82        ; pointer to path 82
    FDB _ROOM2_PATH83        ; pointer to path 83
    FDB _ROOM2_PATH84        ; pointer to path 84
    FDB _ROOM2_PATH85        ; pointer to path 85
    FDB _ROOM2_PATH86        ; pointer to path 86
    FDB _ROOM2_PATH87        ; pointer to path 87
    FDB _ROOM2_PATH88        ; pointer to path 88
    FDB _ROOM2_PATH89        ; pointer to path 89
    FDB _ROOM2_PATH90        ; pointer to path 90
    FDB _ROOM2_PATH91        ; pointer to path 91
    FDB _ROOM2_PATH92        ; pointer to path 92
    FDB _ROOM2_PATH93        ; pointer to path 93
    FDB _ROOM2_PATH94        ; pointer to path 94
    FDB _ROOM2_PATH95        ; pointer to path 95
    FDB _ROOM2_PATH96        ; pointer to path 96
    FDB _ROOM2_PATH97        ; pointer to path 97
    FDB _ROOM2_PATH98        ; pointer to path 98
    FDB _ROOM2_PATH99        ; pointer to path 99
    FDB _ROOM2_PATH100        ; pointer to path 100
    FDB _ROOM2_PATH101        ; pointer to path 101
    FDB _ROOM2_PATH102        ; pointer to path 102
    FDB _ROOM2_PATH103        ; pointer to path 103
    FDB _ROOM2_PATH104        ; pointer to path 104
    FDB _ROOM2_PATH105        ; pointer to path 105
    FDB _ROOM2_PATH106        ; pointer to path 106
    FDB _ROOM2_PATH107        ; pointer to path 107
    FDB _ROOM2_PATH108        ; pointer to path 108
    FDB _ROOM2_PATH109        ; pointer to path 109
    FDB _ROOM2_PATH110        ; pointer to path 110
    FDB _ROOM2_PATH111        ; pointer to path 111
    FDB _ROOM2_PATH112        ; pointer to path 112
    FDB _ROOM2_PATH113        ; pointer to path 113
    FDB _ROOM2_PATH114        ; pointer to path 114
    FDB _ROOM2_PATH115        ; pointer to path 115
    FDB _ROOM2_PATH116        ; pointer to path 116
    FDB _ROOM2_PATH117        ; pointer to path 117
    FDB _ROOM2_PATH118        ; pointer to path 118
    FDB _ROOM2_PATH119        ; pointer to path 119
    FDB _ROOM2_PATH120        ; pointer to path 120
    FDB _ROOM2_PATH121        ; pointer to path 121
    FDB _ROOM2_PATH122        ; pointer to path 122
    FDB _ROOM2_PATH123        ; pointer to path 123
    FDB _ROOM2_PATH124        ; pointer to path 124
    FDB _ROOM2_PATH125        ; pointer to path 125
    FDB _ROOM2_PATH126        ; pointer to path 126
    FDB _ROOM2_PATH127        ; pointer to path 127
    FDB _ROOM2_PATH128        ; pointer to path 128
    FDB _ROOM2_PATH129        ; pointer to path 129
    FDB _ROOM2_PATH130        ; pointer to path 130
    FDB _ROOM2_PATH131        ; pointer to path 131
    FDB _ROOM2_PATH132        ; pointer to path 132
    FDB _ROOM2_PATH133        ; pointer to path 133
    FDB _ROOM2_PATH134        ; pointer to path 134
    FDB _ROOM2_PATH135        ; pointer to path 135
    FDB _ROOM2_PATH136        ; pointer to path 136
    FDB _ROOM2_PATH137        ; pointer to path 137

_ROOM2_PATH0:    ; Path 0
    FCB 127              ; path0: intensity
    FCB $3C,$00,0,0        ; path0: header (y=60, x=0, relative to center)
    FCB $FF,$F6,$77          ; flag=-1, dy=-10, dx=119
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH1:    ; Path 1
    FCB 127              ; path1: intensity
    FCB $C5,$8D,0,0        ; path1: header (y=-59, x=-115, relative to center)
    FCB $FF,$0A,$00          ; flag=-1, dy=10, dx=0
    FCB $FF,$00,$12          ; flag=-1, dy=0, dx=18
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB $FF,$00,$EE          ; flag=-1, dy=0, dx=-18
...
_ROOM2_PATH2:    ; Path 2
    FCB 127              ; path2: intensity
    FCB $CF,$9F,0,0        ; path2: header (y=-49, x=-97, relative to center)
    FCB $FF,$02,$04          ; flag=-1, dy=2, dx=4
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB $FF,$FE,$FD          ; flag=-1, dy=-2, dx=-3
    FCB 2                ; End marker (path complete)
...
_ROOM2_PATH3:    ; Path 3
    FCB 127              ; path3: intensity
    FCB $CF,$8D,0,0        ; path3: header (y=-49, x=-115, relative to center)
    FCB $FF,$02,$04          ; flag=-1, dy=2, dx=4
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB $FF,$01,$03          ; flag=-1, dy=1, dx=3
    FCB 2                ; End marker (path complete)
...
_ROOM2_PATH4:    ; Path 4
    FCB 127              ; path4: intensity
    FCB $D1,$91,0,0        ; path4: header (y=-47, x=-111, relative to center)
    FCB $FF,$28,$00          ; flag=-1, dy=40, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH5:    ; Path 5
    FCB 127              ; path5: intensity
    FCB $D0,$9E,0,0        ; path5: header (y=-48, x=-98, relative to center)
    FCB $FF,$29,$00          ; flag=-1, dy=41, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH6:    ; Path 6
    FCB 127              ; path6: intensity
    FCB $D2,$A1,0,0        ; path6: header (y=-46, x=-95, relative to center)
    FCB $FF,$26,$00          ; flag=-1, dy=38, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH7:    ; Path 7
    FCB 127              ; path7: intensity
    FCB $D8,$91,0,0        ; path7: header (y=-40, x=-111, relative to center)
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB $FF,$01,$03          ; flag=-1, dy=1, dx=3
    FCB 2                ; End marker (path complete)
...
_ROOM2_PATH8:    ; Path 8
    FCB 127              ; path8: intensity
    FCB $E1,$91,0,0        ; path8: header (y=-31, x=-111, relative to center)
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB $FF,$01,$03          ; flag=-1, dy=1, dx=3
    FCB 2                ; End marker (path complete)
...
_ROOM2_PATH9:    ; Path 9
    FCB 127              ; path9: intensity
    FCB $EC,$91,0,0        ; path9: header (y=-20, x=-111, relative to center)
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB $FF,$01,$03          ; flag=-1, dy=1, dx=3
    FCB 2                ; End marker (path complete)

_ROOM2_PATH10:    ; Path 10
    FCB 127              ; path10: intensity
    FCB $F6,$91,0,0        ; path10: header (y=-10, x=-111, relative to center)
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB $FF,$01,$03          ; flag=-1, dy=1, dx=3
    FCB 2                ; End marker (path complete)

_ROOM2_PATH11:    ; Path 11
    FCB 127              ; path11: intensity
    FCB $F9,$8E,0,0        ; path11: header (y=-7, x=-114, relative to center)
    FCB $FF,$00,$11          ; flag=-1, dy=0, dx=17
    FCB $FF,$00,$04          ; flag=-1, dy=0, dx=4
    FCB $FF,$04,$00          ; flag=-1, dy=4, dx=0
    FCB $FF,$00,$FC          ; flag=-1, dy=0, dx=-4
...
_ROOM2_PATH12:    ; Path 12
    FCB 127              ; path12: intensity
    FCB $FD,$9F,0,0        ; path12: header (y=-3, x=-97, relative to center)
    FCB $FF,$FC,$00          ; flag=-1, dy=-4, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH13:    ; Path 13
    FCB 127              ; path13: intensity
    FCB $FD,$91,0,0        ; path13: header (y=-3, x=-111, relative to center)
    FCB $FF,$04,$00          ; flag=-1, dy=4, dx=0
    FCB $FF,$0B,$0A          ; flag=-1, dy=11, dx=10
    FCB $FF,$0B,$18          ; flag=-1, dy=11, dx=24
    FCB $FF,$03,$0D          ; flag=-1, dy=3, dx=13
    FCB $FF,$FF,$07          ; flag=-1, dy=-1, dx=7
    FCB $FF,$F7,$18          ; flag=-1, dy=-9, dx=24
    FCB $FF,$F5,$0D          ; flag=-1, dy=-11, dx=13
    FCB $FF,$F8,$03          ; flag=-1, dy=-8, dx=3
    FCB $FF,$00,$F4          ; flag=-1, dy=0, dx=-12
    FCB $FF,$04,$FF          ; flag=-1, dy=4, dx=-1
    FCB $FF,$06,$FA          ; flag=-1, dy=6, dx=-6
    FCB $FF,$05,$F7          ; flag=-1, dy=5, dx=-9
    FCB $FF,$04,$F7          ; flag=-1, dy=4, dx=-9
    FCB $FF,$02,$FB          ; flag=-1, dy=2, dx=-5
    FCB 2                ; End marker (path complete)

_ROOM2_PATH14:    ; Path 14
    FCB 127              ; path14: intensity
    FCB $FD,$E0,0,0        ; path14: header (y=-3, x=-32, relative to center)
    FCB $FF,$09,$F9          ; flag=-1, dy=9, dx=-7
    FCB $FF,$04,$F8          ; flag=-1, dy=4, dx=-8
    FCB $FF,$06,$F0          ; flag=-1, dy=6, dx=-16
    FCB 2                ; End marker (path complete)

_ROOM2_PATH15:    ; Path 15
    FCB 127              ; path15: intensity
    FCB $FD,$9D,0,0        ; path15: header (y=-3, x=-99, relative to center)
    FCB $FF,$0A,$07          ; flag=-1, dy=10, dx=7
    FCB $FF,$05,$09          ; flag=-1, dy=5, dx=9
    FCB $FF,$04,$0A          ; flag=-1, dy=4, dx=10
    FCB $FF,$01,$05          ; flag=-1, dy=1, dx=5
...
_ROOM2_PATH16:    ; Path 16
    FCB 127              ; path16: intensity
    FCB $FD,$A1,0,0        ; path16: header (y=-3, x=-95, relative to center)
    FCB $FF,$04,$01          ; flag=-1, dy=4, dx=1
    FCB $FF,$05,$05          ; flag=-1, dy=5, dx=5
    FCB $FF,$05,$09          ; flag=-1, dy=5, dx=9
    FCB $FF,$05,$11          ; flag=-1, dy=5, dx=17
    FCB 2                ; End marker (path complete)

_ROOM2_PATH17:    ; Path 17
    FCB 127              ; path17: intensity
    FCB $10,$C1,0,0        ; path17: header (y=16, x=-63, relative to center)
    FCB $FF,$02,$04          ; flag=-1, dy=2, dx=4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH18:    ; Path 18
    FCB 127              ; path18: intensity
    FCB $16,$B3,0,0        ; path18: header (y=22, x=-77, relative to center)
    FCB $FF,$FA,$04          ; flag=-1, dy=-6, dx=4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH19:    ; Path 19
    FCB 127              ; path19: intensity
    FCB $12,$A7,0,0        ; path19: header (y=18, x=-89, relative to center)
    FCB $FF,$FA,$07          ; flag=-1, dy=-6, dx=7
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH20:    ; Path 20
    FCB 127              ; path20: intensity
    FCB $0C,$9C,0,0        ; path20: header (y=12, x=-100, relative to center)
    FCB $FF,$FB,$09          ; flag=-1, dy=-5, dx=9
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH21:    ; Path 21
    FCB 127              ; path21: intensity
    FCB $04,$95,0,0        ; path21: header (y=4, x=-107, relative to center)
    FCB $FF,$FD,$0B          ; flag=-1, dy=-3, dx=11
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH22:    ; Path 22
    FCB 127              ; path22: intensity
    FCB $18,$BA,0,0        ; path22: header (y=24, x=-70, relative to center)
    FCB $FF,$FB,$01          ; flag=-1, dy=-5, dx=1
    FCB $FF,$FE,$02          ; flag=-1, dy=-2, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH23:    ; Path 23
    FCB 127              ; path23: intensity
    FCB $18,$C7,0,0        ; path23: header (y=24, x=-57, relative to center)
    FCB $FF,$FA,$FE          ; flag=-1, dy=-6, dx=-2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH24:    ; Path 24
    FCB 127              ; path24: intensity
    FCB $0E,$C7,0,0        ; path24: header (y=14, x=-57, relative to center)
    FCB $FF,$02,$02          ; flag=-1, dy=2, dx=2
    FCB $FF,$07,$04          ; flag=-1, dy=7, dx=4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH25:    ; Path 25
    FCB 127              ; path25: intensity
    FCB $0A,$D1,0,0        ; path25: header (y=10, x=-47, relative to center)
    FCB $FF,$02,$02          ; flag=-1, dy=2, dx=2
    FCB $FF,$06,$06          ; flag=-1, dy=6, dx=6
    FCB 2                ; End marker (path complete)

_ROOM2_PATH26:    ; Path 26
    FCB 127              ; path26: intensity
    FCB $06,$D9,0,0        ; path26: header (y=6, x=-39, relative to center)
    FCB $FF,$02,$03          ; flag=-1, dy=2, dx=3
    FCB $FF,$04,$08          ; flag=-1, dy=4, dx=8
    FCB 2                ; End marker (path complete)

_ROOM2_PATH27:    ; Path 27
    FCB 127              ; path27: intensity
    FCB $00,$DE,0,0        ; path27: header (y=0, x=-34, relative to center)
    FCB $FF,$01,$04          ; flag=-1, dy=1, dx=4
    FCB $FF,$04,$0A          ; flag=-1, dy=4, dx=10
    FCB 2                ; End marker (path complete)

_ROOM2_PATH28:    ; Path 28
    FCB 127              ; path28: intensity
    FCB $D1,$DC,0,0        ; path28: header (y=-47, x=-36, relative to center)
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB $FF,$FE,$05          ; flag=-1, dy=-2, dx=5
    FCB $FF,$00,$12          ; flag=-1, dy=0, dx=18
    FCB $FF,$0A,$00          ; flag=-1, dy=10, dx=0
...
_ROOM2_PATH29:    ; Path 29
    FCB 127              ; path29: intensity
    FCB $CF,$E1,0,0        ; path29: header (y=-49, x=-31, relative to center)
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH30:    ; Path 30
    FCB 127              ; path30: intensity
    FCB $D2,$DF,0,0        ; path30: header (y=-46, x=-33, relative to center)
    FCB $FF,$FF,$03          ; flag=-1, dy=-1, dx=3
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB $FF,$29,$00          ; flag=-1, dy=41, dx=0
    FCB $FF,$00,$F3          ; flag=-1, dy=0, dx=-13
...
_ROOM2_PATH31:    ; Path 31
    FCB 127              ; path31: intensity
    FCB $F7,$DF,0,0        ; path31: header (y=-9, x=-33, relative to center)
    FCB $FF,$FF,$03          ; flag=-1, dy=-1, dx=3
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB 2                ; End marker (path complete)

_ROOM2_PATH32:    ; Path 32
    FCB 127              ; path32: intensity
    FCB $FA,$E2,0,0        ; path32: header (y=-6, x=-30, relative to center)
    FCB $FF,$D7,$00          ; flag=-1, dy=-41, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH33:    ; Path 33
    FCB 127              ; path33: intensity
    FCB $ED,$DF,0,0        ; path33: header (y=-19, x=-33, relative to center)
    FCB $FF,$FF,$04          ; flag=-1, dy=-1, dx=4
    FCB $FF,$00,$0C          ; flag=-1, dy=0, dx=12
    FCB 2                ; End marker (path complete)

_ROOM2_PATH34:    ; Path 34
    FCB 127              ; path34: intensity
    FCB $E2,$DF,0,0        ; path34: header (y=-30, x=-33, relative to center)
    FCB $FF,$FF,$03          ; flag=-1, dy=-1, dx=3
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB 2                ; End marker (path complete)

_ROOM2_PATH35:    ; Path 35
    FCB 127              ; path35: intensity
    FCB $D8,$DF,0,0        ; path35: header (y=-40, x=-33, relative to center)
    FCB $FF,$FF,$03          ; flag=-1, dy=-1, dx=3
    FCB $FF,$00,$0D          ; flag=-1, dy=0, dx=13
    FCB 2                ; End marker (path complete)

_ROOM2_PATH36:    ; Path 36
    FCB 127              ; path36: intensity
    FCB $FD,$EF,0,0        ; path36: header (y=-3, x=-17, relative to center)
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
    FCB $FF,$FD,$00          ; flag=-1, dy=-3, dx=0
    FCB $FF,$00,$F1          ; flag=-1, dy=0, dx=-15
    FCB $FF,$00,$FB          ; flag=-1, dy=0, dx=-5
...
_ROOM2_PATH37:    ; Path 37
    FCB 127              ; path37: intensity
    FCB $FA,$E2,0,0        ; path37: header (y=-6, x=-30, relative to center)
    FCB $FF,$03,$00          ; flag=-1, dy=3, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH38:    ; Path 38
    FCB 127              ; path38: intensity
    FCB $07,$2B,0,0        ; path38: header (y=7, x=43, relative to center)
    FCB $FF,$BE,$00          ; flag=-1, dy=-66, dx=0
    FCB $FF,$00,$42          ; flag=-1, dy=0, dx=66
    FCB $FF,$42,$00          ; flag=-1, dy=66, dx=0
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
...
_ROOM2_PATH39:    ; Path 39
    FCB 127              ; path39: intensity
    FCB $07,$2B,0,0        ; path39: header (y=7, x=43, relative to center)
    FCB $FF,$00,$42          ; flag=-1, dy=0, dx=66
    FCB 2                ; End marker (path complete)

_ROOM2_PATH40:    ; Path 40
    FCB 127              ; path40: intensity
    FCB $07,$65,0,0        ; path40: header (y=7, x=101, relative to center)
    FCB $FF,$E4,$FF          ; flag=-1, dy=-28, dx=-1
    FCB 2                ; End marker (path complete)

_ROOM2_PATH41:    ; Path 41
    FCB 127              ; path41: intensity
    FCB $06,$5C,0,0        ; path41: header (y=6, x=92, relative to center)
    FCB $FF,$E6,$00          ; flag=-1, dy=-26, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH42:    ; Path 42
    FCB 127              ; path42: intensity
    FCB $07,$55,0,0        ; path42: header (y=7, x=85, relative to center)
    FCB $FF,$F3,$00          ; flag=-1, dy=-13, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH43:    ; Path 43
    FCB 127              ; path43: intensity
    FCB $F5,$55,0,0        ; path43: header (y=-11, x=85, relative to center)
    FCB $FF,$F7,$00          ; flag=-1, dy=-9, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH44:    ; Path 44
    FCB 127              ; path44: intensity
    FCB $07,$4D,0,0        ; path44: header (y=7, x=77, relative to center)
    FCB $FF,$F4,$00          ; flag=-1, dy=-12, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH45:    ; Path 45
    FCB 127              ; path45: intensity
    FCB $F5,$4D,0,0        ; path45: header (y=-11, x=77, relative to center)
    FCB $FF,$F8,$00          ; flag=-1, dy=-8, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH46:    ; Path 46
    FCB 127              ; path46: intensity
    FCB $F5,$34,0,0        ; path46: header (y=-11, x=52, relative to center)
    FCB $FF,$E1,$00          ; flag=-1, dy=-31, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH47:    ; Path 47
    FCB 127              ; path47: intensity
    FCB $D0,$34,0,0        ; path47: header (y=-48, x=52, relative to center)
    FCB $FF,$F5,$00          ; flag=-1, dy=-11, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH48:    ; Path 48
    FCB 127              ; path48: intensity
    FCB $07,$34,0,0        ; path48: header (y=7, x=52, relative to center)
    FCB 2                ; End marker (path complete)

_ROOM2_PATH49:    ; Path 49
    FCB 127              ; path49: intensity
    FCB $07,$3A,0,0        ; path49: header (y=7, x=58, relative to center)
    FCB $FF,$F4,$00          ; flag=-1, dy=-12, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH50:    ; Path 50
    FCB 127              ; path50: intensity
    FCB $F5,$3A,0,0        ; path50: header (y=-11, x=58, relative to center)
    FCB $FF,$E1,$00          ; flag=-1, dy=-31, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH51:    ; Path 51
    FCB 127              ; path51: intensity
    FCB $D0,$3A,0,0        ; path51: header (y=-48, x=58, relative to center)
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH52:    ; Path 52
    FCB 127              ; path52: intensity
    FCB $07,$40,0,0        ; path52: header (y=7, x=64, relative to center)
    FCB $FF,$F3,$00          ; flag=-1, dy=-13, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH53:    ; Path 53
    FCB 127              ; path53: intensity
    FCB $F6,$40,0,0        ; path53: header (y=-10, x=64, relative to center)
    FCB $FF,$DF,$00          ; flag=-1, dy=-33, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH54:    ; Path 54
    FCB 127              ; path54: intensity
    FCB $D1,$40,0,0        ; path54: header (y=-47, x=64, relative to center)
    FCB $FF,$F5,$00          ; flag=-1, dy=-11, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH55:    ; Path 55
    FCB 127              ; path55: intensity
    FCB $07,$47,0,0        ; path55: header (y=7, x=71, relative to center)
    FCB $FF,$F3,$00          ; flag=-1, dy=-13, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH56:    ; Path 56
    FCB 127              ; path56: intensity
    FCB $F6,$47,0,0        ; path56: header (y=-10, x=71, relative to center)
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH57:    ; Path 57
    FCB 127              ; path57: intensity
    FCB $DF,$47,0,0        ; path57: header (y=-33, x=71, relative to center)
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH58:    ; Path 58
    FCB 127              ; path58: intensity
    FCB $D0,$47,0,0        ; path58: header (y=-48, x=71, relative to center)
    FCB $FF,$F5,$00          ; flag=-1, dy=-11, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH59:    ; Path 59
    FCB 127              ; path59: intensity
    FCB $DF,$4E,0,0        ; path59: header (y=-33, x=78, relative to center)
    FCB $FF,$F7,$00          ; flag=-1, dy=-9, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH60:    ; Path 60
    FCB 127              ; path60: intensity
    FCB $D0,$4E,0,0        ; path60: header (y=-48, x=78, relative to center)
    FCB $FF,$F6,$00          ; flag=-1, dy=-10, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH61:    ; Path 61
    FCB 127              ; path61: intensity
    FCB $DF,$55,0,0        ; path61: header (y=-33, x=85, relative to center)
    FCB $FF,$F7,$00          ; flag=-1, dy=-9, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH62:    ; Path 62
    FCB 127              ; path62: intensity
    FCB $D1,$55,0,0        ; path62: header (y=-47, x=85, relative to center)
    FCB $FF,$F4,$00          ; flag=-1, dy=-12, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH63:    ; Path 63
    FCB 127              ; path63: intensity
    FCB $DF,$5C,0,0        ; path63: header (y=-33, x=92, relative to center)
    FCB $FF,$E6,$00          ; flag=-1, dy=-26, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH64:    ; Path 64
    FCB 127              ; path64: intensity
    FCB $DF,$64,0,0        ; path64: header (y=-33, x=100, relative to center)
    FCB $FF,$E7,$00          ; flag=-1, dy=-25, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH65:    ; Path 65
    FCB 127              ; path65: intensity
    FCB $F5,$2E,0,0        ; path65: header (y=-11, x=46, relative to center)
    FCB $FF,$01,$05          ; flag=-1, dy=1, dx=5
    FCB $FF,$FF,$01          ; flag=-1, dy=-1, dx=1
    ...
    FCB $FF,$03,$0C          ; flag=-1, dy=3, dx=12
    FCB $FF,$03,$F4          ; flag=-1, dy=3, dx=-12
    FCB $FF,$FE,$F4          ; flag=-1, dy=-2, dx=-12
    FCB $FF,$02,$F3          ; flag=-1, dy=2, dx=-13
    FCB 2                ; End marker (path complete)

_ROOM2_PATH66:    ; Path 66
    FCB 127              ; path66: intensity
    FCB $FB,$34,0,0        ; path66: header (y=-5, x=52, relative to center)
    FCB $FF,$FF,$FF          ; flag=-1, dy=-1, dx=-1
    FCB $FF,$01,$FB          ; flag=-1, dy=1, dx=-5
    FCB $FF,$FA,$00          ; flag=-1, dy=-6, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH67:    ; Path 67
    FCB 127              ; path67: intensity
    FCB $07,$34,0,0        ; path67: header (y=7, x=52, relative to center)
    FCB $FF,$F4,$00          ; flag=-1, dy=-12, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH68:    ; Path 68
    FCB 127              ; path68: intensity
    FCB $D6,$2E,0,0        ; path68: header (y=-42, x=46, relative to center)
    FCB $FF,$FA,$00          ; flag=-1, dy=-6, dx=0
    FCB $FF,$00,$04          ; flag=-1, dy=0, dx=4
    FCB $FF,$01,$02          ; flag=-1, dy=1, dx=2
    FCB $FF,$FF,$01          ; flag=-1, dy=-1, dx=1
    FCB $FF,$01,$0B          ; flag=-1, dy=1, dx=11
    FCB $FF,$FF,$0E          ; flag=-1, dy=-1, dx=14
    FCB $FF,$03,$0B          ; flag=-1, dy=3, dx=11
    FCB $FF,$03,$F5          ; flag=-1, dy=3, dx=-11
    FCB $FF,$FF,$F2          ; flag=-1, dy=-1, dx=-14
    FCB $FF,$01,$F5          ; flag=-1, dy=1, dx=-11
    FCB $FF,$FF,$FD          ; flag=-1, dy=-1, dx=-3
    FCB $FF,$01,$FC          ; flag=-1, dy=1, dx=-4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH69:    ; Path 69
    FCB 127              ; path69: intensity
    FCB $EB,$45,0,0        ; path69: header (y=-21, x=69, relative to center)
    FCB $FF,$F5,$00          ; flag=-1, dy=-11, dx=0
...
_ROOM2_PATH70:    ; Path 70
    FCB 127              ; path70: intensity
    FCB $E5,$54,0,0        ; path70: header (y=-27, x=84, relative to center)
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
...
_ROOM2_PATH71:    ; Path 71
    FCB 127              ; path71: intensity
    FCB $E5,$4D,0,0        ; path71: header (y=-27, x=77, relative to center)
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
...
_ROOM2_PATH72:    ; Path 72
    FCB 127              ; path72: intensity
    FCB $E5,$5C,0,0        ; path72: header (y=-27, x=92, relative to center)
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
...
_ROOM2_PATH73:    ; Path 73
    FCB 127              ; path73: intensity
    FCB $E5,$63,0,0        ; path73: header (y=-27, x=99, relative to center)
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
...
_ROOM2_PATH74:    ; Path 74
    FCB 127              ; path74: intensity
    FCB $E5,$4B,0,0        ; path74: header (y=-27, x=75, relative to center)
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
...
_ROOM2_PATH75:    ; Path 75
    FCB 127              ; path75: intensity
    FCB $E6,$53,0,0        ; path75: header (y=-26, x=83, relative to center)
    FCB 2                ; End marker (path complete)

_ROOM2_PATH76:    ; Path 76
    FCB 127              ; path76: intensity
    FCB $E5,$61,0,0        ; path76: header (y=-27, x=97, relative to center)
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
...
_ROOM2_PATH77:    ; Path 77
    FCB 127              ; path77: intensity
    FCB $E5,$52,0,0        ; path77: header (y=-27, x=82, relative to center)
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
...
_ROOM2_PATH78:    ; Path 78
    FCB 127              ; path78: intensity
    FCB $E5,$5A,0,0        ; path78: header (y=-27, x=90, relative to center)
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
...
_ROOM2_PATH79:    ; Path 79
    FCB 127              ; path79: intensity
    FCB $3C,$01,0,0        ; path79: header (y=60, x=1, relative to center)
    FCB $FF,$F7,$88          ; flag=-1, dy=-9, dx=-120
    FCB 2                ; End marker (path complete)

_ROOM2_PATH80:    ; Path 80
    FCB 127              ; path80: intensity
    FCB $C7,$A4,0,0        ; path80: header (y=-57, x=-92, relative to center)
    FCB $FF,$00,$36          ; flag=-1, dy=0, dx=54
    FCB 2                ; End marker (path complete)

_ROOM2_PATH81:    ; Path 81
    FCB 127              ; path81: intensity
    FCB $00,$FA,0,0        ; path81: header (y=0, x=-6, relative to center)
    FCB $FF,$00,$2E          ; flag=-1, dy=0, dx=46
    FCB $FF,$D8,$00          ; flag=-1, dy=-40, dx=0
    FCB $FF,$00,$D2          ; flag=-1, dy=0, dx=-46
    FCB $FF,$28,$00          ; flag=-1, dy=40, dx=0
...
_ROOM2_PATH82:    ; Path 82
    FCB 127              ; path82: intensity
    FCB $FE,$FD,0,0        ; path82: header (y=-2, x=-3, relative to center)
    FCB $FF,$00,$2A          ; flag=-1, dy=0, dx=42
    FCB $FF,$DC,$00          ; flag=-1, dy=-36, dx=0
    FCB $FF,$00,$D6          ; flag=-1, dy=0, dx=-42
    FCB $FF,$24,$00          ; flag=-1, dy=36, dx=0
...
_ROOM2_PATH83:    ; Path 83
    FCB 127              ; path83: intensity
    FCB $E0,$FF,0,0        ; path83: header (y=-32, x=-1, relative to center)
    FCB $FF,$01,$04          ; flag=-1, dy=1, dx=4
    FCB $FF,$02,$01          ; flag=-1, dy=2, dx=1
    FCB $FF,$02,$04          ; flag=-1, dy=2, dx=4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH84:    ; Path 84
    FCB 127              ; path84: intensity
    FCB $E4,$09,0,0        ; path84: header (y=-28, x=9, relative to center)
    FCB $FF,$FD,$02          ; flag=-1, dy=-3, dx=2
    FCB $FF,$03,$00          ; flag=-1, dy=3, dx=0
    FCB $FF,$FD,$01          ; flag=-1, dy=-3, dx=1
    FCB $FF,$04,$01          ; flag=-1, dy=4, dx=1
...
_ROOM2_PATH85:    ; Path 85
    FCB 127              ; path85: intensity
    FCB $DA,$0A,0,0        ; path85: header (y=-38, x=10, relative to center)
    FCB $FF,$05,$FD          ; flag=-1, dy=5, dx=-3
    FCB $FF,$04,$02          ; flag=-1, dy=4, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH86:    ; Path 86
    FCB 127              ; path86: intensity
    FCB $E5,$08,0,0        ; path86: header (y=-27, x=8, relative to center)
    FCB $FF,$02,$01          ; flag=-1, dy=2, dx=1
    FCB $FF,$01,$01          ; flag=-1, dy=1, dx=1
    FCB $FF,$FF,$01          ; flag=-1, dy=-1, dx=1
    FCB $FF,$02,$01          ; flag=-1, dy=2, dx=1
...
_ROOM2_PATH87:    ; Path 87
    FCB 127              ; path87: intensity
    FCB $E9,$13,0,0        ; path87: header (y=-23, x=19, relative to center)
    FCB $FF,$FD,$03          ; flag=-1, dy=-3, dx=3
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$FE,$01          ; flag=-1, dy=-2, dx=1
    FCB 2                ; End marker (path complete)

_ROOM2_PATH88:    ; Path 88
    FCB 127              ; path88: intensity
    FCB $E2,$0D,0,0        ; path88: header (y=-30, x=13, relative to center)
    FCB $FF,$FE,$02          ; flag=-1, dy=-2, dx=2
    FCB $FF,$01,$01          ; flag=-1, dy=1, dx=1
    FCB $FF,$04,$01          ; flag=-1, dy=4, dx=1
    FCB 2                ; End marker (path complete)

_ROOM2_PATH89:    ; Path 89
    FCB 127              ; path89: intensity
    FCB $E1,$10,0,0        ; path89: header (y=-31, x=16, relative to center)
    FCB $FF,$01,$04          ; flag=-1, dy=1, dx=4
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH90:    ; Path 90
    FCB 127              ; path90: intensity
    FCB $E2,$14,0,0        ; path90: header (y=-30, x=20, relative to center)
    FCB $FF,$FF,$01          ; flag=-1, dy=-1, dx=1
    FCB $FF,$02,$03          ; flag=-1, dy=2, dx=3
    FCB $FF,$02,$01          ; flag=-1, dy=2, dx=1
    FCB $FF,$02,$00          ; flag=-1, dy=2, dx=0
...
_ROOM2_PATH91:    ; Path 91
    FCB 127              ; path91: intensity
    FCB $E5,$1A,0,0        ; path91: header (y=-27, x=26, relative to center)
    FCB $FF,$02,$02          ; flag=-1, dy=2, dx=2
    FCB $FF,$05,$00          ; flag=-1, dy=5, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH92:    ; Path 92
    FCB 127              ; path92: intensity
    FCB $E9,$0D,0,0        ; path92: header (y=-23, x=13, relative to center)
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB $FF,$00,$03          ; flag=-1, dy=0, dx=3
    FCB 2                ; End marker (path complete)

_ROOM2_PATH93:    ; Path 93
    FCB 127              ; path93: intensity
    FCB $F1,$0E,0,0        ; path93: header (y=-15, x=14, relative to center)
    FCB $FF,$FB,$FF          ; flag=-1, dy=-5, dx=-1
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
...
_ROOM2_PATH94:    ; Path 94
    FCB 127              ; path94: intensity
    FCB $E7,$09,0,0        ; path94: header (y=-25, x=9, relative to center)
    FCB $FF,$01,$FF          ; flag=-1, dy=1, dx=-1
    FCB $FF,$03,$01          ; flag=-1, dy=3, dx=1
    FCB $FF,$04,$FE          ; flag=-1, dy=4, dx=-2
    FCB $FF,$02,$00          ; flag=-1, dy=2, dx=0
...
_ROOM2_PATH95:    ; Path 95
    FCB 127              ; path95: intensity
    FCB $F0,$08,0,0        ; path95: header (y=-16, x=8, relative to center)
    FCB $FF,$05,$00          ; flag=-1, dy=5, dx=0
    FCB $FF,$05,$06          ; flag=-1, dy=5, dx=6
    FCB $FF,$FF,$0B          ; flag=-1, dy=-1, dx=11
    FCB $FF,$FE,$05          ; flag=-1, dy=-2, dx=5
...
_ROOM2_PATH96:    ; Path 96
    FCB 127              ; path96: intensity
    FCB $F1,$08,0,0        ; path96: header (y=-15, x=8, relative to center)
    FCB $FF,$04,$FF          ; flag=-1, dy=4, dx=-1
    FCB $FF,$05,$07          ; flag=-1, dy=5, dx=7
    FCB 2                ; End marker (path complete)

_ROOM2_PATH97:    ; Path 97
    FCB 127              ; path97: intensity
    FCB $F3,$0B,0,0        ; path97: header (y=-13, x=11, relative to center)
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH98:    ; Path 98
    FCB 127              ; path98: intensity
    FCB $F4,$10,0,0        ; path98: header (y=-12, x=16, relative to center)
    FCB $FF,$00,$03          ; flag=-1, dy=0, dx=3
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH99:    ; Path 99
    FCB 127              ; path99: intensity
    FCB $F4,$1A,0,0        ; path99: header (y=-12, x=26, relative to center)
    FCB $FF,$FE,$02          ; flag=-1, dy=-2, dx=2
    FCB $FF,$FD,$00          ; flag=-1, dy=-3, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH100:    ; Path 100
    FCB 127              ; path100: intensity
    FCB $EF,$1D,0,0        ; path100: header (y=-17, x=29, relative to center)
    FCB $FF,$FE,$FF          ; flag=-1, dy=-2, dx=-1
    FCB $FF,$FF,$FD          ; flag=-1, dy=-1, dx=-3
    FCB $FF,$FD,$FF          ; flag=-1, dy=-3, dx=-1
    FCB 2                ; End marker (path complete)

_ROOM2_PATH101:    ; Path 101
    FCB 127              ; path101: intensity
    FCB $EC,$13,0,0        ; path101: header (y=-20, x=19, relative to center)
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH102:    ; Path 102
    FCB 127              ; path102: intensity
    FCB $F1,$1E,0,0        ; path102: header (y=-15, x=30, relative to center)
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
    FCB $FF,$FE,$01          ; flag=-1, dy=-2, dx=1
    FCB $FF,$FE,$FE          ; flag=-1, dy=-2, dx=-2
    FCB $FF,$FF,$FD          ; flag=-1, dy=-1, dx=-3
...
_ROOM2_PATH103:    ; Path 103
    FCB 127              ; path103: intensity
    FCB $ED,$1F,0,0        ; path103: header (y=-19, x=31, relative to center)
    FCB $FF,$FD,$01          ; flag=-1, dy=-3, dx=1
    FCB $FF,$FF,$FF          ; flag=-1, dy=-1, dx=-1
    FCB $FF,$01,$FE          ; flag=-1, dy=1, dx=-2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH104:    ; Path 104
    FCB 127              ; path104: intensity
    FCB $DF,$19,0,0        ; path104: header (y=-33, x=25, relative to center)
    FCB $FF,$04,$03          ; flag=-1, dy=4, dx=3
    FCB $FF,$04,$03          ; flag=-1, dy=4, dx=3
    FCB $FF,$02,$FF          ; flag=-1, dy=2, dx=-1
    FCB 2                ; End marker (path complete)

_ROOM2_PATH105:    ; Path 105
    FCB 127              ; path105: intensity
    FCB $DB,$14,0,0        ; path105: header (y=-37, x=20, relative to center)
    FCB $FF,$03,$04          ; flag=-1, dy=3, dx=4
    FCB $FF,$FD,$08          ; flag=-1, dy=-3, dx=8
    FCB 2                ; End marker (path complete)

_ROOM2_PATH106:    ; Path 106
    FCB 127              ; path106: intensity
    FCB $DC,$21,0,0        ; path106: header (y=-36, x=33, relative to center)
    FCB $FF,$07,$02          ; flag=-1, dy=7, dx=2
    FCB $FF,$04,$00          ; flag=-1, dy=4, dx=0
    FCB $FF,$02,$FC          ; flag=-1, dy=2, dx=-4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH107:    ; Path 107
    FCB 127              ; path107: intensity
    FCB $E6,$23,0,0        ; path107: header (y=-26, x=35, relative to center)
    FCB $FF,$FF,$04          ; flag=-1, dy=-1, dx=4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH108:    ; Path 108
    FCB 127              ; path108: intensity
    FCB $F1,$09,0,0        ; path108: header (y=-15, x=9, relative to center)
    FCB $FF,$00,$05          ; flag=-1, dy=0, dx=5
    FCB 2                ; End marker (path complete)

_ROOM2_PATH109:    ; Path 109
    FCB 127              ; path109: intensity
    FCB $F1,$12,0,0        ; path109: header (y=-15, x=18, relative to center)
    FCB $FF,$00,$03          ; flag=-1, dy=0, dx=3
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH110:    ; Path 110
    FCB 127              ; path110: intensity
    FCB $EF,$0A,0,0        ; path110: header (y=-17, x=10, relative to center)
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
    FCB $FF,$01,$02          ; flag=-1, dy=1, dx=2
    FCB 2                ; End marker (path complete)

_ROOM2_PATH111:    ; Path 111
    FCB 127              ; path111: intensity
    FCB $F0,$09,0,0        ; path111: header (y=-16, x=9, relative to center)
    FCB $FF,$01,$02          ; flag=-1, dy=1, dx=2
    FCB $FF,$FF,$03          ; flag=-1, dy=-1, dx=3
    FCB 2                ; End marker (path complete)

_ROOM2_PATH112:    ; Path 112
    FCB 127              ; path112: intensity
    FCB $F0,$12,0,0        ; path112: header (y=-16, x=18, relative to center)
    FCB $FF,$FF,$02          ; flag=-1, dy=-1, dx=2
    FCB $FF,$01,$03          ; flag=-1, dy=1, dx=3
    FCB 2                ; End marker (path complete)

_ROOM2_PATH113:    ; Path 113
    FCB 127              ; path113: intensity
    FCB $38,$01,0,0        ; path113: header (y=56, x=1, relative to center)
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
...
_ROOM2_PATH114:    ; Path 114
    FCB 127              ; path114: intensity
    FCB $33,$01,0,0        ; path114: header (y=51, x=1, relative to center)
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
    FCB $FF,$00,$00          ; flag=-1, dy=0, dx=0
...
_ROOM2_PATH115:    ; Path 115
    FCB 127              ; path115: intensity
    FCB $2E,$02,0,0        ; path115: header (y=46, x=2, relative to center)
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
    FCB $FF,$01,$00          ; flag=-1, dy=1, dx=0
    FCB $FF,$00,$FF          ; flag=-1, dy=0, dx=-1
...
_ROOM2_PATH116:    ; Path 116
    FCB 127              ; path116: intensity
    FCB $2C,$FF,0,0        ; path116: header (y=44, x=-1, relative to center)
    FCB $FF,$F4,$F5          ; flag=-1, dy=-12, dx=-11
    FCB 2                ; End marker (path complete)

_ROOM2_PATH117:    ; Path 117
    FCB 127              ; path117: intensity
    FCB $2C,$01,0,0        ; path117: header (y=44, x=1, relative to center)
    FCB $FF,$F4,$0A          ; flag=-1, dy=-12, dx=10
    FCB 2                ; End marker (path complete)

_ROOM2_PATH118:    ; Path 118
    FCB 127              ; path118: intensity
    FCB $1F,$F3,0,0        ; path118: header (y=31, x=-13, relative to center)
    FCB $FF,$03,$00          ; flag=-1, dy=3, dx=0
    FCB $FF,$00,$FE          ; flag=-1, dy=0, dx=-2
    FCB $FF,$04,$00          ; flag=-1, dy=4, dx=0
    FCB $FF,$00,$FA          ; flag=-1, dy=0, dx=-6
...
_ROOM2_PATH119:    ; Path 119
    FCB 127              ; path119: intensity
    FCB $22,$EB,0,0        ; path119: header (y=34, x=-21, relative to center)
    FCB $FF,$00,$06          ; flag=-1, dy=0, dx=6
    FCB 2                ; End marker (path complete)

_ROOM2_PATH120:    ; Path 120
    FCB 127              ; path120: intensity
    FCB $1F,$EB,0,0        ; path120: header (y=31, x=-21, relative to center)
    FCB $FF,$FB,$00          ; flag=-1, dy=-5, dx=0
    FCB $FF,$FE,$03          ; flag=-1, dy=-2, dx=3
    FCB $FF,$02,$02          ; flag=-1, dy=2, dx=2
    FCB $FF,$05,$00          ; flag=-1, dy=5, dx=0
...
_ROOM2_PATH121:    ; Path 121
    FCB 127              ; path121: intensity
    FCB $1F,$F3,0,0        ; path121: header (y=31, x=-13, relative to center)
    FCB $FF,$00,$09          ; flag=-1, dy=0, dx=9
    FCB 2                ; End marker (path complete)

_ROOM2_PATH122:    ; Path 122
    FCB 127              ; path122: intensity
    FCB $1B,$F0,0,0        ; path122: header (y=27, x=-16, relative to center)
    FCB $FF,$00,$0C          ; flag=-1, dy=0, dx=12
    FCB 2                ; End marker (path complete)

_ROOM2_PATH123:    ; Path 123
    FCB 127              ; path123: intensity
    FCB $26,$FD,0,0        ; path123: header (y=38, x=-3, relative to center)
    FCB $FF,$00,$06          ; flag=-1, dy=0, dx=6
    FCB $FF,$FD,$00          ; flag=-1, dy=-3, dx=0
    FCB $FF,$00,$02          ; flag=-1, dy=0, dx=2
    FCB $FF,$FD,$00          ; flag=-1, dy=-3, dx=0
...
_ROOM2_PATH124:    ; Path 124
    FCB 127              ; path124: intensity
    FCB $23,$FD,0,0        ; path124: header (y=35, x=-3, relative to center)
    FCB $FF,$00,$06          ; flag=-1, dy=0, dx=6
    FCB 2                ; End marker (path complete)

_ROOM2_PATH125:    ; Path 125
    FCB 127              ; path125: intensity
    FCB $20,$FC,0,0        ; path125: header (y=32, x=-4, relative to center)
    FCB $FF,$F9,$00          ; flag=-1, dy=-7, dx=0
    FCB $FF,$00,$08          ; flag=-1, dy=0, dx=8
    FCB $FF,$07,$00          ; flag=-1, dy=7, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH126:    ; Path 126
    FCB 127              ; path126: intensity
    FCB $1F,$04,0,0        ; path126: header (y=31, x=4, relative to center)
    FCB $FF,$00,$08          ; flag=-1, dy=0, dx=8
    FCB $FF,$03,$00          ; flag=-1, dy=3, dx=0
    FCB $FF,$00,$03          ; flag=-1, dy=0, dx=3
    FCB $FF,$04,$00          ; flag=-1, dy=4, dx=0
...
_ROOM2_PATH127:    ; Path 127
    FCB 127              ; path127: intensity
    FCB $1F,$0F,0,0        ; path127: header (y=31, x=15, relative to center)
    FCB $FF,$FB,$01          ; flag=-1, dy=-5, dx=1
    FCB $FF,$FE,$02          ; flag=-1, dy=-2, dx=2
    FCB $FF,$02,$02          ; flag=-1, dy=2, dx=2
    FCB $FF,$05,$00          ; flag=-1, dy=5, dx=0
...
_ROOM2_PATH128:    ; Path 128
    FCB 127              ; path128: intensity
    FCB $1B,$04,0,0        ; path128: header (y=27, x=4, relative to center)
    FCB $FF,$00,$0C          ; flag=-1, dy=0, dx=12
    FCB 2                ; End marker (path complete)

_ROOM2_PATH129:    ; Path 129
    FCB 127              ; path129: intensity
    FCB $19,$FE,0,0        ; path129: header (y=25, x=-2, relative to center)
    FCB $FF,$FE,$01          ; flag=-1, dy=-2, dx=1
    FCB $FF,$FF,$01          ; flag=-1, dy=-1, dx=1
    FCB $FF,$01,$01          ; flag=-1, dy=1, dx=1
    FCB $FF,$02,$01          ; flag=-1, dy=2, dx=1
...
_ROOM2_PATH130:    ; Path 130
    FCB 127              ; path130: intensity
    FCB $1A,$EB,0,0        ; path130: header (y=26, x=-21, relative to center)
    FCB $FF,$00,$05          ; flag=-1, dy=0, dx=5
    FCB 2                ; End marker (path complete)

_ROOM2_PATH131:    ; Path 131
    FCB 127              ; path131: intensity
    FCB $1A,$10,0,0        ; path131: header (y=26, x=16, relative to center)
    FCB $FF,$00,$04          ; flag=-1, dy=0, dx=4
    FCB 2                ; End marker (path complete)

_ROOM2_PATH132:    ; Path 132
    FCB 127              ; path132: intensity
    FCB $1F,$FA,0,0        ; path132: header (y=31, x=-6, relative to center)
    FCB $FF,$FD,$00          ; flag=-1, dy=-3, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH133:    ; Path 133
    FCB 127              ; path133: intensity
    FCB $1F,$06,0,0        ; path133: header (y=31, x=6, relative to center)
    FCB $FF,$FD,$00          ; flag=-1, dy=-3, dx=0
    FCB 2                ; End marker (path complete)

_ROOM2_PATH134:    ; Path 134
    FCB 127              ; path134: intensity
    FCB $27,$ED,0,0        ; path134: header (y=39, x=-19, relative to center)
    FCB $FF,$02,$FF          ; flag=-1, dy=2, dx=-1
    FCB $FF,$02,$02          ; flag=-1, dy=2, dx=2
    FCB $FF,$FE,$02          ; flag=-1, dy=-2, dx=2
    FCB $FF,$FE,$FF          ; flag=-1, dy=-2, dx=-1
...
_ROOM2_PATH135:    ; Path 135
    FCB 127              ; path135: intensity
    FCB $27,$11,0,0        ; path135: header (y=39, x=17, relative to center)
    FCB $FF,$02,$FF          ; flag=-1, dy=2, dx=-1
    FCB $FF,$03,$02          ; flag=-1, dy=3, dx=2
    FCB $FF,$FD,$02          ; flag=-1, dy=-3, dx=2
    FCB $FF,$FE,$FF          ; flag=-1, dy=-2, dx=-1
...
_ROOM2_PATH136:    ; Path 136
    FCB 127              ; path136: intensity
    FCB $27,$FF,0,0        ; path136: header (y=39, x=-1, relative to center)
    FCB $FF,$02,$FF          ; flag=-1, dy=2, dx=-1
    FCB $FF,$02,$02          ; flag=-1, dy=2, dx=2
    FCB $FF,$FE,$02          ; flag=-1, dy=-2, dx=2
    FCB $FF,$FE,$FF          ; flag=-1, dy=-2, dx=-1
...
_ROOM2_PATH137:    ; Path 137
    FCB 127              ; path137: intensity
    FCB $3C,$00,0,0        ; path137: header (y=60, x=0, relative to center)
    FCB $FF,$F0,$00          ; flag=-1, dy=-16, dx=0
    FCB 2                ; End marker (path complete)
...
; Object: obj_crypt_room (enemy)
    ...
    FDB 0  ; spawn_delay
    FDB _ROOM2_VECTORS  ; vector_ptr
    FCB _ROOM2_HALF_WIDTH  ; half_width (visual cull margin, ROM+18)
...
PRINT_TEXT_STR_564764511967242620:
    FCC "A STONE SARCOPHAGUS."
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_931851343526459475:
    FCC "TAKE SARCOPHAGUS"
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_1306255401665072902:
    FCC "TAKE THE CLOCK"
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_2328381712862181292:
    FCC "YOU ESCAPED."
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_2512255219486809515:
    FCC "THE LAST WILL OF VOSS:"
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_4509857456104209203:
    FCC "THE CLOCKWORK LOCK."
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_4514345320188155635:
    FCC "INSIDE: A LAST WILL."
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_6343893941434420413:
    FCC "YOU TRY: 1-8-8-7."
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_6906140908233091688:
    FCC "THE SARCOPHAGUS OPENS."
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_8675300455265089919:
    FCC "THE ESTATE IS YOURS."
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_9005050258175366001:
    FCC "YOU HAVE EARNED IT."""
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_9303927173923537616:
    FCC """TO WHOEVER OPENS THIS,"
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_9469988307073198007:
    FCC "4 DIGIT WHEELS..."
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_9476469358947353920:
    FCC "EXAMINE THE CLOCK"
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_11806333666897636487:
    FCC "STOPPED AT 11:07."
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_12641232965239080973:
    FCC "EXAMINE SARCOPHAGUS"
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_13777482088983958502:
    FCC "USE THE CLOCK"
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_13843794019476522291:
    FCC "USE SARCOPHAGUS"
    FCB $80          ; Vectrex string terminator
...
PRINT_TEXT_STR_15001376415733204503:
    FCC "A GRANDFATHER CLOCK."
    FCB $80          ; Vectrex string terminator
