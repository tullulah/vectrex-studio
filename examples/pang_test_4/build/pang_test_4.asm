...
VAR_CURRENT_LOCATION EQU $C880+$2B   ; User variable: CURRENT_LOCATION (2 bytes)
VAR_BUTTON_PRESSED   EQU $C880+$2D   ; User variable: BUTTON_PRESSED (2 bytes)
VAR_LOCATION_X_COORDS EQU $C880+$2F   ; User variable: LOCATION_X_COORDS (2 bytes)
VAR_LOCATION_Y_COORDS EQU $C880+$31   ; User variable: LOCATION_Y_COORDS (2 bytes)
VAR_NUM_LOCATIONS    EQU $C880+$33   ; User variable: NUM_LOCATIONS (2 bytes)
VAR_LOC_X            EQU $C880+$35   ; User variable: LOC_X (2 bytes)
VAR_LOC_Y            EQU $C880+$37   ; User variable: LOC_Y (2 bytes)
...
; Array literal for variable 'LOCATION_X_COORDS' (5 elements, 2 bytes each)
...
; Array literal for variable 'LOCATION_Y_COORDS' (5 elements, 2 bytes each)
