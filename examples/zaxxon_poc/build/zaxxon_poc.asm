...
.equ VAR_LEVEL_LEN, 0x0010015C  @ const scalar
.equ VAR_BLD_COUNT, 0x00100160  @ const scalar
.equ VAR_VIS_FAR, 0x00100164  @ const scalar
.equ ARRAY_BLD_X_LEN, 6
.equ VAR_BLD_X, 0x00100168  @ const array ptr
.equ ARRAY_BLD_Z_LEN, 6
.equ VAR_BLD_Z, 0x0010016C  @ const array ptr
.equ ARRAY_BLD_W_LEN, 6
.equ VAR_BLD_W, 0x00100170  @ const array ptr
.equ ARRAY_BLD_H_LEN, 6
.equ VAR_BLD_H, 0x00100174  @ const array ptr
.equ VAR_PLAYER_X, 0x00100178
.equ VAR_PLAYER_Y, 0x0010017C
.equ VAR_CAM_Z, 0x00100180
.equ VAR_SCROLL_TICK, 0x00100184
.equ VAR_SCORE, 0x00100188
.equ VAR_B0ALIVE, 0x0010018C
.equ VAR_B1ALIVE, 0x00100190
.equ VAR_B2ALIVE, 0x00100194
.equ VAR_B3ALIVE, 0x00100198
.equ VAR_B4ALIVE, 0x0010019C
.equ VAR_B5ALIVE, 0x001001A0
.equ VAR_BULLET_ALIVE, 0x001001A4
.equ VAR_BULLET_ABS_Z, 0x001001A8
.equ VAR_BULLET_RX, 0x001001AC
.equ VAR_BULLET_RY, 0x001001B0
.equ VAR_BTN_PREV, 0x001001B4
.equ VAR_EXPL_FRAMES, 0x001001B8
.equ VAR_EXPL_SX, 0x001001BC
.equ VAR_EXPL_SY, 0x001001C0
.equ VAR_P_RX, 0x001001C4
.equ VAR_P_WY, 0x001001C8
.equ VAR_P_RZ, 0x001001CC
.equ VAR_P_SX, 0x001001D0
.equ VAR_P_SY, 0x001001D4
.equ VAR_C0X, 0x001001D8
.equ VAR_C0Y, 0x001001DC
.equ VAR_C1X, 0x001001E0
.equ VAR_C1Y, 0x001001E4
.equ VAR_C2X, 0x001001E8
.equ VAR_C2Y, 0x001001EC
.equ VAR_C3X, 0x001001F0
.equ VAR_C3Y, 0x001001F4
.equ VAR_C4X, 0x001001F8
.equ VAR_C4Y, 0x001001FC
.equ VAR_C5X, 0x00100200
.equ VAR_C5Y, 0x00100204
.equ VAR_BI, 0x00100208
.equ VAR_BX, 0x0010020C
.equ VAR_BZ, 0x00100210
.equ VAR_BW, 0x00100214
.equ VAR_BH, 0x00100218
.equ VAR_RZ, 0x0010021C
.equ VAR_ALIVE, 0x00100220
.equ VAR_HIT_BI, 0x00100224
.equ VAR_BULLET_RZ, 0x00100228
.equ VAR_BZ_CHECK, 0x0010022C
.equ VAR_BX_CHECK, 0x00100230
.equ VAR_BW_CHECK, 0x00100234
.equ VAR_BH_CHECK, 0x00100238
.equ VAR_PLAYER_SY, 0x0010023C
.equ VAR_ALT_BAR, 0x00100240
.equ VAR_GI, 0x00100244
.equ VAR_GRZ, 0x00100248
.equ VAR_GSX_L, 0x0010024C
.equ VAR_GSY_L, 0x00100250
.equ VAR_GSX_R, 0x00100254
.equ VAR_GSY_R, 0x00100258
.equ VAR_JOY_X, 0x0010025C  @ local assign
.equ VAR_JOY_Y, 0x00100260  @ local assign
.equ VAR_BTN1, 0x00100264  @ local assign
...
DRAW_BOX:
    push    {r4, r5, r6, r7, r8, lr}
    ldr     r1, =0x0010020C    @ BX
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100178    @ PLAYER_X
    ldr     r0, [r1]
    mov     r1, r0
    pop     {r0}
    sub     r0, r0, r1
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x001001D8    @ C0X
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x001001DC    @ C0Y
    str     r0, [r1]
    ldr     r1, =0x0010020C    @ BX
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100214    @ BW
    ldr     r0, [r1]
    mov     r1, r0
    pop     {r0}
    add     r0, r0, r1
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x001001E0    @ C1X
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x001001E4    @ C1Y
    str     r0, [r1]
    ldr     r1, =0x0010020C    @ BX
    ldr     r0, [r1]
    push    {r0}
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x001001E8    @ C2X
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x001001EC    @ C2Y
    str     r0, [r1]
    ldr     r1, =0x0010020C    @ BX
    ldr     r0, [r1]
    push    {r0}
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x001001F0    @ C3X
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x001001F4    @ C3Y
    str     r0, [r1]
    ldr     r1, =0x0010020C    @ BX
    ldr     r0, [r1]
    push    {r0}
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x001001F8    @ C4X
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x001001FC    @ C4Y
    str     r0, [r1]
    ldr     r1, =0x0010020C    @ BX
    ldr     r0, [r1]
    push    {r0}
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x00100200    @ C5X
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x00100204    @ C5Y
    str     r0, [r1]
    mov     r0, #70
    push    {r0}
    ldr     r1, =0x001001D8    @ C0X
...
.Lgp_0:
    ...
    ldr     r1, =0x00100168
    str     r0, [r1]  @ const array BLD_X → rodata
    ldr     r0, =ARRAY_BLD_Z_DATA
    ldr     r1, =0x0010016C
    str     r0, [r1]  @ const array BLD_Z → rodata
    ldr     r0, =ARRAY_BLD_W_DATA
    ldr     r1, =0x00100170
    str     r0, [r1]  @ const array BLD_W → rodata
    ldr     r0, =ARRAY_BLD_H_DATA
    ldr     r1, =0x00100174
    str     r0, [r1]  @ const array BLD_H → rodata
    ldr     r1, =0x00100178
    mov     r0, #0
    str     r0, [r1]
    ldr     r1, =0x0010017C
...
pitrex_game_loop:
    ...
    bl      pitrex_j1_x
    ldr     r1, =0x0010025C    @ JOY_X
    str     r0, [r1]
    bl      pitrex_j1_y
    ldr     r1, =0x00100260    @ JOY_Y
    str     r0, [r1]
    bl      pitrex_j1_btn1
    ldr     r1, =0x00100264    @ BTN1
    str     r0, [r1]
    ldr     r1, =0x00100184    @ SCROLL_TICK
    ldr     r0, [r1]
    push    {r0}
    mov     r0, #1
    mov     r1, r0
...
.Lcf1e:
    ...
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x0010018C    @ B0ALIVE
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x00100190    @ B1ALIVE
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x00100194    @ B2ALIVE
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x00100198    @ B3ALIVE
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x0010019C    @ B4ALIVE
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x001001A0    @ B5ALIVE
    str     r0, [r1]
    b       if_end_1
if_else_1:
if_end_1:
...
.Lcf7e:
    cmp     r0, #0
    beq     if_else_7
    ldr     r1, =0x001001A4    @ BULLET_ALIVE
    ldr     r0, [r1]
    push    {r0}
    mov     r0, #0
    mov     r1, r0
...
.Lcf8e:
    ...
    pop     {r0}
    add     r0, r0, r1
    ldr     r1, =0x001001A8    @ BULLET_ABS_Z
    str     r0, [r1]
    ldr     r1, =0x00100178    @ PLAYER_X
    ldr     r0, [r1]
    ldr     r1, =0x001001AC    @ BULLET_RX
    str     r0, [r1]
    ldr     r1, =0x0010017C    @ PLAYER_Y
    ldr     r0, [r1]
    ldr     r1, =0x001001B0    @ BULLET_RY
    str     r0, [r1]
...
.Lcf9e:
    ...
    pop     {r0}
    sub     r0, r0, r1
    ldr     r1, =0x00100228    @ BULLET_RZ
    str     r0, [r1]
    ldr     r1, =0x00100228    @ BULLET_RZ
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100164    @ VIS_FAR
    ldr     r0, [r1]
    mov     r1, r0
    pop     {r0}
    cmp     r0, r1
...
if_else_10:
    ...
    bl      pitrex_draw_vector
    ldr     r0, =-1
    ldr     r1, =0x00100224    @ HIT_BI
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x00100208    @ BI
    str     r0, [r1]
while_top_11:
    ldr     r1, =0x00100208    @ BI
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100160    @ BLD_COUNT
    ldr     r0, [r1]
    mov     r1, r0
    pop     {r0}
    cmp     r0, r1
...
.Lcf11e:
    ...
    ldr     r1, =0x0010022C    @ BZ_CHECK
    str     r0, [r1]
    ldr     r1, =0x00100168    @ BLD_X
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100208    @ BI
    ldr     r0, [r1]
    ...
    add     r0, r0, r1
    ldrsh   r0, [r0]       @ sign-extend 16-bit load
    ldr     r1, =0x00100230    @ BX_CHECK
    str     r0, [r1]
    ldr     r1, =0x00100170    @ BLD_W
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100208    @ BI
    ldr     r0, [r1]
    ...
    add     r0, r0, r1
    ldrsh   r0, [r0]       @ sign-extend 16-bit load
    ldr     r1, =0x00100234    @ BW_CHECK
    str     r0, [r1]
    ldr     r1, =0x00100174    @ BLD_H
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x00100208    @ BI
    ldr     r0, [r1]
...
.Lcf17e:
    ...
    str     r0, [r1]
    mov     r0, #14
    ldr     r1, =0x001001B8    @ EXPL_FRAMES
    str     r0, [r1]
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x001001BC    @ EXPL_SX
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x001001C0    @ EXPL_SY
    str     r0, [r1]
    ldr     r1, =0x00100188    @ SCORE
    ldr     r0, [r1]
    push    {r0}
    mov     r0, #1
    mov     r1, r0
...
if_end_24:
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x0010024C    @ GSX_L
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x00100250    @ GSY_L
    str     r0, [r1]
    mov     r0, #200
    ldr     r1, =0x001001CC    @ P_RZ
    str     r0, [r1]
    ...
    ldr     r1, =0x001001D0    @ P_SX
    ldr     r0, [r1]
    ldr     r1, =0x00100254    @ GSX_R
    str     r0, [r1]
    ldr     r1, =0x001001D4    @ P_SY
    ldr     r0, [r1]
    ldr     r1, =0x00100258    @ GSY_R
    str     r0, [r1]
    mov     r0, #25
    push    {r0}
    ldr     r1, =0x0010024C    @ GSX_L
