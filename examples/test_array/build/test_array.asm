...
ARRAY_COUNTERS_LEN         EQU 8   ; 8 elements
ARRAY_POSITIONS_LEN         EQU 4   ; 4 elements
...
.COPY_LOOP_1:
    ...
    LDX #VAR_POSITIONS_DATA    ; Array now in RAM
    STX VAR_POSITIONS
    LDD #0
    STD VAR_INDEX
...
IF_END_0:
    ...
    LDD #0
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_62552633      ; Pointer to string in helpers bank
    STX VAR_ARG2
