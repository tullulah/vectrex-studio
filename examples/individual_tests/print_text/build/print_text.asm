...
TEXT_SCALE_H         EQU $C880+$20   ; Character height for Print_Str_d (default $F8 = -8, normal) (1 bytes)
TEXT_SCALE_W         EQU $C880+$21   ; Character width for Print_Str_d (default $48 = 72, normal) (1 bytes)
