...
.equ VAR_BALL_X, 0x001005D4
.equ VAR_BALL_Y, 0x001005D8
.equ VAR_BALL_VX, 0x001005DC
.equ VAR_BALL_VY, 0x001005E0
.equ VAR_BUB_X, 0x001005E4
.equ VAR_BUB_Y, 0x001005E8
.equ VAR_BUB_VX, 0x001005EC
.equ VAR_BUB_VY, 0x001005F0
...
.Lgp_1:
    ...
    mov     r0, #0
    ldr     r1, =0x001005D4    @ BALL_X
    str     r0, [r1]
    mov     r0, #20
    ldr     r1, =0x001005D8    @ BALL_Y
    str     r0, [r1]
    mov     r0, #3
    ldr     r1, =0x001005DC    @ BALL_VX
    str     r0, [r1]
    mov     r0, #2
    ldr     r1, =0x001005E0    @ BALL_VY
    str     r0, [r1]
    ldr     r0, =-30
    ldr     r1, =0x001005E4    @ BUB_X
    str     r0, [r1]
    ldr     r0, =-20
    ldr     r1, =0x001005E8    @ BUB_Y
    str     r0, [r1]
    ldr     r0, =-2
    ldr     r1, =0x001005EC    @ BUB_VX
    str     r0, [r1]
    mov     r0, #3
    ldr     r1, =0x001005F0    @ BUB_VY
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
