...
_TEST_PATH0:
    .byte   127               @ intensity
    .byte   0x25, 0xE0, 0x00, 0x00  @ y=37, x=-32, hdr
    .byte   0xFF, 0x14, 0x19  @ line dy=20, dx=25
    .byte   0xFF, 0xF7, 0x16  @ line dy=-9, dx=22
    .byte   0xFF, 0xF6, 0x16  @ line dy=-10, dx=22
    .byte   0xFF, 0xD5, 0xFB  @ line dy=-43, dx=-5
    .byte   0xFF, 0x09, 0xF1  @ line dy=9, dx=-15
    .byte   0xFF, 0xE5, 0xF4  @ line dy=-27, dx=-12
    .byte   0xFF, 0xF9, 0x0A  @ line dy=-7, dx=10
    .byte   0xFF, 0xF9, 0x0F  @ line dy=-7, dx=15
    .byte   0xFF, 0xEE, 0xF9  @ line dy=-18, dx=-7
    .byte   0xFF, 0xFF, 0xEA  @ line dy=-1, dx=-22
    .byte   0xFF, 0x00, 0xD9  @ line dy=0, dx=-39
