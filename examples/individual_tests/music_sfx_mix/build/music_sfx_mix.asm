...
.equ VAR_SFX_TIMER, 0x001005D4
.equ VAR_LAST_SFX, 0x001005D8
.equ VAR_RADIUS, 0x001005DC
...
.Lgp_1:
    ...
    mov     r0, #0
    ldr     r1, =0x001005D4    @ SFX_TIMER
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005D8    @ LAST_SFX
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
...
if_end_0:
    ...
    cmp     r0, #0
    beq     if_else_1
    ldr     r0, =_EXPLOSION1_SFX    @ asset 'explosion1'
    push    {r0}
    pop     {r0}
    bl      pitrex_play_sfx
    mov     r0, #20
