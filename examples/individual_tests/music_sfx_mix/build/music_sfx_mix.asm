...
VAR_SFX_TIMER        EQU $C880+$32   ; User variable: SFX_TIMER (2 bytes)
VAR_LAST_SFX         EQU $C880+$34   ; User variable: LAST_SFX (2 bytes)
VAR_RADIUS           EQU $C880+$36   ; User variable: RADIUS (2 bytes)
...
_JUMP_SFX:
    ...
    FCB $01, $77  ; Tone period = 375 (big-endian)
    FCB $AE         ; Frame 2 - flags (vol=14, noisevol=0, tone=Y, noise=N)
    FCB $01, $44  ; Tone period = 324 (big-endian)
    FCB $AD         ; Frame 3 - flags (vol=13, noisevol=0, tone=Y, noise=N)
    FCB $01, $1D  ; Tone period = 285 (big-endian)
    ...
    FCB $00, $D2  ; Tone period = 210 (big-endian)
