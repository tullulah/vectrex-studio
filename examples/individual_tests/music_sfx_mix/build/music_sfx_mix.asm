...
@ --- User variables (RAM) ---
.equ VAR_SFX_TIMER, 0x2007F460
.equ VAR_LAST_SFX, 0x2007F464
.equ VAR_RADIUS, 0x2007F468
...
gm_zero_loop:
    ...
    bl      vpy_play_music
    mov     r0, #0
    ldr     r1, =0x2007F460    @ SFX_TIMER
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F464    @ LAST_SFX
    str     r0, [r1]
game_main_loop:
    bl      vpy_wait_recal
