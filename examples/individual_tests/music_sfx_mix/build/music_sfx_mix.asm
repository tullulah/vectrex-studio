...
TEXT_SCALE_H         EQU $C880+$2D   ; Character height for Print_Str_d (default $F8 = -8, normal) (1 bytes)
TEXT_SCALE_W         EQU $C880+$2E   ; Character width for Print_Str_d (default $48 = 72, normal) (1 bytes)
VAR_SFX_TIMER        EQU $C880+$2F   ; User variable: SFX_TIMER (2 bytes)
VAR_LAST_SFX         EQU $C880+$31   ; User variable: LAST_SFX (2 bytes)
VAR_RADIUS           EQU $C880+$33   ; User variable: RADIUS (2 bytes)
...
.J1B2_1_END:
    ...
    LDX #_EXPLOSION1_SFX  ; Load SFX data pointer
    JSR PLAY_SFX_RUNTIME
    LDD #0
    STD RESULT
    LDD #20
...
.J1B4_3_END:
    ...
    LDX #_COIN_SFX  ; Load SFX data pointer
    JSR PLAY_SFX_RUNTIME
    LDD #0
    STD RESULT
    LDD #20
