...
.equ VAR_SFX_TIMER, 0x0010015C
.equ VAR_LAST_SFX, 0x00100160
.equ VAR_RADIUS, 0x00100164
...
.Lgp_1:
    ...
    mov     r0, #0
    ldr     r1, =0x0010015C    @ SFX_TIMER
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x00100160    @ LAST_SFX
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
