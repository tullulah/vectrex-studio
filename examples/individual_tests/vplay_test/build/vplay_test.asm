...
_BALL_WIDTH EQU 32
_BALL_HALF_WIDTH EQU 16
_BALL_HEIGHT EQU 32
_BALL_HALF_HEIGHT EQU 16
...
_COIN_WIDTH EQU 17
_COIN_HALF_WIDTH EQU 8
_COIN_HEIGHT EQU 20
_COIN_HALF_HEIGHT EQU 10
...
_SPAWN_WIDTH EQU 23
_SPAWN_HALF_WIDTH EQU 11
_SPAWN_HEIGHT EQU 51
_SPAWN_HALF_HEIGHT EQU 25
...
; Object: obj_1772212957260 (enemy)
    ...
    FCB _SPAWN_HALF_WIDTH  ; half_width (visual cull margin, ROM+18)
    FCB _SPAWN_HALF_HEIGHT  ; half_height (collision AABB, ROM+19)
...
; Object: obj_1772212984369 (enemy)
    ...
    FCB _BALL_HALF_WIDTH  ; half_width (visual cull margin, ROM+18)
    FCB _BALL_HALF_HEIGHT  ; half_height (collision AABB, ROM+19)
...
; Object: obj_1772214807272 (enemy)
    ...
    FCB _COIN_HALF_WIDTH  ; half_width (visual cull margin, ROM+18)
    FCB _COIN_HALF_HEIGHT  ; half_height (collision AABB, ROM+19)
...
; Object: obj_1772202959556 (enemy)
    ...
    FCB _PLATFORM_HALF_HEIGHT  ; half_height (collision AABB, ROM+19)
