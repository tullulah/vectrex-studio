...
VAR_X                EQU $C880+$2B   ; User variable: x (2 bytes)
VAR_Y                EQU $C880+$2D   ; User variable: y (2 bytes)
VAR_CIRCLE_X         EQU $C880+$2F   ; User variable: circle_x (2 bytes)
VAR_CIRCLE_Y         EQU $C880+$31   ; User variable: circle_y (2 bytes)
