...
.equ VAR_X, 0x0010015C
.equ VAR_Y, 0x00100160
.equ VAR_CIRCLE_X, 0x00100164
.equ VAR_CIRCLE_Y, 0x00100168
.equ VAR_BTN1, 0x0010016C  @ local assign
.equ VAR_BTN2, 0x00100170  @ local assign
.equ VAR_BTN3, 0x00100174  @ local assign
.equ VAR_BTN4, 0x00100178  @ local assign
...
_str_1_after:
    ...
    bl      pitrex_j1_btn1
    ldr     r1, =0x0010016C    @ BTN1
    str     r0, [r1]
    bl      pitrex_j1_btn2
    ldr     r1, =0x00100170    @ BTN2
    str     r0, [r1]
    bl      pitrex_j1_btn3
    ldr     r1, =0x00100174    @ BTN3
    str     r0, [r1]
    bl      pitrex_j1_btn4
    ldr     r1, =0x00100178    @ BTN4
    str     r0, [r1]
    ldr     r0, =-60
    push    {r0}
    mov     r0, #40
