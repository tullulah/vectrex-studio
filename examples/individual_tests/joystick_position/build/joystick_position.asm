...
VAR_CIRCLE_X         EQU $C880+$30   ; User variable (2 bytes)
VAR_CIRCLE_Y         EQU $C880+$32   ; User variable (2 bytes)
...
VAR_ARG4             EQU $C880+$3C   ; Function argument 4 (2 bytes)
...
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 23
    ...
    LDD RESULT
    STD VAR_ARG2
; NATIVE_CALL: VECTREX_PRINT_NUMBER at line 24
...
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 26
    ...
    LDD RESULT
    STD VAR_ARG2
; NATIVE_CALL: VECTREX_PRINT_NUMBER at line 27
    JSR VECTREX_PRINT_NUMBER
    CLRA
    CLRB
    STD RESULT
