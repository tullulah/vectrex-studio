...
.equ USER_RAM_START,      0x2007F308  @ user variables begin here
...
vbez_loop:
    ...
    asr     r3, r3, #8
    add     r3, r3, r12
    push    {r0, r3}            @ save r0y, r1y
    ldr     r12, [sp, #44]      @ r0x (sp+36+8)
    ldr     r2,  [sp, #24]      @ t256 (sp+16+8)
    sub     r0, r1, r12
    mul     r0, r0, r2
    asr     r0, r0, #8
    add     r0, r0, r12
    ...
    asr     r1, r1, #8
    add     r1, r1, r12
    pop     {r2, r3}            @ discard saved r0y/r1y (restore sp)
    ldr     r2, [sp, #16]       @ t256 (restored sp)
    ldr     r2, [sp, #8]        @ prev_x
    ldr     r3, [sp, #12]       @ prev_y
    ...
    add     r0, r0, #1
    str     r0, [sp, #4]
    ldr     r2, [sp, #16]       @ reload t256 for lerps
    b       vbez_loop
vbez_done:
    add     sp, sp, #40
    pop     {r4, r5, r6, r7, r8, r9, r10, r11, pc}
...
@ --- User variables (RAM) ---
.equ VAR_ANGLE, 0x2007F308
.equ VAR_PX, 0x2007F30C  @ implicit
.equ VAR_PY, 0x2007F310  @ implicit
