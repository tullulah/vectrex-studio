...
@ --- User variables (RAM) ---
.equ VAR_BTN1, 0x2007F460  @ implicit
.equ VAR_BTN2, 0x2007F464  @ implicit
.equ VAR_BTN3, 0x2007F468  @ implicit
.equ VAR_BTN4, 0x2007F46C  @ implicit
...
game_main_loop:
    ...
    strb    r1, [r0]
    bl      vpy_j1_btn1
    ldr     r1, =0x2007F460    @ BTN1
    str     r0, [r1]
    bl      vpy_j1_btn2
    ldr     r1, =0x2007F464    @ BTN2
    str     r0, [r1]
    bl      vpy_j1_btn3
    ldr     r1, =0x2007F468    @ BTN3
    str     r0, [r1]
    bl      vpy_j1_btn4
    ldr     r1, =0x2007F46C    @ BTN4
    str     r0, [r1]
    ldr     r0, =-60
    push    {r0}
    mov     r0, #80
