...
.equ VAR_BTN1, 0x001005D4  @ local assign
.equ VAR_BTN2, 0x001005D8  @ local assign
.equ VAR_BTN3, 0x001005DC  @ local assign
.equ VAR_BTN4, 0x001005E0  @ local assign
...
pitrex_game_loop:
    ...
    bl      pitrex_j1_btn1
    ldr     r1, =0x001005D4    @ BTN1
    str     r0, [r1]
    bl      pitrex_j1_btn2
    ldr     r1, =0x001005D8    @ BTN2
    str     r0, [r1]
    bl      pitrex_j1_btn3
    ldr     r1, =0x001005DC    @ BTN3
    str     r0, [r1]
    bl      pitrex_j1_btn4
    ldr     r1, =0x001005E0    @ BTN4
    str     r0, [r1]
    ldr     r0, =-60
    push    {r0}
    mov     r0, #80
