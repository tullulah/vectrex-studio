...
DRAW_CIRCLE_TEMP     EQU $C880+$0F   ; Circle temporary buffer (8 bytes: radius16, a, b, c, d, --, --)  a=0.383r b=0.324r c=0.217r d=0.076r (8 bytes)
...
VAR_RADIUS           EQU $C880+$2B   ; User variable: radius (2 bytes)
