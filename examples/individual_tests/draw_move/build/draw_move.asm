; --- Motorola 6809 backend (Vectrex) title='DRAW_MOVE' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
LOOP_BODY:
    ...
    ; VPy_LINE:13
    LDA #$C4  ; MOVE X offset
    STA VPY_MOVE_X
    LDA #$3C  ; MOVE Y offset
    STA VPY_MOVE_Y
    LDD #0
    STD RESULT
    ...
    ; VPy_LINE:21
    LDA #$00  ; MOVE X offset
    STA VPY_MOVE_X
    LDA #$00  ; MOVE Y offset
    STA VPY_MOVE_Y
    LDD #0
    STD RESULT
