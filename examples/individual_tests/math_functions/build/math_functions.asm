...
VAR_VAL1             EQU $C880+$2B   ; User variable: val1 (2 bytes)
VAR_VAL2             EQU $C880+$2D   ; User variable: val2 (2 bytes)
VAR_VAL3             EQU $C880+$2F   ; User variable: val3 (2 bytes)
VAR_VAL4             EQU $C880+$31   ; User variable: val4 (2 bytes)
