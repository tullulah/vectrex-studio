...
.equ VAR_RX1, 0x001005D4
.equ VAR_RY1, 0x001005D8
.equ VAR_RX2, 0x001005DC
.equ VAR_RY2, 0x001005E0
.equ VAR_RX3, 0x001005E4
.equ VAR_RY4, 0x001005E8
.equ VAR_RY3, 0x001005EC  @ local assign
...
.Lgp_1:
    @ main() body
    mov     r0, #0
    ldr     r1, =0x001005D4    @ RX1
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005D8    @ RY1
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005DC    @ RX2
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005E0    @ RY2
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005E4    @ RX3
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005E8    @ RY4
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
