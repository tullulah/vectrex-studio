...
@ --- User variables (RAM) ---
.equ VAR_RX1, 0x2007F460
.equ VAR_RY1, 0x2007F464
.equ VAR_RX2, 0x2007F468
.equ VAR_RY2, 0x2007F46C
.equ VAR_RX3, 0x2007F470
.equ VAR_RY4, 0x2007F474
.equ VAR_RY3, 0x2007F478  @ implicit
...
gm_zero_loop:
    ...
    @ main() body
    mov     r0, #0
    ldr     r1, =0x2007F460    @ RX1
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F464    @ RY1
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F468    @ RX2
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F46C    @ RY2
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F470    @ RX3
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F474    @ RY4
    str     r0, [r1]
game_main_loop:
    bl      vpy_wait_recal
