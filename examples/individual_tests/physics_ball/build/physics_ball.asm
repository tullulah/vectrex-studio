...
.equ VAR_BX, 0x001005D4
.equ VAR_BY, 0x001005D8
.equ VAR_VX, 0x001005DC
.equ VAR_VY, 0x001005E0
.equ VAR_JX, 0x001005E4
...
.Lgp_1:
    ...
    mov     r0, #0
    ldr     r1, =0x001005D4    @ BX
    str     r0, [r1]
    mov     r0, #60
    ldr     r1, =0x001005D8    @ BY
    str     r0, [r1]
    mov     r0, #1
    ldr     r1, =0x001005DC    @ VX
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x001005E0    @ VY
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
