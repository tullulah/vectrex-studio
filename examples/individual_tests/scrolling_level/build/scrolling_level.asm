...
@ --- User variables (RAM) ---
.equ VAR_CAMERA_X, 0x2007F28C
.equ VAR_CAMERA_Y, 0x2007F290
.equ VAR_JOY_X, 0x2007F294  @ implicit
.equ VAR_JOY_Y, 0x2007F298  @ implicit
...
game_main_loop:
    ...
    bl      vpy_audio_update
    bl      vpy_j1_x
    ldr     r1, =0x2007F294    @ JOY_X
    str     r0, [r1]
    bl      vpy_j1_y
    ldr     r1, =0x2007F298    @ JOY_Y
    str     r0, [r1]
    ldr     r1, =0x2007F294    @ JOY_X
    ldr     r0, [r1]
    push    {r0}
