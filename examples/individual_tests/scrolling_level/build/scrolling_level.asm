...
DRAW_SCALE           EQU $C880+$250   ; Current T1 scale for Draw_Sync_List_At_With_Mirrors ($7F=normal) (1 bytes)
VAR_CAMERA_X         EQU $C880+$251   ; User variable: camera_x (2 bytes)
VAR_CAMERA_Y         EQU $C880+$253   ; User variable: camera_y (2 bytes)
VAR_JOY_X            EQU $C880+$255   ; User variable: joy_x (2 bytes)
VAR_JOY_Y            EQU $C880+$257   ; User variable: joy_y (2 bytes)
...
_WORLD_LEVEL:
    ...
    FDB 500  ; xMax (16-bit signed)
    FDB -300  ; yMin (16-bit signed)
