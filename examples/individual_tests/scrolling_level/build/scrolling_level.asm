...
.equ VAR_CAMERA_X, 0x001005D4
.equ VAR_CAMERA_Y, 0x001005D8
.equ VAR_JOY_X, 0x001005DC  @ local assign
.equ VAR_JOY_Y, 0x001005E0  @ local assign
...
pitrex_game_loop:
    ...
    bl      pitrex_j1_x
    ldr     r1, =0x001005DC    @ JOY_X
    str     r0, [r1]
    bl      pitrex_j1_y
    ldr     r1, =0x001005E0    @ JOY_Y
    str     r0, [r1]
    ldr     r1, =0x001005DC    @ JOY_X
    ldr     r0, [r1]
    push    {r0}
...
_WORLD_LEVEL:
    ...
    .hword 500  @ scrollLimit right
    .hword 127  @ scrollLimit top
    .hword -300  @ scrollLimit bottom
