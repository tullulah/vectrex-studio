...
BEEP_FRAMES_LEFT     EQU $C880+$32   ; Beep countdown timer (frames remaining) (1 bytes)
VAR_PLAYING          EQU $C880+$33   ; User variable: PLAYING (2 bytes)
...
PRINT_TEXT_STR_60036864546:
    FCC "B1=PLAY"
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_60065591183:
    FCC "B2=STOP"
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_60093699162:
    FCC "B3=BEEP"
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_2110696929079206:
    FCC "MUSIC CTRL"
    FCB $80          ; Vectrex string terminator
