; --- Motorola 6809 backend (Vectrex) title='STOPMUSIC' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
SFX_ACTIVE           EQU $C880+$26   ; SFX playback flag (always needed by AUDIO_UPDATE) (1 bytes)
NUM_STR              EQU $C880+$27   ; String buffer for PRINT_NUMBER (5 digits + terminator) (6 bytes)
BEEP_FRAMES_LEFT     EQU $C880+$2D   ; Beep countdown timer (frames remaining) (1 bytes)
DRAW_CIRCLE_XC       EQU $C880+$2E   ; Circle center X (byte) (1 bytes)
DRAW_CIRCLE_YC       EQU $C880+$2F   ; Circle center Y (byte) (1 bytes)
DRAW_CIRCLE_DIAM     EQU $C880+$30   ; Circle diameter (byte) (1 bytes)
DRAW_CIRCLE_INTENSITY EQU $C880+$31   ; Circle intensity (byte) (1 bytes)
DRAW_CIRCLE_TEMP     EQU $C880+$32   ; Circle drawing temporaries (radius=2, xc=2, yc=2, spare=2) (8 bytes)
VAR_PLAYING          EQU $C880+$3A   ; User variable (2 bytes)
VAR_ARG0             EQU $C880+$3C   ; Function argument 0 (2 bytes)
VAR_ARG1             EQU $C880+$3E   ; Function argument 1 (2 bytes)
VAR_ARG2             EQU $C880+$40   ; Function argument 2 (2 bytes)
VAR_ARG3             EQU $C880+$42   ; Function argument 3 (2 bytes)
VAR_ARG4             EQU $C880+$44   ; Function argument 4 (2 bytes)
VAR_ARG5             EQU $C880+$46   ; Function argument 5 (2 bytes)
...
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 17
    ...
    ; VPy_LINE:19
; NATIVE_CALL: J1_BUTTON_1 at line 19
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    LBEQ IF_NEXT_1
...
; NATIVE_CALL: J1_BUTTON_2 at line 23
    ...
    LBEQ IF_NEXT_3
    ; VPy_LINE:24
; NATIVE_CALL: STOP_MUSIC at line 24
...
IF_END_2:
    ...
    ; VPy_LINE:27
; NATIVE_CALL: J1_BUTTON_3 at line 27
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    LBEQ IF_NEXT_5
    ; VPy_LINE:28
; NATIVE_CALL: BEEP at line 28
; BEEP() - non-blocking beep (PSG ch A, freq=50, 8 frames)
    ...
    LDB #0
    JSR Sound_Byte
    LDA #7              ; PSG reg 7 = mixer (tone A on)
    LDB #$3E            ; %00111110
    JSR Sound_Byte
    ...
    STA >BEEP_FRAMES_LEFT  ; BEEP_UPDATE_RUNTIME will mute when this reaches 0
    LDD #0
    STD RESULT
    LBRA IF_END_4
IF_NEXT_5:
