...
VAR_ARG0             EQU $C880+$37   ; Function argument 0 (16-bit) (2 bytes)
VAR_ARG1             EQU $C880+$39   ; Function argument 1 (16-bit) (2 bytes)
VAR_ARG2             EQU $C880+$3B   ; Function argument 2 (16-bit) (2 bytes)
VAR_ARG3             EQU $C880+$3D   ; Function argument 3 (16-bit) (2 bytes)
VAR_ARG4             EQU $C880+$3F   ; Function argument 4 (16-bit) (2 bytes)
VAR_ARG5             EQU $C880+$41   ; Function argument 5 (16-bit) (2 bytes)
VAR_ARG6             EQU $C880+$43   ; Function argument 6 (16-bit) (2 bytes)
VAR_ARG7             EQU $C880+$45   ; Function argument 7 (16-bit) (2 bytes)
CURRENT_ROM_BANK     EQU $C880+$47   ; Current ROM bank ID (multibank tracking) (1 bytes)
VAR_X                EQU $C880+$48   ; User variable: x (2 bytes)
VAR_Y                EQU $C880+$4A   ; User variable: y (2 bytes)
VAR_PRESSED          EQU $C880+$4C   ; User variable: pressed (2 bytes)
VAR_CX               EQU $C880+$4E   ; User variable: cx (2 bytes)
VAR_JX               EQU $C880+$50   ; User variable: jx (2 bytes)
VAR_JY               EQU $C880+$52   ; User variable: jy (2 bytes)
VAR_B1               EQU $C880+$54   ; User variable: b1 (2 bytes)
VAR_B2               EQU $C880+$56   ; User variable: b2 (2 bytes)
VAR_B3               EQU $C880+$58   ; User variable: b3 (2 bytes)
VAR_B4               EQU $C880+$5A   ; User variable: b4 (2 bytes)
VAR_SX               EQU $C880+$5C   ; User variable: SX (2 bytes)
VAR_SY               EQU $C880+$5E   ; User variable: SY (2 bytes)
VAR_B_Y              EQU $C880+$60   ; User variable: B_Y (2 bytes)
VAR_B_X0             EQU $C880+$62   ; User variable: B_X0 (2 bytes)
...
MAIN:
    ...
    ; TODO: Statement Pass { source_line: 19 }
...
LOOP_BODY:
    ...
    LDD #110
    STD >VAR_ARG1
    LDX #PRINT_TEXT_STR_68020170476      ; Pointer to string in helpers bank
    STX >VAR_ARG2
    ...
    LDD #50
    STD >VAR_ARG1
    LDX #PRINT_TEXT_STR_2529      ; Pointer to string in helpers bank
    STX >VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.J1B4_3_END:
    ...
    LDD #50
    STD >VAR_ARG1
    LDX #PRINT_TEXT_STR_2530      ; Pointer to string in helpers bank
    STX >VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
.J2B4_7_END:
    ...
    SUBD TMPVAL         ; D = LEFT - RIGHT
    STD >VAR_ARG1
    LDX #PRINT_TEXT_STR_6969309672619227168      ; Pointer to string in helpers bank
    STX >VAR_ARG2
    JSR VECTREX_PRINT_TEXT
    LDD #0
    STD RESULT
...
PRINT_TEXT_STR_68020170476:
    FCC "JOY 1+2"
    FCB $80          ; Vectrex string terminator

PRINT_TEXT_STR_6969309672619227168:
    FCC "P2 KEYS J K L M"
    FCB $80          ; Vectrex string terminator
