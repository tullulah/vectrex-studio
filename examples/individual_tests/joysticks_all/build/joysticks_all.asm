...
@ --- User variables (RAM) ---
.equ VAR_CX, 0x2007F3DC  @ param
.equ VAR_JX, 0x2007F3E0  @ param
.equ VAR_JY, 0x2007F3E4  @ param
.equ VAR_B1, 0x2007F3E8  @ param
.equ VAR_B2, 0x2007F3EC  @ param
.equ VAR_B3, 0x2007F3F0  @ param
.equ VAR_B4, 0x2007F3F4  @ param
.equ VAR_SX, 0x2007F3F8  @ implicit
.equ VAR_SY, 0x2007F3FC  @ implicit
.equ VAR_B_Y, 0x2007F400  @ implicit
.equ VAR_B_X0, 0x2007F404  @ implicit
...
DRAW_PANEL:
    push    {r4, r5, r6, r7, lr}
    ldr     r4, =0x2007F3DC    @ save param cx
    str     r0, [r4]
    ldr     r4, =0x2007F3E0    @ save param jx
    str     r1, [r4]
    ldr     r4, =0x2007F3E4    @ save param jy
    str     r2, [r4]
    ldr     r4, =0x2007F3E8    @ save param b1
    str     r3, [r4]
    ldr     r1, =0x2007F3DC    @ CX
    ldr     r0, [r1]
    push    {r0}
    ldr     r1, =0x2007F3E0    @ JX
    ldr     r0, [r1]
    push    {r0}
    mov     r0, #4
    mov     r1, r0
    ...
    pop     {r0}
    add     r0, r0, r1
    ldr     r1, =0x2007F3F8    @ SX
    str     r0, [r1]
    ldr     r1, =0x2007F3E4    @ JY
    ldr     r0, [r1]
    push    {r0}
    mov     r0, #2
    mov     r1, r0
    ...
    pop     {r0}
    sub     r0, r0, r1
    ldr     r1, =0x2007F404    @ B_X0
    str     r0, [r1]
    ldr     r1, =0x2007F3E8    @ B1
    ldr     r0, [r1]
    push    {r0}
    mov     r0, #1
    mov     r1, r0
