...
@ --- User variables (RAM) ---
.equ VAR_U8_VAL, 0x2007F460
.equ VAR_I8_VAL, 0x2007F464
.equ VAR_U16_VAL, 0x2007F468
.equ VAR_I16_VAL, 0x2007F46C
.equ ARRAY_U8_ARR_DATA, 0x2007F470
.equ ARRAY_U8_ARR_LEN, 4
.equ VAR_U8_ARR, 0x2007F478  @ array pointer
.equ ARRAY_I8_ARR_DATA, 0x2007F47C
.equ ARRAY_I8_ARR_LEN, 4
.equ VAR_I8_ARR, 0x2007F484  @ array pointer
.equ ARRAY_U16_ARR_DATA, 0x2007F488
.equ ARRAY_U16_ARR_LEN, 4
.equ VAR_U16_ARR, 0x2007F490  @ array pointer
.equ ARRAY_I16_ARR_DATA, 0x2007F494
.equ ARRAY_I16_ARR_LEN, 4
.equ VAR_I16_ARR, 0x2007F49C  @ array pointer
.equ ARRAY_ROW_Y_LEN, 4
.equ VAR_ROW_Y, 0x2007F4A0  @ const array pointer
.equ VAR_SELECTED, 0x2007F4A4
.equ VAR_COOLDOWN, 0x2007F4A8
.equ VAR_ARR_IDX, 0x2007F4AC
.equ VAR_ARR_TICK, 0x2007F4B0
.equ VAR_JOY_Y, 0x2007F4B4
...
gm_zero_loop:
    ...
    mov     r0, #0
    ldr     r1, =0x2007F4A4    @ SELECTED
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F4A8    @ COOLDOWN
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F4AC    @ ARR_IDX
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x2007F4B0    @ ARR_TICK
    str     r0, [r1]
game_main_loop:
    bl      vpy_wait_recal
