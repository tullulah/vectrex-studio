...
.equ VAR_U8_VAL, 0x001005D4
.equ VAR_I8_VAL, 0x001005D8
.equ VAR_U16_VAL, 0x001005DC
.equ VAR_I16_VAL, 0x001005E0
.equ ARRAY_U8_ARR_DATA, 0x001005E4
.equ ARRAY_U8_ARR_LEN, 4
.equ VAR_U8_ARR, 0x001005EC  @ array ptr
.equ ARRAY_I8_ARR_DATA, 0x001005F0
.equ ARRAY_I8_ARR_LEN, 4
.equ VAR_I8_ARR, 0x001005F8  @ array ptr
.equ ARRAY_U16_ARR_DATA, 0x001005FC
.equ ARRAY_U16_ARR_LEN, 4
.equ VAR_U16_ARR, 0x00100604  @ array ptr
.equ ARRAY_I16_ARR_DATA, 0x00100608
.equ ARRAY_I16_ARR_LEN, 4
.equ VAR_I16_ARR, 0x00100610  @ array ptr
.equ ARRAY_ROW_Y_LEN, 4
.equ VAR_ROW_Y, 0x00100614  @ const array ptr
.equ VAR_SELECTED, 0x00100618
.equ VAR_COOLDOWN, 0x0010061C
.equ VAR_ARR_IDX, 0x00100620
.equ VAR_ARR_TICK, 0x00100624
.equ VAR_JOY_Y, 0x00100628
...
.Lgp_1:
    ...
    mov     r0, #0
    ldr     r1, =0x00100618    @ SELECTED
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x0010061C    @ COOLDOWN
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x00100620    @ ARR_IDX
    str     r0, [r1]
    mov     r0, #0
    ldr     r1, =0x00100624    @ ARR_TICK
    str     r0, [r1]
    b       .Lgp_2
    .ltorg
.Lgp_2:
