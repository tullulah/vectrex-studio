...
vupe_w_air:
    ...
    ldr     r1,  [r5, #28]          @ type_data_ptr
    cmp     r1, #0
    beq     vupe_w_air_nofeet
    ldrsb   r1, [r1, #4]            @ feet_offset
    add     r9, r9, r1              @ target_y = area.y + feet
vupe_w_air_nofeet:
    ldr     r10, [r5, #4]           @ world_x
    ldrsh   r0,  [r12, #2]          @ target_x
    cmp     r10, r0
    beq.w   vupe_w_air_yarc         @ x already at target_x
    bgt.w   vupe_w_air_xleft
    add     r10, r10, #2            @ x += AIR_X
    cmp     r10, r0
    it      gt
    movgt   r10, r0                 @ clamp to target_x
    str     r10, [r5, #4]
    b.w     vupe_w_air_yarc
vupe_w_air_xleft:
    sub     r10, r10, #2            @ x -= AIR_X
    cmp     r10, r0
    it      lt
    movlt   r10, r0                 @ clamp to target_x
    str     r10, [r5, #4]
vupe_w_air_yarc:
    ldrsh   r0, [r5, #8]            @ world_y
    ldrsh   r1, [r12, #0]           @ vy
    ...
    strh    r0, [r5, #8]            @ y += vy
    sub     r1, r1, #1
    mvn     r2, #3                  @ -4 terminal velocity
    cmp     r1, r2
    it      lt
    movlt   r1, r2
    strh    r1, [r12, #0]           @ vy updated
    ldrb    r2, [r5, #11]           @ trans_type
    cmp     r2, #2
    beq.w   vupe_w_air_chk          @ drop: eligible immediately
    cmp     r1, #0
    bge.w   vupe_next               @ ascending (vy>=0): keep flying
vupe_w_air_chk:
    cmp     r0, r9                  @ world_y vs target_y
    bgt.w   vupe_next               @ y > target_y: still above, keep arcing
    strh    r9, [r5, #8]            @ world_y = target_y
    mov     r0, #0
    strb    r0, [r5, #10]           @ sub_state = WALK
    b.w     vupe_next
vupe_next:
