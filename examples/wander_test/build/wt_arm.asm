...
.Lgp_1:
    @ main() body
    @ LOAD_LEVEL("wlevel") -> libvpy
    ldr     r0, =_WLEVEL_LEVEL_C
    ldr     r1, =_WLEVEL_level_sprites
    bl      vpy_load_level
    @ SPAWN_ENEMIES("wlevel") -> libvpy
    ldr     r0, =_WLEVEL_ENEMIES_C
    ldr     r1, =_WLEVEL_ENEMY_SPRITES
