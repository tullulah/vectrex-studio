...
@ --- enemy (3 path(s)) ---
.section .rodata._ENEMY_VECTORS,"a",%progbits
    .balign 4
...
.section .rodata._ENEMY_DATA,"a",%progbits
    .balign 4
.global _ENEMY_DATA
_ENEMY_DATA:
    .word 1    @ state_count
...
_WLEVEL_ENEMIES_C:
    .byte   0x01, 0x00, 0x00, 0x00, 0xD8, 0xFF, 0xEC, 0xFF, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
