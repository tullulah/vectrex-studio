...
.Lpue_w_tt_face_r:
    ...
    b       .Lpue_skip
.Lpue_w_air:
    ldrsh   r10, [r5, #4]       @ current x
    ldrsh   r8, [r5, #14]       @ target_x
    sub     r6, r8, r10         @ dx
    cmp     r6, #0
    beq     .Lpue_w_air_y_lerp  @ Phase B: lerp Y, then land
    bgt     .Lpue_w_air_xright
    sub     r10, r10, #4        @ x -= AIR_SPEED
    cmp     r10, r8
    it      lt
    movlt   r10, r8
    strh    r10, [r5, #4]
...
.Lpue_w_air_y_lerp:
    ...
    ldrsh   r9, [r8]            @ target_y
    ldrsh   r6, [r5, #6]
    sub     r0, r9, r6          @ target_y - y
    cmp     r0, #0
    beq     .Lpue_w_air_land
    bgt     .Lpue_w_air_ylerp_up
    sub     r6, r6, #4
    cmp     r6, r9
    it      lt
    movlt   r6, r9
...
.Lpue_w_air_land:
    ...
    cmp     r0, #0
    beq     .Lpue_w_air_land_no_off
    ldrsb   r0, [r0, #209]      @ feet_offset
    add     r9, r9, r0
.Lpue_w_air_land_no_off:
    strh    r9, [r5, #6]        @ snap y = target_y + feet_offset
    mov     r0, #0
    strb    r0, [r5, #10]       @ sub_state = WALK
...
_WLEVEL_ENEMIES_C:
    .byte   0x01, 0x00, 0x00, 0x00, 0xD8, 0xFF, 0xEC, 0xFF, 0x04, 0x00, 0x01, 0x00, 0x00, 0x0A, 0x00, 0x00
    .byte   0x00, 0xFF, 0xFF, 0x00, 0x02, 0x00, 0xEC, 0xFF, 0xB0, 0xFF, 0x00, 0x00, 0x1E, 0x00, 0x0A, 0x00
    .byte   0x50, 0x00, 0x01, 0x00, 0x00, 0x01, 0x01, 0x00, 0xD8, 0xFF, 0x2D, 0x00
.section .text
...
_WLEVEL_LEVEL_C:
    .byte   0xA0, 0xFF, 0x5F, 0x00, 0x80, 0xFF, 0x7F, 0x00, 0x00, 0x01, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00
    .byte   0x24, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00, 0xA0, 0xFF, 0x5F, 0x00, 0x7F, 0x00, 0x80, 0xFF
    .byte   0x00, 0x00, 0x00, 0x00, 0xD8, 0xFF, 0xEC, 0xFF, 0x08, 0x7F, 0x00, 0x01, 0xFF, 0xFF, 0xFF, 0xFF
