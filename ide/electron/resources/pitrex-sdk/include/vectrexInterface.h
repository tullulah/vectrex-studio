...
/* Smooth continuous drawing — beam stays ON between all segments (no vertex bright spots).
 * v_directDrawPolyline: xs[]/ys[] are in the same pre-scaled units as v_directDraw32.
 * v_drawBezierCubic / v_drawBezierQuad: take raw VPy coordinates (range ±127); scale internally. */
